// COMMAND: random_gen -r WsubWX8VInt16VBVISI_TAMA -n 1 -l 7 --has-ta --has-ma -c WsubWX8VInt16VBVISI_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_3_0= vwsub_wx_i16m2_tama(mask_value_0_0, vec_value_1_0, placeholder2, tail_vl);
...
int16_t tmp[] = {-1,-1,1206,-1,-6405,-1,-1,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
