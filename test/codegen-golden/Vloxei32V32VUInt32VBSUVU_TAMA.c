// COMMAND: random_gen -r Vloxei32V32VUInt32VBSUVU_TAMA -n 1 -l 7 --has-ta --has-ma -c Vloxei32V32VUInt32VBSUVU_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint32m1_t vec_value_3_0= vloxei32_v_u32m1_tama(mask_value_0_0, placeholder1, vec_value_2_0, tail_vl);
