// COMMAND: random_gen -r Vlse32XX32VFloat32VBSFSI_TAMA -n 1 -l 7 --has-ta --has-ma -c Vlse32XX32VFloat32VBSFSI_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder2 *= 4;
vfloat32m1_t vec_value_3_0= vlse32_v_f32m1_tama(mask_value_0_0, placeholder1, placeholder2, tail_vl);
...
uint64_t tmp[] = {4294967295u,4294967295u,1261086746u,4294967295u,1247419408u,4294967295u,4294967295u,};
