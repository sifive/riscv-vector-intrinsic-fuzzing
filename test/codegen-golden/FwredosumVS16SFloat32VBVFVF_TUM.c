// COMMAND: random_gen -r FwredosumVS16SFloat32VBVFVF_TUM -n 1 -l 7 --has-ta --has-ma -c FwredosumVS16SFloat32VBVFVF_TUM.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m1_t placeholder6= vmv_v_v_f32m1(placeholder5, vsetvlmax_e32m1());
...
placeholder6 = vfwredosum_vs_f16m1_f32m1_tum(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder6, vl);
placeholder0 += vl;
placeholder1 += vl;
placeholder2 += vl;
placeholder3 += vl;
}
float32_t *placeholder7 = value_3;
*placeholder7= vfmv_f_s_f32m1_f32(placeholder6);
}
...
uint64_t tmp[] = {1191776256u,1267490606u,1261860990u,1261781606u,1262205779u,1243709844u,1259168278u,};
