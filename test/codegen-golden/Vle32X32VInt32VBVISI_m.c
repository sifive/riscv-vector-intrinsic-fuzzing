// COMMAND: random_gen -r Vle32X32VInt32VBVISI_m -n 1 -l 7 --has-ta --has-ma -c Vle32X32VInt32VBVISI_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint32m1_t vec_value_3_0= vle32_v_i32m1_m (mask_value_0_0, vec_value_1_0, placeholder2, vl);
...
int32_t tmp[] = {2884331,5000420,-1529498,1879014,1613727,-7353883,-734314,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
