// COMMAND: random_gen -r FwredosumVS16SFloat32VF_TA -n 1 -l 7 --has-ta --has-ma -c FwredosumVS16SFloat32VF_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder4 = vfwredosum_vs_f16m1_f32m1_ta(vec_value_0_0, placeholder4, vl);
placeholder0 += vl;
placeholder1 += vl;
}
