// COMMAND: random_gen -r WsubuWV8VUInt16VBVUVUVU_TAMU -n 1 -l 7 --has-ta --has-ma -c WsubuWV8VUInt16VBVUVUVU_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
uint16_t tmp[] = {8488,3583,6940,9596,3071,2350,3007,};
for (int i=0; i<7;++i) {value_2[i] = tmp[i];
}
}
void vwsubu_wv_operator_0() {
...
vuint16m2_t vec_value_4_0= vwsubu_wv_u16m2_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, tail_vl);
...
int golden_vwsubu_wv_operator_0() {
uint16_t tmp[] = {6442,65535,6898,65535,3013,65535,4633,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
