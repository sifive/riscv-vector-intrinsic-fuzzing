// COMMAND: random_gen -r Vloxei32V32VInt32VBSIVU_TAMA -n 1 -l 7 --has-ta --has-ma -c Vloxei32V32VInt32VBSIVU_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint32m1_t vec_value_3_0= vloxei32_v_i32m1_tama(mask_value_0_0, placeholder1, vec_value_2_0, tail_vl);
...
int32_t tmp[] = {-1,-1,-734314,-1,2884331,-1,-1,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
