// COMMAND: random_gen -r Vluxei32V32VUInt32VBVUSUVU_m -n 1 -l 7 --has-ta --has-ma -c Vluxei32V32VUInt32VBVUSUVU_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint32m1_t vec_value_4_0= vluxei32_v_u32m1_m (mask_value_0_0, vec_value_1_0, placeholder2, vec_value_3_0, vl);
...
uint32_t tmp[] = {6442165u,3071074u,3007149u,5939507u,8488019u,1323058u,4632843u,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
