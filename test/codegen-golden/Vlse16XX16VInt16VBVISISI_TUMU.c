// COMMAND: random_gen -r Vlse16XX16VInt16VBVISISI_TUMU -n 1 -l 7 --has-ta --has-ma -c Vlse16XX16VInt16VBVISISI_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder3 *= 2;
vint16m1_t vec_value_4_0= vlse16_v_i16m1_tumu(mask_value_0_0, vec_value_1_0, placeholder2, placeholder3, tail_vl);
...
int16_t tmp[] = {5001,-1530,1879,1614,-7354,-2596,2884,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
