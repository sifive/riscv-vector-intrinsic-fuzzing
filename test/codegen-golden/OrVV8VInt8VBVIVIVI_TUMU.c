// COMMAND: random_gen -r OrVV8VInt8VBVIVIVI_TUMU -n 1 -l 7 --has-ta --has-ma -c OrVV8VInt8VBVIVIVI_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_4_0= vor_vv_i8m1_tumu(mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, tail_vl);
