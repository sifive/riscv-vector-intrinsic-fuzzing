// COMMAND: random_gen -r FdivVF16VFloat16VFSF_TA -n 1 -l 7 --has-ta --has-ma -c FdivVF16VFloat16VFSF_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_2_0= vfdiv_vf_f16m1_ta(vec_value_0_0, placeholder1, tail_vl);
...
uint64_t tmp[] = {14481,65535,16364,65535,15988,65535,14458,};
