// COMMAND: random_gen -r Vsuxei32V32VoidVBVUVU_m -n 1 -l 7 --has-ta --has-ma -c Vsuxei32V32VoidVBVUVU_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vsuxei32_v_u32m1_m (mask_value_0_0, placeholder3, vec_value_2_0, vec_value_1_0, vl);
placeholder0 += vl;
placeholder1 += vl;
placeholder2 += vl;
}
...
uint32_t tmp[] = {6151593u,0u,0u,0u,9199407u,0u,5979199u,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
