// COMMAND: random_gen -r FwmulVF16VFloat32VFSF_TA -n 1 -l 7 --has-ta --has-ma -c FwmulVF16VFloat32VFSF_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_2_0= vfwmul_vf_f32m2_ta(vec_value_0_0, placeholder1, tail_vl);
...
uint64_t tmp[] = {1275373464u,4294967295u,1290145744u,4294967295u,1287351912u,4294967295u,1275201776u,};
