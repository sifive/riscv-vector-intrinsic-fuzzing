// COMMAND: random_gen -r Sext_vf2V16VInt16VBVI_TAMA -n 1 -l 7 --has-ta --has-ma -c Sext_vf2V16VInt16VBVI_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m1_t vec_value_2_0= vsext_vf2_i16m1_tama(mask_value_0_0, vec_value_1_0, tail_vl);
