// COMMAND: random_gen -r FwcvtV8VFloat16VI -n 1 -l 7 --has-ta --has-ma -c FwcvtV8VFloat16VI.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m2_t vec_value_1_0= vfwcvt_f_x_v_f16m2(vec_value_0_0, vl);
...
uint64_t tmp[] = {54016,21744,21216,51968,20096,54416,54048,};
