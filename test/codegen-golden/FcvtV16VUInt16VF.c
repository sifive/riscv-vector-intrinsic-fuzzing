// COMMAND: random_gen -r FcvtV16VUInt16VF -n 1 -l 7 --has-ta --has-ma -c FcvtV16VUInt16VF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m1_t vec_value_1_0= vfcvt_xu_f_v_u16m1(vec_value_0_0, vl);
