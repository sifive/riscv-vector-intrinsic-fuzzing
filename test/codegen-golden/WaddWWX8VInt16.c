// COMMAND: random_gen -r WaddWWX8VInt16 -n 1 -l 7 --has-ta --has-ma -c WaddWWX8VInt16.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_2_0= vwadd_wx_i16m2(vec_value_0_0, placeholder1, vl);
...
int16_t tmp[] = {-5568,7871,5436,-1439,2574,-7248,-5652,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
