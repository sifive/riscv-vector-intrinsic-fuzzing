// COMMAND: random_gen -r FnmsacVF16VFloat16VBVFSFVF_TAMA -n 1 -l 7 --has-ta --has-ma -c FnmsacVF16VFloat16VBVFSFVF_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_4_0= vfnmsac_vf_f16m1_tama(mask_value_0_0, vec_value_1_0, placeholder2, vec_value_3_0, tail_vl);
...
int golden_vfnmsac_vf_operator_0() {
...
vfnmsac_vf_operator_0();
printf("operator_1 : %s\n", golden_vinit_rif_operator_1() ? "pass" : "fail");
printf("operator_4 : %s\n", golden_vinit_rif_operator_4() ? "pass" : "fail");
printf("operator_2 : %s\n", golden_vinit_rif_operator_2() ? "pass" : "fail");
printf("operator_3 : %s\n", golden_vinit_rif_operator_3() ? "pass" : "fail");
printf("operator_0 : %s\n", golden_vfnmsac_vf_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
