// COMMAND: random_gen -r MergeVXM8VInt8VBVISI -n 1 -l 7 --has-ta --has-ma -c MergeVXM8VInt8VBVISI.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_3_0= vmerge_vxm_i8m1(mask_value_0_0, vec_value_1_0, placeholder2, vl);
...
int8_t tmp[] = {50,-22,-22,16,-22,-26,29,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
