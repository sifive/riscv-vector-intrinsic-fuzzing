// COMMAND: random_gen -r FmaxVV16VFloat16VBVFVFVF_TUMA -n 1 -l 7 --has-ta --has-ma -c FmaxVV16VFloat16VBVFVFVF_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_4_0= vfmax_vv_f16m1_tuma(mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, tail_vl);
...
uint64_t tmp[] = {65535,29822,29383,29133,29100,26923,65535,};
