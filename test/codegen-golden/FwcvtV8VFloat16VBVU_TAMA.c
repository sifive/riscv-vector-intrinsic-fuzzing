// COMMAND: random_gen -r FwcvtV8VFloat16VBVU_TAMA -n 1 -l 7 --has-ta --has-ma -c FwcvtV8VFloat16VBVU_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m2_t vec_value_2_0= vfwcvt_f_xu_v_f16m2_tama(mask_value_0_0, vec_value_1_0, tail_vl);
...
uint64_t tmp[] = {65535,65535,20800,65535,21312,65535,65535,};
