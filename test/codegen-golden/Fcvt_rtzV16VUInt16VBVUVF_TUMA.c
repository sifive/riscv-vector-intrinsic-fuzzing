// COMMAND: random_gen -r Fcvt_rtzV16VUInt16VBVUVF_TUMA -n 1 -l 7 --has-ta --has-ma -c Fcvt_rtzV16VUInt16VBVUVF_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m1_t vec_value_3_0= vfcvt_rtz_xu_f_v_u16m1_tuma(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
uint16_t tmp[] = {65535,9200,8472,5940,11616,1323,65535,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
