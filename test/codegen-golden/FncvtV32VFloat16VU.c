// COMMAND: random_gen -r FncvtV32VFloat16VU -n 1 -l 7 --has-ta --has-ma -c FncvtV32VFloat16VU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16mf2_t vec_value_1_0= vfncvt_f_xu_w_f16mf2(vec_value_0_0, vl);
