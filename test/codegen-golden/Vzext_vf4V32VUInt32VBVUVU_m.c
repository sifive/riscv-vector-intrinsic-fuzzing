// COMMAND: random_gen -r Vzext_vf4V32VUInt32VBVUVU_m -n 1 -l 7 --has-ta --has-ma -c Vzext_vf4V32VUInt32VBVUVU_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint32m1_t vec_value_3_0= vzext_vf4_u32m1_m (mask_value_0_0, vec_value_1_0, vec_value_2_0, vl);
...
uint32_t tmp[] = {6442165u,75u,42u,5939507u,58u,1323058u,4632843u,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
