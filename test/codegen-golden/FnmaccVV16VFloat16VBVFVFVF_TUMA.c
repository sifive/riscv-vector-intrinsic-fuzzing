// COMMAND: random_gen -r FnmaccVV16VFloat16VBVFVFVF_TUMA -n 1 -l 7 --has-ta --has-ma -c FnmaccVV16VFloat16VBVFVFVF_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_4_0= vfnmacc_vv_f16m1_tuma(mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, tail_vl);
...
int golden_vfnmacc_vv_operator_0() {
...
vfnmacc_vv_operator_0();
printf("operator_1 : %s\n", golden_vinit_rif_operator_1() ? "pass" : "fail");
printf("operator_4 : %s\n", golden_vinit_rif_operator_4() ? "pass" : "fail");
printf("operator_2 : %s\n", golden_vinit_rif_operator_2() ? "pass" : "fail");
printf("operator_3 : %s\n", golden_vinit_rif_operator_3() ? "pass" : "fail");
printf("operator_0 : %s\n", golden_vfnmacc_vv_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
