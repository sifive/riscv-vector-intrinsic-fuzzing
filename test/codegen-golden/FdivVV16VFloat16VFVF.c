// COMMAND: random_gen -r FdivVV16VFloat16VFVF -n 1 -l 7 --has-ta --has-ma -c FdivVV16VFloat16VFVF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_2_0= vfdiv_vv_f16m1(vec_value_0_0, vec_value_1_0, vl);
...
uint64_t tmp[] = {14481,15557,16204,14884,15446,14902,14520,};
