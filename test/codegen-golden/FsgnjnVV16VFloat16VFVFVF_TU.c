// COMMAND: random_gen -r FsgnjnVV16VFloat16VFVFVF_TU -n 1 -l 7 --has-ta --has-ma -c FsgnjnVV16VFloat16VFVFVF_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_3_0= vfsgnjn_vv_f16m1_tu(vec_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
uint64_t tmp[] = {62026,29790,61911,28721,61954,26987,61574,};
