// COMMAND: random_gen -r FwmulVF16VFloat32VBVFSF_TAMA -n 1 -l 7 --has-ta --has-ma -c FwmulVF16VFloat32VBVFSF_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_3_0= vfwmul_vf_f32m2_tama(mask_value_0_0, vec_value_1_0, placeholder2, tail_vl);
...
uint64_t tmp[] = {4294967295u,4294967295u,1285978408u,4294967295u,1272229144u,4294967295u,4294967295u,};
