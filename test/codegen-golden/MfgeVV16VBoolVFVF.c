// COMMAND: random_gen -r MfgeVV16VBoolVFVF -n 1 -l 7 --has-ta --has-ma -c MfgeVV16VBoolVFVF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vbool16_t vec_value_2_0= vmfge_vv_f16m1_b16(vec_value_0_0, vec_value_1_0, vl);
