// COMMAND: random_gen -r Vluxei32V32VUInt32SUVU_TA -n 1 -l 7 --has-ta --has-ma -c Vluxei32V32VUInt32SUVU_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint32m1_t vec_value_2_0= vluxei32_v_u32m1_ta(placeholder0, vec_value_1_0, tail_vl);
