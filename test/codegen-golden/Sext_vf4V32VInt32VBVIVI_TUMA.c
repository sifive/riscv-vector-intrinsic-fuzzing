// COMMAND: random_gen -r Sext_vf4V32VInt32VBVIVI_TUMA -n 1 -l 7 --has-ta --has-ma -c Sext_vf4V32VInt32VBVIVI_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint32m1_t vec_value_3_0= vsext_vf4_i32m1_tuma(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
int32_t tmp[] = {-1,8398813,-15,1879014,16,-7353883,-1,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
