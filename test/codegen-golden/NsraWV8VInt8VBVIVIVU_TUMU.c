// COMMAND: random_gen -r NsraWV8VInt8VBVIVIVU_TUMU -n 1 -l 7 --has-ta --has-ma -c NsraWV8VInt8VBVIVIVU_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_4_0= vnsra_wv_i8m1_tumu(mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, tail_vl);
...
int golden_vnsra_wv_operator_0() {
int8_t tmp[] = {29,84,3,19,-4,-74,-7,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
...
printf("operator_0 : %s\n", golden_vnsra_wv_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
