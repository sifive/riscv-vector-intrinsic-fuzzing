// COMMAND: random_gen -r RedmaxuVS8SUInt8VU -n 1 -l 7 --has-ta --has-ma -c RedmaxuVS8SUInt8VU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder4 = vredmaxu_vs_u8m1_u8m1(placeholder4, vec_value_0_0, placeholder4, vl);
placeholder0 += vl;
}
