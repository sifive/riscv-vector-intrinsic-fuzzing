// COMMAND: random_gen -r WmaccVV8VInt16 -n 1 -l 7 --has-ta --has-ma -c WmaccVV8VInt16.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_3_0= vwmacc_vv_i16m2(vec_value_0_0, vec_value_1_0, vec_value_2_0, vl);
...
int16_t tmp[] = {-6184,12093,5158,-1189,2964,-2416,-5448,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
