// COMMAND: random_gen -r Vle8X8VInt8VBVISI_TUMU -n 1 -l 7 --has-ta --has-ma -c Vle8X8VInt8VBVISI_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_3_0= vle8_v_i8m1_tumu(mask_value_0_0, vec_value_1_0, placeholder2, tail_vl);
...
int golden_vle8_v_operator_0() {
int8_t tmp[] = {29,84,-15,19,16,-74,-7,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
...
printf("operator_0 : %s\n", golden_vle8_v_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
ret &= golden_vinit_rif_operator_1();
ret &= golden_vinit_rif_operator_3();
ret &= golden_vinit_rif_operator_2();
ret &= golden_vle8_v_operator_0();
if (!ret) return 1;
return 0; }
