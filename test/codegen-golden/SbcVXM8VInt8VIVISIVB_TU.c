// COMMAND: random_gen -r SbcVXM8VInt8VIVISIVB_TU -n 1 -l 7 --has-ta --has-ma -c SbcVXM8VInt8VIVISIVB_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_4_0= vsbc_vxm_i8m1_tu(vec_value_0_0, vec_value_1_0, placeholder2, mask_value_3_0, tail_vl);
...
int8_t tmp[] = {-41,79,-50,-14,-48,-73,-77,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
