// COMMAND: random_gen -r Fncvt_rtzV16VInt8VF_TA -n 1 -l 7 --has-ta --has-ma -c Fncvt_rtzV16VInt8VF_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8mf2_t vec_value_1_0= vfncvt_rtz_x_f_w_i8mf2_ta(vec_value_0_0, tail_vl);
