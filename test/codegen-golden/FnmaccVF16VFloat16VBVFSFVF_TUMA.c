// COMMAND: random_gen -r FnmaccVF16VFloat16VBVFSFVF_TUMA -n 1 -l 7 --has-ta --has-ma -c FnmaccVF16VFloat16VBVFSFVF_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_4_0= vfnmacc_vf_f16m1_tuma(mask_value_0_0, vec_value_1_0, placeholder2, vec_value_3_0, tail_vl);
...
int golden_vfnmacc_vf_operator_0() {
