// COMMAND: random_gen -r FaddVF16VFloat16VFSF -n 1 -l 7 --has-ta --has-ma -c FaddVF16VFloat16VFSF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_2_0= vfadd_vf_f16m1(vec_value_0_0, placeholder1, vl);
...
uint64_t tmp[] = {29180,30278,30126,29696,29947,28970,29170,};
