// COMMAND: random_gen -r FwaddWX16VFloat32VFSF -n 1 -l 7 --has-ta --has-ma -c FwaddWX16VFloat32VFSF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_2_0= vfwadd_wf_f32m2(vec_value_0_0, placeholder1, vl);
...
uint64_t tmp[] = {1250437964u,1267241206u,1265368270u,1258493403u,1262506504u,1244254744u,1250270228u,};
