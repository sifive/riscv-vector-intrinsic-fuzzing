// COMMAND: random_gen -r FwnmsacVF16VFloat32VBVFSFVF_TUMA -n 1 -l 7 --has-ta --has-ma -c FwnmsacVF16VFloat32VBVFSFVF_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_4_0= vfwnmsac_vf_f32m2_tuma(mask_value_0_0, vec_value_1_0, placeholder2, vec_value_3_0, tail_vl);
...
int golden_vfwnmsac_vf_operator_0() {
uint64_t tmp[] = {4294967295u,1267490606u,3439034848u,1261781606u,3442496299u,1243709844u,4294967295u,};
...
vfwnmsac_vf_operator_0();
printf("operator_1 : %s\n", golden_vinit_rif_operator_1() ? "pass" : "fail");
printf("operator_4 : %s\n", golden_vinit_rif_operator_4() ? "pass" : "fail");
printf("operator_2 : %s\n", golden_vinit_rif_operator_2() ? "pass" : "fail");
printf("operator_3 : %s\n", golden_vinit_rif_operator_3() ? "pass" : "fail");
printf("operator_0 : %s\n", golden_vfwnmsac_vf_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
