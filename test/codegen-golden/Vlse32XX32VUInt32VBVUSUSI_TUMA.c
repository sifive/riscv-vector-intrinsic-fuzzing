// COMMAND: random_gen -r Vlse32XX32VUInt32VBVUSUSI_TUMA -n 1 -l 7 --has-ta --has-ma -c Vlse32XX32VUInt32VBVUSUSI_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder3 *= 4;
vuint32m1_t vec_value_4_0= vlse32_v_u32m1_tuma(mask_value_0_0, vec_value_1_0, placeholder2, placeholder3, tail_vl);
...
uint32_t tmp[] = {4294967295u,4235251u,5939507u,5806864u,1323058u,3702157u,4294967295u,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
