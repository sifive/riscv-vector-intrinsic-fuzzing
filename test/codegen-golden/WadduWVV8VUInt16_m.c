// COMMAND: random_gen -r WadduWVV8VUInt16_m -n 1 -l 7 --has-ta --has-ma -c WadduWVV8VUInt16_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_4_0= vwaddu_vv_u16m2_m (mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, vl);
...
uint16_t tmp[] = {6442,111,112,5940,89,1323,4633,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
