// COMMAND: random_gen -r FwnmsacVF16VFloat32VBVFSFVF_TAMA -n 1 -l 7 --has-ta --has-ma -c FwnmsacVF16VFloat32VBVFSFVF_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_4_0= vfwnmsac_vf_f32m2_tama(mask_value_0_0, vec_value_1_0, placeholder2, vec_value_3_0, tail_vl);
...
uint64_t tmp[] = {4294967295u,4294967295u,3439034848u,4294967295u,3442496299u,4294967295u,4294967295u,};
