// COMMAND: random_gen -r FsubVF16VFloat16VFSF_TA -n 1 -l 7 --has-ta --has-ma -c FsubVF16VFloat16VFSF_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_2_0= vfsub_vf_f16m1_ta(vec_value_0_0, placeholder1, tail_vl);
...
uint64_t tmp[] = {60042,65535,28537,65535,27821,65535,60086,};
