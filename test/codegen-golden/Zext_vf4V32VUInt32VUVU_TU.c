// COMMAND: random_gen -r Zext_vf4V32VUInt32VUVU_TU -n 1 -l 7 --has-ta --has-ma -c Zext_vf4V32VUInt32VUVU_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint32m1_t vec_value_2_0= vzext_vf4_u32m1_tu(vec_value_0_0, vec_value_1_0, tail_vl);
...
uint32_t tmp[] = {39u,8946104u,42u,4291503u,58u,1387269u,37u,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
