// COMMAND: random_gen -r WmaccVV8VInt16VIVIVI_TA -n 1 -l 7 --has-ta --has-ma -c WmaccVV8VInt16VIVIVI_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_3_0= vwmacc_vv_i16m2_ta(vec_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
int16_t tmp[] = {-6184,-1,5158,-1,2964,-1,-5448,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
