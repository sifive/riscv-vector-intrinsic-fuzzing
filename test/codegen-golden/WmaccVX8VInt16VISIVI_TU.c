// COMMAND: random_gen -r WmaccVX8VInt16VISIVI_TU -n 1 -l 7 --has-ta --has-ma -c WmaccVX8VInt16VISIVI_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_3_0= vwmacc_vx_i16m2_tu(vec_value_0_0, placeholder1, vec_value_2_0, tail_vl);
...
int16_t tmp[] = {-6184,7893,5023,-1417,3060,-7226,-6384,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
