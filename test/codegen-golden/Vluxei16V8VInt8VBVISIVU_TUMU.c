// COMMAND: random_gen -r Vluxei16V8VInt8VBVISIVU_TUMU -n 1 -l 7 --has-ta --has-ma -c Vluxei16V8VInt8VBVISIVU_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_3_0= vle16_v_u16m2(placeholder3, vl);
if (7 < 65535) {
vuint16m2_t placeholder7= vmv_v_x_u16m2(0, vsetvlmax_e16m2());
vec_value_3_0 = vremu_vx_u16m2_m(mask_value_0_0, placeholder7, vec_value_3_0, 7, vl);
}
vec_value_3_0 = vmul_vx_u16m2(vec_value_3_0, 1, vl);
vint8m1_t vec_value_4_0= vluxei16_v_i8m1_tumu(mask_value_0_0, vec_value_1_0, placeholder2, vec_value_3_0, tail_vl);
...
int golden_vluxei16_v_operator_0() {
int8_t tmp[] = {29,84,70,19,-39,-74,-7,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
...
vluxei16_v_operator_0();
printf("operator_1 : %s\n", golden_vinit_rif_operator_1() ? "pass" : "fail");
printf("operator_4 : %s\n", golden_vinit_rif_operator_4() ? "pass" : "fail");
printf("operator_2 : %s\n", golden_vinit_rif_operator_2() ? "pass" : "fail");
printf("operator_3 : %s\n", golden_vinit_rif_operator_3() ? "pass" : "fail");
printf("operator_0 : %s\n", golden_vluxei16_v_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
