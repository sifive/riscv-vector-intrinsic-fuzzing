// COMMAND: random_gen -r RedxorVS8SInt8VBVIVI_TUM -n 1 -l 7 --has-ta --has-ma -c RedxorVS8SInt8VBVIVI_TUM.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder6 = vredxor_vs_i8m1_i8m1_tum(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder6, vl);
placeholder0 += vl;
placeholder1 += vl;
placeholder2 += vl;
placeholder3 += vl;
...
int golden_vredxor_vs_operator_0() {
int8_t tmp[] = {-45,84,20,19,23,-74,-7,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
...
vredxor_vs_operator_0();
printf("operator_1 : %s\n", golden_vinit_rif_operator_1() ? "pass" : "fail");
printf("operator_3 : %s\n", golden_vinit_rif_operator_3() ? "pass" : "fail");
printf("operator_2 : %s\n", golden_vinit_rif_operator_2() ? "pass" : "fail");
printf("operator_0 : %s\n", golden_vredxor_vs_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
ret &= golden_vinit_rif_operator_1();
ret &= golden_vinit_rif_operator_3();
ret &= golden_vinit_rif_operator_2();
ret &= golden_vredxor_vs_operator_0();
if (!ret) return 1;
return 0; }
