// COMMAND: random_gen -r XorVV8VInt8VIVIVI_TU -n 1 -l 7 --has-ta --has-ma -c XorVV8VInt8VIVIVI_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_3_0= vxor_vv_i8m1_tu(vec_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
