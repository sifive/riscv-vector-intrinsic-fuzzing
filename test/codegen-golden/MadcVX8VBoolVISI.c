// COMMAND: random_gen -r MadcVX8VBoolVISI -n 1 -l 7 --has-ta --has-ma -c MadcVX8VBoolVISI.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vbool8_t vec_value_2_0= vmadc_vx_i8m1_b8(vec_value_0_0, placeholder1, vl);
...
int golden_vmadc_vx_operator_0() {
...
printf("operator_0 : %s\n", golden_vmadc_vx_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
ret &= golden_vinit_rif_operator_1();
ret &= golden_vinit_rif_operator_2();
ret &= golden_vmadc_vx_operator_0();
if (!ret) return 1;
return 0; }
