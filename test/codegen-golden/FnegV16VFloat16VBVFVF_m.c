// COMMAND: random_gen -r FnegV16VFloat16VBVFVF_m -n 1 -l 7 --has-ta --has-ma -c FnegV16VFloat16VBVFVF_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_3_0= vfneg_v_f16m1_m (mask_value_0_0, vec_value_1_0, vec_value_2_0, vl);
...
uint64_t tmp[] = {29258,62291,61475,29133,61868,26923,28806,};
