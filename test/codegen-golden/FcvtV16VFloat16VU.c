// COMMAND: random_gen -r FcvtV16VFloat16VU -n 1 -l 7 --has-ta --has-ma -c FcvtV16VFloat16VU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_1_0= vfcvt_f_xu_v_f16m1(vec_value_0_0, vl);
...
uint64_t tmp[] = {26714,28766,28556,27697,28198,25963,26692,};
