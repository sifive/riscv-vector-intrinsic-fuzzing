// COMMAND: random_gen -r WmaccuVV8VUInt16VUVUVU_TU -n 1 -l 7 --has-ta --has-ma -c WmaccuVV8VUInt16VUVUVU_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_3_0= vwmaccu_vv_u16m2_tu(vec_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
uint16_t tmp[] = {4762,8946,10249,4291,9894,1387,3887,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
