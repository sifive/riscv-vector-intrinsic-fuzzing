// COMMAND: random_gen -r FmaxVV16VFloat16VFVF_TA -n 1 -l 7 --has-ta --has-ma -c FmaxVV16VFloat16VFVF_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_2_0= vfmax_vv_f16m1_ta(vec_value_0_0, vec_value_1_0, tail_vl);
...
uint64_t tmp[] = {28575,65535,29580,65535,29222,65535,28475,};
