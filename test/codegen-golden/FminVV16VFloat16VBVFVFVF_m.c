// COMMAND: random_gen -r FminVV16VFloat16VBVFVFVF_m -n 1 -l 7 --has-ta --has-ma -c FminVV16VFloat16VBVFVFVF_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_4_0= vfmin_vv_f16m1_m (mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, vl);
...
uint64_t tmp[] = {29258,28416,28707,29133,28160,26923,28806,};
