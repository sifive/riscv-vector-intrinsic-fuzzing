// COMMAND: random_gen -r FwmsacVF16VFloat32VBVFSFVF_TAMA -n 1 -l 7 --has-ta --has-ma -c FwmsacVF16VFloat32VBVFSFVF_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_4_0= vfwmsac_vf_f32m2_tama(mask_value_0_0, vec_value_1_0, placeholder2, vec_value_3_0, tail_vl);
...
uint64_t tmp[] = {4294967295u,4294967295u,1291551200u,4294967295u,1295012651u,4294967295u,4294967295u,};
