// COMMAND: random_gen -r AsubuVV8VUInt8VBVUVU_TAMA -n 1 -l 7 --has-ta --has-ma -c AsubuVV8VUInt8VBVUVU_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_3_0= vasubu_vv_u8m1_tama(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
uint8_t tmp[] = {255,255,9,255,2,255,255,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
