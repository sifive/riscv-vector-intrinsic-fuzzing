// COMMAND: random_gen -r FclassV16VUInt16VUVF_TU -n 1 -l 7 --has-ta --has-ma -c FclassV16VUInt16VUVF_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m1_t vec_value_2_0= vfclass_v_u16m1_tu(vec_value_0_0, vec_value_1_0, tail_vl);
...
uint16_t tmp[] = {64,8946,64,4291,64,1387,64,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
