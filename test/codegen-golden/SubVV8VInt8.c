// COMMAND: random_gen -r SubVV8VInt8 -n 1 -l 7 --has-ta --has-ma -c SubVV8VInt8.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_2_0= vsub_vv_i8m1(vec_value_0_0, vec_value_1_0, vl);
...
int8_t tmp[] = {-34,29,70,-26,10,-8,-31,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
