// COMMAND: random_gen -r WmaccsuVX8VInt16VISIVU_TA -n 1 -l 7 --has-ta --has-ma -c WmaccsuVX8VInt16VISIVU_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_3_0= vwmaccsu_vx_i16m2_ta(vec_value_0_0, placeholder1, vec_value_2_0, tail_vl);
...
int16_t tmp[] = {-4415,-1,6676,-1,4278,-1,-4557,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
