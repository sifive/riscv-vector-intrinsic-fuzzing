// COMMAND: random_gen -r Vsse32XX32VoidSIVI -n 1 -l 7 --has-ta --has-ma -c Vsse32XX32VoidSIVI.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder1 *= 4;
vsse32_v_i32m1(placeholder2, placeholder1, vec_value_0_0, vl);
