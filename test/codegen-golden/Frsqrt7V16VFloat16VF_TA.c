// COMMAND: random_gen -r Frsqrt7V16VFloat16VF_TA -n 1 -l 7 --has-ta --has-ma -c Frsqrt7V16VFloat16VF_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_1_0= vfrsqrt7_v_f16m1_ta(vec_value_0_0, tail_vl);
...
uint64_t tmp[] = {9136,65535,8224,65535,8336,65535,9144,};
