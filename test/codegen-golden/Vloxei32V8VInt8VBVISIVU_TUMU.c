// COMMAND: random_gen -r Vloxei32V8VInt8VBVISIVU_TUMU -n 1 -l 7 --has-ta --has-ma -c Vloxei32V8VInt8VBVISIVU_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint32m4_t vec_value_3_0= vle32_v_u32m4(placeholder3, vl);
if (7 < 4294967295) {
vuint32m4_t placeholder7= vmv_v_x_u32m4(0, vsetvlmax_e32m4());
vec_value_3_0 = vremu_vx_u32m4_m(mask_value_0_0, placeholder7, vec_value_3_0, 7, vl);
}
vec_value_3_0 = vmul_vx_u32m4(vec_value_3_0, 1, vl);
vint8m1_t vec_value_4_0= vloxei32_v_i8m1_tumu(mask_value_0_0, vec_value_1_0, placeholder2, vec_value_3_0, tail_vl);
...
int8_t tmp[] = {29,84,-40,19,70,-74,-7,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
