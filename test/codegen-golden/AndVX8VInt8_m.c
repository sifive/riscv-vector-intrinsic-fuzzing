// COMMAND: random_gen -r AndVX8VInt8_m -n 1 -l 7 --has-ta --has-ma -c AndVX8VInt8_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_4_0= vand_vx_i8m1_m (mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, vl);
