// COMMAND: random_gen -r FcvtV16VFloat16VU_TA -n 1 -l 7 --has-ta --has-ma -c FcvtV16VFloat16VU_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_1_0= vfcvt_f_xu_v_f16m1_ta(vec_value_0_0, tail_vl);
...
uint64_t tmp[] = {26714,65535,28556,65535,28198,65535,26692,};
