// COMMAND: random_gen -r FsgnjVV16VFloat16VBVFVF_TAMA -n 1 -l 7 --has-ta --has-ma -c FsgnjVV16VFloat16VBVFVF_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_3_0= vfsgnj_vv_f16m1_tama(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
