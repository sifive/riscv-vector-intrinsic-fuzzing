// COMMAND: random_gen -r FdivVF16VFloat16VBVFVFSF_TAMU -n 1 -l 7 --has-ta --has-ma -c FdivVF16VFloat16VBVFVFSF_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_4_0= vfdiv_vf_f16m1_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, tail_vl);
...
uint64_t tmp[] = {29523,65535,15895,65535,13677,65535,29258,};
