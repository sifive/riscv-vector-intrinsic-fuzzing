// COMMAND: random_gen -r Vlse8XX8VInt8VBVISISI_TUMU -n 1 -l 7 --has-ta --has-ma -c Vlse8XX8VInt8VBVISISI_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder3 *= 1;
vint8m1_t vec_value_4_0= vlse8_v_i8m1_tumu(mask_value_0_0, vec_value_1_0, placeholder2, placeholder3, tail_vl);
...
int8_t tmp[] = {50,-15,19,16,-74,-26,29,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
