// COMMAND: random_gen -r Vluxei32V8VInt8VBSIVU_TAMA -n 1 -l 7 --has-ta --has-ma -c Vluxei32V8VInt8VBSIVU_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
if (7 < 4294967295) {
vuint32m4_t placeholder6= vmv_v_x_u32m4(0, vsetvlmax_e32m4());
vec_value_2_0 = vremu_vx_u32m4_m(mask_value_0_0, placeholder6, vec_value_2_0, 7, vl);
}
vec_value_2_0 = vmul_vx_u32m4(vec_value_2_0, 1, vl);
vint8m1_t vec_value_3_0= vluxei32_v_i8m1_tama(mask_value_0_0, placeholder1, vec_value_2_0, tail_vl);
