// COMMAND: random_gen -r WadduVV8VUInt16VUVUVU_TU -n 1 -l 7 --has-ta --has-ma -c WadduVV8VUInt16VUVUVU_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_3_0= vwaddu_vv_u16m2_tu(vec_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
uint16_t tmp[] = {104,8946,102,4291,120,1387,83,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
