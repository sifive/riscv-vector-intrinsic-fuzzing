// COMMAND: random_gen -r AdcVXM8VInt8VISIVB -n 1 -l 7 --has-ta --has-ma -c AdcVXM8VInt8VISIVB.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_3_0= vadc_vxm_i8m1(vec_value_0_0, placeholder1, mask_value_2_0, vl);
...
int8_t tmp[] = {-27,109,84,16,56,-44,-28,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
