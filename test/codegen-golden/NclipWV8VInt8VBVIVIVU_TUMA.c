// COMMAND: random_gen -r NclipWV8VInt8VBVIVIVU_TUMA -n 1 -l 7 --has-ta --has-ma -c NclipWV8VInt8VBVIVIVU_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_4_0= vnclip_wv_i8m1_tuma(mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, tail_vl);
