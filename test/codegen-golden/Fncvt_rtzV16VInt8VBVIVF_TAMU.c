// COMMAND: random_gen -r Fncvt_rtzV16VInt8VBVIVF_TAMU -n 1 -l 7 --has-ta --has-ma -c Fncvt_rtzV16VInt8VBVIVF_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8mf2_t vec_value_3_0= vfncvt_rtz_x_f_w_i8mf2_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
