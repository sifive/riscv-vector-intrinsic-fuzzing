// COMMAND: random_gen -r Fncvt_rtzV16VUInt8VBVF_TAMA -n 1 -l 7 --has-ta --has-ma -c Fncvt_rtzV16VUInt8VBVF_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8mf2_t vec_value_2_0= vfncvt_rtz_xu_f_w_u8mf2_tama(mask_value_0_0, vec_value_1_0, tail_vl);
