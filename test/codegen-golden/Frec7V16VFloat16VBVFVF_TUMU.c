// COMMAND: random_gen -r Frec7V16VFloat16VBVFVF_TUMU -n 1 -l 7 --has-ta --has-ma -c Frec7V16VFloat16VBVFVF_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_3_0= vfrec7_v_f16m1_tumu(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
int golden_vfrec7_v_operator_0() {
uint64_t tmp[] = {29258,29822,1976,29133,1448,26923,28806,};
...
printf("operator_0 : %s\n", golden_vfrec7_v_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
ret &= golden_vinit_rif_operator_1();
ret &= golden_vinit_rif_operator_3();
ret &= golden_vinit_rif_operator_2();
ret &= golden_vfrec7_v_operator_0();
if (!ret) return 1;
return 0; }
