// COMMAND: random_gen -r MaxuVV8VUInt8VBVUVUVU_TAMU -n 1 -l 7 --has-ta --has-ma -c MaxuVV8VUInt8VBVUVUVU_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_4_0= vmaxu_vv_u8m1_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, tail_vl);
...
int golden_vmaxu_vv_operator_0() {
uint8_t tmp[] = {65,255,70,255,58,255,46,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
...
printf("operator_0 : %s\n", golden_vmaxu_vv_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
ret &= golden_vinit_rif_operator_1();
ret &= golden_vinit_rif_operator_4();
ret &= golden_vinit_rif_operator_2();
ret &= golden_vinit_rif_operator_3();
ret &= golden_vmaxu_vv_operator_0();
if (!ret) return 1;
return 0; }
