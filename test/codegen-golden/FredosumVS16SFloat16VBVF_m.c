// COMMAND: random_gen -r FredosumVS16SFloat16VBVF_m -n 1 -l 7 --has-ta --has-ma -c FredosumVS16SFloat16VBVF_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder5 = vfredosum_vs_f16m1_f16m1_m (mask_value_0_0, placeholder5, vec_value_1_0, placeholder5, vl);
placeholder0 += vl;
placeholder1 += vl;
}
...
converter.u16 = tmp;
converter2.f16 = value_2;
if(converter.f16 != value_2 && !(isNaNF16UI(converter.u16) && isNaNF16UI(converter2.u16))) {
return 0;
}
return 1;
}
