// COMMAND: random_gen -r FaddVF16VFloat16VBVFVFSF_TUMA -n 1 -l 7 --has-ta --has-ma -c FaddVF16VFloat16VBVFVFSF_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_4_0= vfadd_vf_f16m1_tuma(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, tail_vl);
...
int golden_vfadd_vf_operator_0() {
uint64_t tmp[] = {65535,28707,29902,29100,28954,28475,65535,};
...
printf("operator_0 : %s\n", golden_vfadd_vf_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
ret &= golden_vinit_rif_operator_1();
ret &= golden_vinit_rif_operator_4();
ret &= golden_vinit_rif_operator_2();
ret &= golden_vinit_rif_operator_3();
ret &= golden_vfadd_vf_operator_0();
if (!ret) return 1;
return 0; }
