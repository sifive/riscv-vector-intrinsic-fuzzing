// COMMAND: random_gen -r Vle32X32VFloat32VBVFSF_TUMA -n 1 -l 7 --has-ta --has-ma -c Vle32X32VFloat32VBVFSF_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m1_t vec_value_3_0= vle32_v_f32m1_tuma(mask_value_0_0, vec_value_1_0, placeholder2, tail_vl);
...
uint64_t tmp[] = {4294967295u,1267490606u,1258373094u,1261781606u,1261516319u,1243709844u,4294967295u,};
