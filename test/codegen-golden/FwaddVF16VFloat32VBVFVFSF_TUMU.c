// COMMAND: random_gen -r FwaddVF16VFloat32VBVFVFSF_TUMU -n 1 -l 7 --has-ta --has-ma -c FwaddVF16VFloat32VBVFVFSF_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_4_0= vfwadd_vf_f32m2_tumu(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, tail_vl);
...
uint64_t tmp[] = {1264903012u,1258373094u,1184483328u,1261516319u,1176717312u,1256322614u,1262786923u,};
