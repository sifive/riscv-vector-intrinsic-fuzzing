// COMMAND: random_gen -r FabsV16VFloat16VBVFVF_TAMU -n 1 -l 7 --has-ta --has-ma -c FabsV16VFloat16VBVFVF_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_3_0= vfabs_v_f16m1_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
int golden_vfabs_v_operator_0() {
uint64_t tmp[] = {29258,65535,28707,65535,29100,65535,28806,};
...
printf("operator_0 : %s\n", golden_vfabs_v_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
ret &= golden_vinit_rif_operator_1();
ret &= golden_vinit_rif_operator_3();
ret &= golden_vinit_rif_operator_2();
ret &= golden_vfabs_v_operator_0();
if (!ret) return 1;
return 0; }
