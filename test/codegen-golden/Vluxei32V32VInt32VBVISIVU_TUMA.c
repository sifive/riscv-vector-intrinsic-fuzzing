// COMMAND: random_gen -r Vluxei32V32VInt32VBVISIVU_TUMA -n 1 -l 7 --has-ta --has-ma -c Vluxei32V32VInt32VBVISIVU_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint32m1_t vec_value_4_0= vluxei32_v_i32m1_tuma(mask_value_0_0, vec_value_1_0, placeholder2, vec_value_3_0, tail_vl);
...
int32_t tmp[] = {-1,8398813,-3985701,1879014,6976038,-7353883,-1,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
