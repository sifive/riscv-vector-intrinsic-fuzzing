// COMMAND: random_gen -r RemVX8VInt8VBVIVISI_TUMU -n 1 -l 7 --has-ta --has-ma -c RemVX8VInt8VBVIVISI_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_4_0= vrem_vx_i8m1_tumu(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, tail_vl);
...
int golden_vrem_vx_operator_0() {
int8_t tmp[] = {50,-15,19,16,-8,-26,29,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
...
printf("operator_0 : %s\n", golden_vrem_vx_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
