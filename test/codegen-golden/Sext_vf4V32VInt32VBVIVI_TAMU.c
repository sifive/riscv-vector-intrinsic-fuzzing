// COMMAND: random_gen -r Sext_vf4V32VInt32VBVIVI_TAMU -n 1 -l 7 --has-ta --has-ma -c Sext_vf4V32VInt32VBVIVI_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint32m1_t vec_value_3_0= vsext_vf4_i32m1_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
int32_t tmp[] = {2884331,-1,-15,-1,16,-1,-734314,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
