// COMMAND: random_gen -r FredusumVS16SFloat16VF -n 1 -l 7 --has-ta --has-ma -c FredusumVS16SFloat16VF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder4 = vfredusum_vs_f16m1_f16m1(placeholder4, vec_value_0_0, placeholder4, vl);
placeholder0 += vl;
}
