// COMMAND: random_gen -r FwredusumVS16SFloat32VF -n 1 -l 7 --has-ta --has-ma -c FwredusumVS16SFloat32VF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder4 = vfwredusum_vs_f16m1_f32m1(placeholder4, vec_value_0_0, placeholder4, vl);
placeholder0 += vl;
}
