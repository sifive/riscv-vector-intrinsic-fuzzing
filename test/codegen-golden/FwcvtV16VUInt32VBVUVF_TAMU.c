// COMMAND: random_gen -r FwcvtV16VUInt32VBVUVF_TAMU -n 1 -l 7 --has-ta --has-ma -c FwcvtV16VUInt32VBVUVF_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint32m2_t vec_value_3_0= vfwcvt_xu_f_v_u32m2_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
