// COMMAND: random_gen -r MaccVX8VInt8VISIVI_TU -n 1 -l 7 --has-ta --has-ma -c MaccVX8VInt8VISIVI_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_3_0= vmacc_vx_i8m1_tu(vec_value_0_0, placeholder1, vec_value_2_0, tail_vl);
...
int8_t tmp[] = {74,79,-124,-14,-22,-73,-43,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
