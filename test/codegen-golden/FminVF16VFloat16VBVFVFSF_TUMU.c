// COMMAND: random_gen -r FminVF16VFloat16VBVFVFSF_TUMU -n 1 -l 7 --has-ta --has-ma -c FminVF16VFloat16VBVFVFSF_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_4_0= vfmin_vf_f16m1_tumu(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, tail_vl);
...
uint64_t tmp[] = {29523,28707,28575,29100,26923,28475,29258,};
