// COMMAND: random_gen -r FsubVF16VFloat16VFSF -n 1 -l 7 --has-ta --has-ma -c FsubVF16VFloat16VFSF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_2_0= vfsub_vf_f16m1(vec_value_0_0, placeholder1, vl);
...
uint64_t tmp[] = {60042,28908,28537,25112,27821,60650,60086,};
