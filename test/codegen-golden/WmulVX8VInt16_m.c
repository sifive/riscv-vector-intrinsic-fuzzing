// COMMAND: random_gen -r WmulVX8VInt16_m -n 1 -l 7 --has-ta --has-ma -c WmulVX8VInt16_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_4_0= vwmul_vx_i16m2_m (mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, vl);
...
int16_t tmp[] = {5001,-440,-418,1614,1628,-2596,2884,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
