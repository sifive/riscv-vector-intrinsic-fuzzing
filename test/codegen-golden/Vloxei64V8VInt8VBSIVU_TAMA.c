// COMMAND: random_gen -r Vloxei64V8VInt8VBSIVU_TAMA -n 1 -l 7 --has-ta --has-ma -c Vloxei64V8VInt8VBSIVU_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
{
vuint64m8_t placeholder6= vmv_v_x_u64m8(0, vsetvlmax_e64m8());
vec_value_2_0 = vremu_vx_u64m8_m(mask_value_0_0, placeholder6, vec_value_2_0, 7, vl);
}
vec_value_2_0 = vmul_vx_u64m8(vec_value_2_0, 1, vl);
vint8m1_t vec_value_3_0= vloxei64_v_i8m1_tama(mask_value_0_0, placeholder1, vec_value_2_0, tail_vl);
