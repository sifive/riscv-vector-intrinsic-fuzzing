// COMMAND: random_gen -r WadduWVV8VUInt16 -n 1 -l 7 --has-ta --has-ma -c WadduWVV8VUInt16.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_2_0= vwaddu_vv_u16m2(vec_value_0_0, vec_value_1_0, vl);
...
uint16_t tmp[] = {61,165,120,99,121,32,59,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
