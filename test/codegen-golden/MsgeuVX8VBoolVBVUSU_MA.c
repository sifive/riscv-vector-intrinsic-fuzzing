// COMMAND: random_gen -r MsgeuVX8VBoolVBVUSU_MA -n 1 -l 7 --has-ta --has-ma -c MsgeuVX8VBoolVBVUSU_MA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vbool8_t vec_value_3_0= vmsgeu_vx_u8m1_b8_ma(mask_value_0_0, vec_value_1_0, placeholder2, vl);
...
int golden_vmsgeu_vx_operator_0() {
int8_t tmp[] = {1,1,1,1,0,1,1,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
...
vmsgeu_vx_operator_0();
printf("operator_1 : %s\n", golden_vinit_rif_operator_1() ? "pass" : "fail");
printf("operator_3 : %s\n", golden_vinit_rif_operator_3() ? "pass" : "fail");
printf("operator_2 : %s\n", golden_vinit_rif_operator_2() ? "pass" : "fail");
printf("operator_0 : %s\n", golden_vmsgeu_vx_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
ret &= golden_vinit_rif_operator_1();
ret &= golden_vinit_rif_operator_3();
ret &= golden_vinit_rif_operator_2();
ret &= golden_vmsgeu_vx_operator_0();
if (!ret) return 1;
return 0; }
