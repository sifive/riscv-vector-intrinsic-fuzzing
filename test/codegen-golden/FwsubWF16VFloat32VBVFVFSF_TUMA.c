// COMMAND: random_gen -r FwsubWF16VFloat32VBVFVFSF_TUMA -n 1 -l 7 --has-ta --has-ma -c FwsubWF16VFloat32VBVFVFSF_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_4_0= vfwsub_wf_f32m2_tuma(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, tail_vl);
...
uint64_t tmp[] = {4294967295u,1258373094u,1261773802u,1261516319u,1243678628u,1256322614u,4294967295u,};
