// COMMAND: random_gen -r FsqrtV16VFloat16VF_TA -n 1 -l 7 --has-ta --has-ma -c FsqrtV16VFloat16VF_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_1_0= vfsqrt_v_f16m1_ta(vec_value_0_0, tail_vl);
...
uint64_t tmp[] = {21548,65535,22469,65535,22275,65535,21537,};
