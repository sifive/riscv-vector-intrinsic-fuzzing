// COMMAND: random_gen -r IotaM8VUInt8VB_TA -n 1 -l 7 --has-ta --has-ma -c IotaM8VUInt8VB_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_1_0= viota_m_u8m1_ta(mask_value_0_0, tail_vl);
vec_value_1_0 = vadd_vx_u8m1_ta(vec_value_1_0, placeholder3, tail_vl);
vse8_v_u8m1(placeholder1, vec_value_1_0, vl);
placeholder3 += vcpop_m_b8(mask_value_0_0, tail_vl);
placeholder0 += vl;
placeholder1 += vl;
}
}
...
uint8_t tmp[] = {0,255,0,255,1,255,2,};
for (int i=0; i<7;++i)
if(value_1[i] != tmp[i]) {
return 0;
}
