// COMMAND: random_gen -r WmaccsuVV8VInt16VIVIVU_TU -n 1 -l 7 --has-ta --has-ma -c WmaccsuVV8VInt16VIVIVU_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_3_0= vwmaccsu_vv_i16m2_tu(vec_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
int16_t tmp[] = {-4415,7893,6298,-1417,3930,-7226,-5889,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
