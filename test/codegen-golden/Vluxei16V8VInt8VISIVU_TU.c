// COMMAND: random_gen -r Vluxei16V8VInt8VISIVU_TU -n 1 -l 7 --has-ta --has-ma -c Vluxei16V8VInt8VISIVU_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_3_0= vluxei16_v_i8m1_tu(vec_value_0_0, placeholder1, vec_value_2_0, tail_vl);
