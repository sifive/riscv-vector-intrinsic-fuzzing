// COMMAND: random_gen -r NotV8VInt8VI_TA -n 1 -l 7 --has-ta --has-ma -c NotV8VInt8VI_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_1_0= vnot_v_i8m1_ta(vec_value_0_0, tail_vl);
