// COMMAND: random_gen -r FdivVF16VFloat16VFSF -n 1 -l 7 --has-ta --has-ma -c FdivVF16VFloat16VFSF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_2_0= vfdiv_vf_f16m1(vec_value_0_0, placeholder1, vl);
...
uint64_t tmp[] = {14481,16534,16364,15462,15988,13744,14458,};
