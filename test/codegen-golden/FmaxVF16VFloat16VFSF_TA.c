// COMMAND: random_gen -r FmaxVF16VFloat16VFSF_TA -n 1 -l 7 --has-ta --has-ma -c FmaxVF16VFloat16VFSF_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_2_0= vfmax_vf_f16m1_ta(vec_value_0_0, placeholder1, tail_vl);
...
uint64_t tmp[] = {28575,65535,29580,65535,29222,65535,28575,};
