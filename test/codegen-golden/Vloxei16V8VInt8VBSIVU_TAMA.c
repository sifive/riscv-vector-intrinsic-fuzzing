// COMMAND: random_gen -r Vloxei16V8VInt8VBSIVU_TAMA -n 1 -l 7 --has-ta --has-ma -c Vloxei16V8VInt8VBSIVU_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_3_0= vloxei16_v_i8m1_tama(mask_value_0_0, placeholder1, vec_value_2_0, tail_vl);
