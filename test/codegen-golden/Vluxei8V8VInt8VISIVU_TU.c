// COMMAND: random_gen -r Vluxei8V8VInt8VISIVU_TU -n 1 -l 7 --has-ta --has-ma -c Vluxei8V8VInt8VISIVU_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
if (7 < 255) {
vec_value_2_0 = vremu_vx_u8m1(vec_value_2_0, 7, vl);
}
vec_value_2_0 = vmul_vx_u8m1(vec_value_2_0, 1, vl);
vint8m1_t vec_value_3_0= vluxei8_v_i8m1_tu(vec_value_0_0, placeholder1, vec_value_2_0, tail_vl);
...
int8_t tmp[] = {23,79,29,-14,20,-73,20,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
