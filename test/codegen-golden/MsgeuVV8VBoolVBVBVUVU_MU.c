// COMMAND: random_gen -r MsgeuVV8VBoolVBVBVUVU_MU -n 1 -l 7 --has-ta --has-ma -c MsgeuVV8VBoolVBVBVUVU_MU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vbool8_t vec_value_4_0= vmsgeu_vv_u8m1_b8_mu(mask_value_0_0, mask_value_1_0, vec_value_2_0, vec_value_3_0, vl);
...
int golden_vmsgeu_vv_operator_0() {
int8_t tmp[] = {1,0,1,1,0,0,0,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
