// COMMAND: random_gen -r WredsumuVS8SUInt16VBVU_m -n 1 -l 7 --has-ta --has-ma -c WredsumuVS8SUInt16VBVU_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder5 = vwredsumu_vs_u8m1_u16m1_m (mask_value_0_0, placeholder5, vec_value_1_0, placeholder5, vl);
placeholder0 += vl;
placeholder1 += vl;
}
