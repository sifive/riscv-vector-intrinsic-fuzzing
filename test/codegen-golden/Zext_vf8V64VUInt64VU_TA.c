// COMMAND: random_gen -r Zext_vf8V64VUInt64VU_TA -n 1 -l 7 --has-ta --has-ma -c Zext_vf8V64VUInt64VU_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint64m1_t vec_value_1_0= vzext_vf8_u64m1_ta(vec_value_0_0, tail_vl);
...
uint64_t tmp[] = {22ull,18446744073709551615ull,78ull,18446744073709551615ull,63ull,18446744073709551615ull,22ull,};
for (int i=0; i<7;++i)
if(value_1[i] != tmp[i]) {
return 0;
}
