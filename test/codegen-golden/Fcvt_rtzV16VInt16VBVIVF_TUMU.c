// COMMAND: random_gen -r Fcvt_rtzV16VInt16VBVIVF_TUMU -n 1 -l 7 --has-ta --has-ma -c Fcvt_rtzV16VInt16VBVIVF_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
void vfcvt_rtz_x_f_v_operator_0() {
...
vint16m1_t vec_value_3_0= vfcvt_rtz_x_f_v_i16m1_tumu(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
int golden_vfcvt_rtz_x_f_v_operator_0() {
int16_t tmp[] = {2884,8399,8472,1879,11616,-7354,-734,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
...
vfcvt_rtz_x_f_v_operator_0();
printf("operator_1 : %s\n", golden_vinit_rif_operator_1() ? "pass" : "fail");
printf("operator_3 : %s\n", golden_vinit_rif_operator_3() ? "pass" : "fail");
printf("operator_2 : %s\n", golden_vinit_rif_operator_2() ? "pass" : "fail");
printf("operator_0 : %s\n", golden_vfcvt_rtz_x_f_v_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
ret &= golden_vinit_rif_operator_1();
ret &= golden_vinit_rif_operator_3();
ret &= golden_vinit_rif_operator_2();
ret &= golden_vfcvt_rtz_x_f_v_operator_0();
if (!ret) return 1;
return 0; }
