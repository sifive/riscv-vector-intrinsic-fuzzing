// COMMAND: random_gen -r MaddVX8VInt8VISIVI_TU -n 1 -l 7 --has-ta --has-ma -c MaddVX8VInt8VISIVI_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_3_0= vmadd_vx_i8m1_tu(vec_value_0_0, placeholder1, vec_value_2_0, tail_vl);
...
int8_t tmp[] = {-110,79,44,-14,2,-73,113,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
