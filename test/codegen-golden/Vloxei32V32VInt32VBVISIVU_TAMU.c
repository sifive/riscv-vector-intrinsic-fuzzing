// COMMAND: random_gen -r Vloxei32V32VInt32VBVISIVU_TAMU -n 1 -l 7 --has-ta --has-ma -c Vloxei32V32VInt32VBVISIVU_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint32m1_t vec_value_4_0= vloxei32_v_i32m1_tamu(mask_value_0_0, vec_value_1_0, placeholder2, vec_value_3_0, tail_vl);
...
int32_t tmp[] = {2884331,-1,-3985701,-1,6976038,-1,-734314,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
