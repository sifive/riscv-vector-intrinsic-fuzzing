// COMMAND: random_gen -r Vle32X32VFloat32VFSF_TU -n 1 -l 7 --has-ta --has-ma -c Vle32X32VFloat32VFSF_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m1_t vec_value_2_0= vle32_v_f32m1_tu(vec_value_0_0, placeholder1, tail_vl);
...
uint64_t tmp[] = {1257125040u,1267237304u,1258373094u,1258485599u,1261516319u,1244223528u,1256322614u,};
