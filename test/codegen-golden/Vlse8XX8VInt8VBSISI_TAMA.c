// COMMAND: random_gen -r Vlse8XX8VInt8VBSISI_TAMA -n 1 -l 7 --has-ta --has-ma -c Vlse8XX8VInt8VBSISI_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder2 *= 1;
vint8m1_t vec_value_3_0= vlse8_v_i8m1_tama(mask_value_0_0, placeholder1, placeholder2, tail_vl);
