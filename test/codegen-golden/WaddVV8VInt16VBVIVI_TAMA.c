// COMMAND: random_gen -r WaddVV8VInt16VBVIVI_TAMA -n 1 -l 7 --has-ta --has-ma -c WaddVV8VInt16VBVIVI_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_3_0= vwadd_vv_i16m2_tama(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
