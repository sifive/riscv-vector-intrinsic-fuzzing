// COMMAND: random_gen -r Vle32X32VUInt32VUSU_TU -n 1 -l 7 --has-ta --has-ma -c Vle32X32VUInt32VUSU_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint32m1_t vec_value_2_0= vle32_v_u32m1_tu(vec_value_0_0, placeholder1, tail_vl);
...
uint32_t tmp[] = {3902764u,8946104u,4235251u,4291503u,5806864u,1387269u,3702157u,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
