// COMMAND: random_gen -r FsubVF16VFloat16VBVFVFSF_TAMU -n 1 -l 7 --has-ta --has-ma -c FsubVF16VFloat16VBVFVFSF_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_4_0= vfsub_vf_f16m1_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, tail_vl);
...
int golden_vfsub_vf_operator_0() {
uint64_t tmp[] = {29523,65535,27638,65535,60682,65535,29258,};
...
printf("operator_0 : %s\n", golden_vfsub_vf_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
ret &= golden_vinit_rif_operator_1();
ret &= golden_vinit_rif_operator_4();
ret &= golden_vinit_rif_operator_2();
ret &= golden_vinit_rif_operator_3();
ret &= golden_vfsub_vf_operator_0();
if (!ret) return 1;
return 0; }
