// COMMAND: random_gen -r WredsumVS8SInt16VBVIVI_TUM -n 1 -l 7 --has-ta --has-ma -c WredsumVS8SInt16VBVIVI_TUM.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m1_t placeholder6= vmv_v_v_i16m1(placeholder5, vsetvlmax_e16m1());
...
placeholder6 = vwredsum_vs_i8m1_i16m1_tum(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder6, vl);
placeholder0 += vl;
placeholder1 += vl;
placeholder2 += vl;
placeholder3 += vl;
}
int16_t *placeholder7 = value_3;
*placeholder7= vmv_x_s_i16m1_i16(placeholder6);
}
...
int16_t tmp[] = {51,8399,1958,1879,2303,-7354,-734,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
