// COMMAND: random_gen -r WmulsuVV8VInt16 -n 1 -l 7 --has-ta --has-ma -c WmulsuVV8VInt16.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_2_0= vwmulsu_vv_i16m2(vec_value_0_0, vec_value_1_0, vl);
...
int16_t tmp[] = {-2184,5925,2310,-784,1508,-1314,-2109,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
