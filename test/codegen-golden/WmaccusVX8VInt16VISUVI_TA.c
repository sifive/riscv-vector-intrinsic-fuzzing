// COMMAND: random_gen -r WmaccusVX8VInt16VISUVI_TA -n 1 -l 7 --has-ta --has-ma -c WmaccusVX8VInt16VISUVI_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_3_0= vwmaccus_vx_i16m2_ta(vec_value_0_0, placeholder1, vec_value_2_0, tail_vl);
...
int16_t tmp[] = {-6976,-1,4483,-1,3636,-1,-7320,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
