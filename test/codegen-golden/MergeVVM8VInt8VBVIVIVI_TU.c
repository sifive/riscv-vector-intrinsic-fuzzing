// COMMAND: random_gen -r MergeVVM8VInt8VBVIVIVI_TU -n 1 -l 7 --has-ta --has-ma -c MergeVVM8VInt8VBVIVIVI_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_4_0= vmerge_vvm_i8m1_tu(mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, tail_vl);
...
int golden_vmerge_vvm_operator_0() {
int8_t tmp[] = {70,84,-15,19,16,-74,-40,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
