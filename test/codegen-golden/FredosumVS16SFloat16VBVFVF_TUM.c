// COMMAND: random_gen -r FredosumVS16SFloat16VBVFVF_TUM -n 1 -l 7 --has-ta --has-ma -c FredosumVS16SFloat16VBVFVF_TUM.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t placeholder5= vfmv_v_f_f16m1(0, vsetvlmax_e16m1());
vfloat16m1_t placeholder6= vmv_v_v_f16m1(placeholder5, vsetvlmax_e16m1());
...
placeholder6 = vfredosum_vs_f16m1_f16m1_tum(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder6, vl);
placeholder0 += vl;
placeholder1 += vl;
placeholder2 += vl;
placeholder3 += vl;
}
float16_t *placeholder7 = value_3;
*placeholder7= vfmv_f_s_f16m1_f16(placeholder6);
}
...
int golden_vfredosum_vs_operator_0() {
uint64_t tmp[] = {30792,29822,29143,29133,29186,26923,28806,};
...
vfredosum_vs_operator_0();
printf("operator_1 : %s\n", golden_vinit_rif_operator_1() ? "pass" : "fail");
printf("operator_3 : %s\n", golden_vinit_rif_operator_3() ? "pass" : "fail");
printf("operator_2 : %s\n", golden_vinit_rif_operator_2() ? "pass" : "fail");
printf("operator_0 : %s\n", golden_vfredosum_vs_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
ret &= golden_vinit_rif_operator_1();
ret &= golden_vinit_rif_operator_3();
ret &= golden_vinit_rif_operator_2();
ret &= golden_vfredosum_vs_operator_0();
if (!ret) return 1;
return 0; }
