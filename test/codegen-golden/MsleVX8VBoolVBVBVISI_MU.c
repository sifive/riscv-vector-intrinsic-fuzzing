// COMMAND: random_gen -r MsleVX8VBoolVBVBVISI_MU -n 1 -l 7 --has-ta --has-ma -c MsleVX8VBoolVBVBVISI_MU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vbool8_t vec_value_4_0= vmsle_vx_i8m1_b8_mu(mask_value_0_0, mask_value_1_0, vec_value_2_0, placeholder3, vl);
...
int golden_vmsle_vx_operator_0() {
...
printf("operator_0 : %s\n", golden_vmsle_vx_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
ret &= golden_vinit_rif_operator_1();
ret &= golden_vinit_rif_operator_4();
ret &= golden_vinit_rif_operator_2();
ret &= golden_vinit_rif_operator_3();
ret &= golden_vmsle_vx_operator_0();
if (!ret) return 1;
return 0; }
