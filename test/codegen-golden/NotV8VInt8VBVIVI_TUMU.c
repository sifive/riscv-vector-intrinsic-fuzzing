// COMMAND: random_gen -r NotV8VInt8VBVIVI_TUMU -n 1 -l 7 --has-ta --has-ma -c NotV8VInt8VBVIVI_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_3_0= vnot_v_i8m1_tumu(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
int8_t tmp[] = {29,84,14,19,-17,-74,-7,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
