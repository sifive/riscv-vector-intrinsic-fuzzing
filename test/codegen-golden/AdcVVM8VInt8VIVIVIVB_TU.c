// COMMAND: random_gen -r AdcVVM8VInt8VIVIVIVB_TU -n 1 -l 7 --has-ta --has-ma -c AdcVVM8VInt8VIVIVIVB_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_4_0= vadc_vvm_i8m1_tu(vec_value_0_0, vec_value_1_0, vec_value_2_0, mask_value_3_0, tail_vl);
...
int golden_vadc_vvm_operator_0() {
int8_t tmp[] = {99,79,59,-14,-15,-73,-47,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
...
printf("operator_0 : %s\n", golden_vadc_vvm_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
ret &= golden_vinit_rif_operator_1();
ret &= golden_vinit_rif_operator_4();
ret &= golden_vinit_rif_operator_2();
ret &= golden_vinit_rif_operator_3();
ret &= golden_vadc_vvm_operator_0();
if (!ret) return 1;
return 0; }
