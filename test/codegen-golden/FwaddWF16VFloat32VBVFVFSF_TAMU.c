// COMMAND: random_gen -r FwaddWF16VFloat32VBVFVFSF_TAMU -n 1 -l 7 --has-ta --has-ma -c FwaddWF16VFloat32VBVFVFSF_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_4_0= vfwadd_wf_f32m2_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, tail_vl);
...
uint64_t tmp[] = {1264903012u,4294967295u,1261789410u,4294967295u,1243741060u,4294967295u,1262786923u,};
