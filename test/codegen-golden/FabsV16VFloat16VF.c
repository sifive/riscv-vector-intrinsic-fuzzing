// COMMAND: random_gen -r FabsV16VFloat16VF -n 1 -l 7 --has-ta --has-ma -c FabsV16VFloat16VF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_1_0= vfabs_v_f16m1(vec_value_0_0, vl);
