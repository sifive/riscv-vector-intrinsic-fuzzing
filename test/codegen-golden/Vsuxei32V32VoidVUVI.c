// COMMAND: random_gen -r Vsuxei32V32VoidVUVI -n 1 -l 7 --has-ta --has-ma -c Vsuxei32V32VoidVUVI.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vsuxei32_v_i32m1(placeholder2, vec_value_1_0, vec_value_0_0, vl);
placeholder0 += vl;
placeholder1 += vl;
}
}
