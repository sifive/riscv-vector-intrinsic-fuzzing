// COMMAND: random_gen -r WadduWWX8VUInt16 -n 1 -l 7 --has-ta --has-ma -c WadduWWX8VUInt16.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_2_0= vwaddu_wx_u16m2(vec_value_0_0, placeholder1, vl);
...
uint16_t tmp[] = {2266,8985,7768,4330,6337,1426,2224,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
