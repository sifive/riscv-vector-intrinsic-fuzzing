// COMMAND: random_gen -r FwmulVF16VFloat32VBVFVFSF_TAMU -n 1 -l 7 --has-ta --has-ma -c FwmulVF16VFloat32VBVFVFSF_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_4_0= vfwmul_vf_f32m2_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, tail_vl);
...
uint64_t tmp[] = {1264903012u,4294967295u,1286657356u,4294967295u,1268615892u,4294967295u,1262786923u,};
