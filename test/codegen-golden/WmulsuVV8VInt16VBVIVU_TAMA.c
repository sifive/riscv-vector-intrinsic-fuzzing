// COMMAND: random_gen -r WmulsuVV8VInt16VBVIVU_TAMA -n 1 -l 7 --has-ta --has-ma -c WmulsuVV8VInt16VBVIVU_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_3_0= vwmulsu_vv_i16m2_tama(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
int16_t tmp[] = {-1,-1,840,-1,1334,-1,-1,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
