// COMMAND: random_gen -r MsleuVX8VBoolVBVBVUSU_MU -n 1 -l 7 --has-ta --has-ma -c MsleuVX8VBoolVBVBVUSU_MU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vbool8_t vec_value_4_0= vmsleu_vx_u8m1_b8_mu(mask_value_0_0, mask_value_1_0, vec_value_2_0, placeholder3, vl);
...
int golden_vmsleu_vx_operator_0() {
int8_t tmp[] = {1,0,0,1,1,0,1,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
