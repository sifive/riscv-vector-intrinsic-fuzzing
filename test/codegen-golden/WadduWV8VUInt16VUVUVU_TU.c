// COMMAND: random_gen -r WadduWV8VUInt16VUVUVU_TU -n 1 -l 7 --has-ta --has-ma -c WadduWV8VUInt16VUVUVU_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_3_0= vwaddu_wv_u16m2_tu(vec_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
uint16_t tmp[] = {6481,8946,6021,4291,6210,1387,4670,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
