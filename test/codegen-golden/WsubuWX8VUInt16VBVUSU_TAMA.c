// COMMAND: random_gen -r WsubuWX8VUInt16VBVUSU_TAMA -n 1 -l 7 --has-ta --has-ma -c WsubuWX8VUInt16VBVUSU_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_3_0= vwsubu_wx_u16m2_tama(mask_value_0_0, vec_value_1_0, placeholder2, tail_vl);
...
uint16_t tmp[] = {65535,65535,5553,65535,1747,65535,65535,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
