// COMMAND: random_gen -r WmaccsuVX8VInt16 -n 1 -l 7 --has-ta --has-ma -c WmaccsuVX8VInt16.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_3_0= vwmaccsu_vx_i16m2(vec_value_0_0, placeholder1, vec_value_2_0, vl);
...
int16_t tmp[] = {-4415,10068,6676,207,4278,-6704,-4557,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
