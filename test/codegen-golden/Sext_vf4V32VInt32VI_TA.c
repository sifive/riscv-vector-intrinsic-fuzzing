// COMMAND: random_gen -r Sext_vf4V32VInt32VI_TA -n 1 -l 7 --has-ta --has-ma -c Sext_vf4V32VInt32VI_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vl = 2;
size_t tail_vl = 1;
vint8mf4_t vec_value_0_0= vle8_v_i8mf4(placeholder0, vl);

vint32m1_t vec_value_1_0= vsext_vf4_i32m1_ta(vec_value_0_0, tail_vl);
