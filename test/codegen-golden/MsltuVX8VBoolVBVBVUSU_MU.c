// COMMAND: random_gen -r MsltuVX8VBoolVBVBVUSU_MU -n 1 -l 7 --has-ta --has-ma -c MsltuVX8VBoolVBVBVUSU_MU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vbool8_t vec_value_4_0= vmsltu_vx_u8m1_b8_mu(mask_value_0_0, mask_value_1_0, vec_value_2_0, placeholder3, vl);
...
int golden_vmsltu_vx_operator_0() {
