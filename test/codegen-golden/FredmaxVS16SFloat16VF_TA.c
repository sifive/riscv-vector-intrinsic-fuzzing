// COMMAND: random_gen -r FredmaxVS16SFloat16VF_TA -n 1 -l 7 --has-ta --has-ma -c FredmaxVS16SFloat16VF_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder4 = vfredmax_vs_f16m1_f16m1_ta(vec_value_0_0, placeholder4, vl);
placeholder0 += vl;
placeholder1 += vl;
}
...
uint64_t tmp[] = {29790,65535,65535,65535,65535,65535,65535,};
