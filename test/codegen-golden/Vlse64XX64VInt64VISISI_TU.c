// COMMAND: random_gen -r Vlse64XX64VInt64VISISI_TU -n 1 -l 7 --has-ta --has-ma -c Vlse64XX64VInt64VISISI_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
if (placeholder8 < 7) {
vint64m1_t placeholder9= vmv_v_x_i64m1(0, vsetvlmax_e64m1());
vse64_v_i64m1(placeholder3, placeholder9, vl);
...
placeholder2 *= 8;
vint64m1_t vec_value_3_0= vlse64_v_i64m1_tu(vec_value_0_0, placeholder1, placeholder2, tail_vl);
vse64_v_i64m1(placeholder3, vec_value_3_0, vl);
vl = placeholder10; // recover vl
placeholder2 = placeholder11; // recover stride
}
else {
vint64m1_t placeholder12= vmv_v_x_i64m1(0, vsetvlmax_e64m1());
vse64_v_i64m1(placeholder3, placeholder12, vl);
};
placeholder0 += vl;
...
int64_t tmp[] = {5000420ll,7892207ll,1184154ll,-1416993ll,-6426492ll,-7225462ll,2884331ll,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
