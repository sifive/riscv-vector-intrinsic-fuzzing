// COMMAND: random_gen -r WsubuWX8VUInt16VBVUVUSU_TUMA -n 1 -l 7 --has-ta --has-ma -c WsubuWX8VUInt16VBVUVUSU_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_4_0= vwsubu_wx_u16m2_tuma(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, tail_vl);
...
uint16_t tmp[] = {65535,4235,5901,5807,1284,3702,65535,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
