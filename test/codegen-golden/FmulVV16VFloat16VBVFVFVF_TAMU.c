// COMMAND: random_gen -r FmulVV16VFloat16VBVFVFVF_TAMU -n 1 -l 7 --has-ta --has-ma -c FmulVV16VFloat16VBVFVFVF_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_4_0= vfmul_vv_f16m1_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, tail_vl);
...
int golden_vfmul_vv_operator_0() {
...
printf("operator_0 : %s\n", golden_vfmul_vv_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
