// COMMAND: random_gen -r Vluxei32V32VFloat32VFSFVU_TU -n 1 -l 7 --has-ta --has-ma -c Vluxei32V32VFloat32VFSFVU_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m1_t vec_value_3_0= vluxei32_v_f32m1_tu(vec_value_0_0, placeholder1, vec_value_2_0, tail_vl);
