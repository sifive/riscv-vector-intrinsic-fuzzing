// COMMAND: random_gen -r Vsse32XX32VoidVBSIVF_m -n 1 -l 7 --has-ta --has-ma -c Vsse32XX32VoidVBSIVF_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder2 *= 4;
vsse32_v_f32m1_m (mask_value_0_0, placeholder3, placeholder2, vec_value_1_0, vl);
...
uint64_t tmp[] = {0u,1258373094u,1261086746u,0u,1247419408u,0u,0u,};
