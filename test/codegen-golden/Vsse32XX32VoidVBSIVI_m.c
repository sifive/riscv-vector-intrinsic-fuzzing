// COMMAND: random_gen -r Vsse32XX32VoidVBSIVI_m -n 1 -l 7 --has-ta --has-ma -c Vsse32XX32VoidVBSIVI_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder2 *= 4;
vsse32_v_i32m1_m (mask_value_0_0, placeholder3, placeholder2, vec_value_1_0, vl);
...
int32_t tmp[] = {0,-1529498,1184154,0,-6426492,0,0,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
