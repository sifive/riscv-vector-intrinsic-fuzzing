// COMMAND: random_gen -r Vluxei8V8VInt8VBVISIVU_TUMU -n 1 -l 7 --has-ta --has-ma -c Vluxei8V8VInt8VBVISIVU_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
if (7 < 255) {
vuint8m1_t placeholder7= vmv_v_x_u8m1(0, vsetvlmax_e8m1());
vec_value_3_0 = vremu_vx_u8m1_m(mask_value_0_0, placeholder7, vec_value_3_0, 7, vl);
}
vec_value_3_0 = vmul_vx_u8m1(vec_value_3_0, 1, vl);
vint8m1_t vec_value_4_0= vluxei8_v_i8m1_tumu(mask_value_0_0, vec_value_1_0, placeholder2, vec_value_3_0, tail_vl);
...
int golden_vluxei8_v_operator_0() {
