// COMMAND: random_gen -r MnandMMVBoolVBVB -n 1 -l 7 --has-ta --has-ma -c MnandMMVBoolVBVB.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vbool8_t vec_value_2_0= vmnand_mm_b8(mask_value_0_0, mask_value_1_0, vl);
...
int golden_vmnand_mm_operator_0() {
int8_t tmp[] = {1,0,1,1,0,1,1,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
...
vmnand_mm_operator_0();
printf("operator_1 : %s\n", golden_vinit_rif_operator_1() ? "pass" : "fail");
printf("operator_2 : %s\n", golden_vinit_rif_operator_2() ? "pass" : "fail");
printf("operator_0 : %s\n", golden_vmnand_mm_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
