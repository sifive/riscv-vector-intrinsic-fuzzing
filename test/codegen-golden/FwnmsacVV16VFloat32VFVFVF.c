// COMMAND: random_gen -r FwnmsacVV16VFloat32VFVFVF -n 1 -l 7 --has-ta --has-ma -c FwnmsacVV16VFloat32VFVFVF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_3_0= vfwnmsac_vv_f32m2(vec_value_0_0, vec_value_1_0, vec_value_2_0, vl);
...
uint64_t tmp[] = {3434559731u,3447072409u,3433285470u,3438087428u,3438842958u,3402351580u,3430218540u,};
