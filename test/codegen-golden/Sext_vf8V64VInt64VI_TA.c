// COMMAND: random_gen -r Sext_vf8V64VInt64VI_TA -n 1 -l 7 --has-ta --has-ma -c Sext_vf8V64VInt64VI_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vl = 2;
size_t tail_vl = 1;
vint8mf8_t vec_value_0_0= vle8_v_i8mf8(placeholder0, vl);

vint64m1_t vec_value_1_0= vsext_vf8_i64m1_ta(vec_value_0_0, tail_vl);
...
int64_t tmp[] = {-56ll,-1ll,55ll,-1ll,26ll,-1ll,-57ll,};
for (int i=0; i<7;++i)
if(value_1[i] != tmp[i]) {
return 0;
}
