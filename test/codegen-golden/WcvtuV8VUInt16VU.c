// COMMAND: random_gen -r WcvtuV8VUInt16VU -n 1 -l 7 --has-ta --has-ma -c WcvtuV8VUInt16VU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_1_0= vwcvtu_x_x_v_u16m2(vec_value_0_0, vl);
