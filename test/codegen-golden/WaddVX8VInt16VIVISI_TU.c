// COMMAND: random_gen -r WaddVX8VInt16VIVISI_TU -n 1 -l 7 --has-ta --has-ma -c WaddVX8VInt16VIVISI_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_3_0= vwadd_vx_i16m2_tu(vec_value_0_0, vec_value_1_0, placeholder2, tail_vl);
...
int16_t tmp[] = {28,7893,-10,-1417,-87,-7226,7,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
