// COMMAND: random_gen -r MsifM0VBool8VBVBVB_MU -n 1 -l 7 --has-ta --has-ma -c MsifM0VBool8VBVBVB_MU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vbool8_t vec_value_3_0= vmsif_m_b8_mu(mask_value_0_0, mask_value_1_0, mask_value_2_0, vl);
{
