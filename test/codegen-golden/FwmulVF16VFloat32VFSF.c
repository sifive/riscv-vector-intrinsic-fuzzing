// COMMAND: random_gen -r FwmulVF16VFloat32VFSF -n 1 -l 7 --has-ta --has-ma -c FwmulVF16VFloat32VFSF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_2_0= vfwmul_vf_f32m2(vec_value_0_0, placeholder1, vl);
...
uint64_t tmp[] = {1275373464u,1292181896u,1290145744u,1283427192u,1287351912u,1269115348u,1275201776u,};
