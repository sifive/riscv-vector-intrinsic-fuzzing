// COMMAND: random_gen -r FwmsacVF16VFloat32VFSFVF_TU -n 1 -l 7 --has-ta --has-ma -c FwmsacVF16VFloat32VFSFVF_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_3_0= vfwmsac_vf_f32m2_tu(vec_value_0_0, placeholder1, vec_value_2_0, tail_vl);
...
uint64_t tmp[] = {1287076083u,1267237304u,1286776102u,1258485599u,1292020647u,1244223528u,1286442566u,};
