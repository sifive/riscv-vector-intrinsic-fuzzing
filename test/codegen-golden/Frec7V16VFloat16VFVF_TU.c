// COMMAND: random_gen -r Frec7V16VFloat16VFVF_TU -n 1 -l 7 --has-ta --has-ma -c Frec7V16VFloat16VFVF_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_2_0= vfrec7_v_f16m1_tu(vec_value_0_0, vec_value_1_0, tail_vl);
...
uint64_t tmp[] = {2104,29790,1976,28721,1448,26987,2160,};
