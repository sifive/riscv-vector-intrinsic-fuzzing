// COMMAND: random_gen -r Vse32X32VoidVBSUVU_m -n 1 -l 7 --has-ta --has-ma -c Vse32X32VoidVBSUVU_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vse32_v_u32m1_m (mask_value_0_0, placeholder2, vec_value_1_0, vl);
placeholder0 += vl;
placeholder1 += vl;
placeholder2 += vl;
}
...
uint32_t tmp[] = {0u,7500210u,4235251u,0u,5806864u,0u,0u,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
