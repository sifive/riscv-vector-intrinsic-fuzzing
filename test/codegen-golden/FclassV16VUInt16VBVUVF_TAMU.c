// COMMAND: random_gen -r FclassV16VUInt16VBVUVF_TAMU -n 1 -l 7 --has-ta --has-ma -c FclassV16VUInt16VBVUVF_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m1_t vec_value_3_0= vfclass_v_u16m1_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
uint16_t tmp[] = {6442,65535,64,65535,64,65535,4633,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
