// COMMAND: random_gen -r Zext_vf2V16VUInt16VBVU_TAMA -n 1 -l 7 --has-ta --has-ma -c Zext_vf2V16VUInt16VBVU_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m1_t vec_value_2_0= vzext_vf2_u16m1_tama(mask_value_0_0, vec_value_1_0, tail_vl);
...
uint16_t tmp[] = {65535,65535,42,65535,58,65535,65535,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
