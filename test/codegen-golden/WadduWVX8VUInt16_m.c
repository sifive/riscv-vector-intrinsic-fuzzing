// COMMAND: random_gen -r WadduWVX8VUInt16_m -n 1 -l 7 --has-ta --has-ma -c WadduWVX8VUInt16_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_4_0= vwaddu_vx_u16m2_m (mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, vl);
...
uint16_t tmp[] = {7500,99,98,5807,52,3702,6442,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
