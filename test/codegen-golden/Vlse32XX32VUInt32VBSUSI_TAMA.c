// COMMAND: random_gen -r Vlse32XX32VUInt32VBSUSI_TAMA -n 1 -l 7 --has-ta --has-ma -c Vlse32XX32VUInt32VBSUSI_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder2 *= 4;
vuint32m1_t vec_value_3_0= vlse32_v_u32m1_tama(mask_value_0_0, placeholder1, placeholder2, tail_vl);
...
uint32_t tmp[] = {4294967295u,4294967295u,5592077u,4294967295u,1786754u,4294967295u,4294967295u,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
