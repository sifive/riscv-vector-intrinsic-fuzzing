// COMMAND: random_gen -r FaddVV16VFloat16VFVFVF_TU -n 1 -l 7 --has-ta --has-ma -c FaddVV16VFloat16VFVFVF_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_3_0= vfadd_vv_f16m1_tu(vec_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
uint64_t tmp[] = {29965,29790,29949,28721,30167,26987,29714,};
