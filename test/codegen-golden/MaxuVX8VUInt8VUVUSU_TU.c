// COMMAND: random_gen -r MaxuVX8VUInt8VUVUSU_TU -n 1 -l 7 --has-ta --has-ma -c MaxuVX8VUInt8VUVUSU_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_3_0= vmaxu_vx_u8m1_tu(vec_value_0_0, vec_value_1_0, placeholder2, tail_vl);
...
uint8_t tmp[] = {75,90,56,43,39,14,65,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
