// COMMAND: random_gen -r FcvtV16VFloat16VBVI_TAMA -n 1 -l 7 --has-ta --has-ma -c FcvtV16VFloat16VBVI_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_2_0= vfcvt_f_x_v_f16m1_tama(mask_value_0_0, vec_value_1_0, tail_vl);
...
uint64_t tmp[] = {65535,65535,58874,65535,26190,65535,65535,};
