// COMMAND: random_gen -r Vlse32XX32VFloat32SFSI -n 1 -l 7 --has-ta --has-ma -c Vlse32XX32VFloat32SFSI.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder1 *= 4;
vfloat32m1_t vec_value_2_0= vlse32_v_f32m1(placeholder0, placeholder1, vl);
