// COMMAND: random_gen -r Vloxei64V8VInt8SIVU_TA -n 1 -l 7 --has-ta --has-ma -c Vloxei64V8VInt8SIVU_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_2_0= vloxei64_v_i8m1_ta(placeholder0, vec_value_1_0, tail_vl);
