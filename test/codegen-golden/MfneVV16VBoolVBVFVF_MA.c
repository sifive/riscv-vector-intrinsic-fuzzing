// COMMAND: random_gen -r MfneVV16VBoolVBVFVF_MA -n 1 -l 7 --has-ta --has-ma -c MfneVV16VBoolVBVFVF_MA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vbool16_t vec_value_3_0= vmfne_vv_f16m1_b16_ma(mask_value_0_0, vec_value_1_0, vec_value_2_0, vl);
