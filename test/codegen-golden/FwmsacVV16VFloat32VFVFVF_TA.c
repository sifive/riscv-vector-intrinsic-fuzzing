// COMMAND: random_gen -r FwmsacVV16VFloat32VFVFVF_TA -n 1 -l 7 --has-ta --has-ma -c FwmsacVV16VFloat32VFVFVF_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_3_0= vfwmsac_vv_f32m2_ta(vec_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
uint64_t tmp[] = {1287076083u,4294967295u,1285801822u,4294967295u,1291359310u,4294967295u,1282734892u,};
