// COMMAND: random_gen -r FwsubWF16VFloat32VFVFSF_TU -n 1 -l 7 --has-ta --has-ma -c FwsubWF16VFloat32VFVFSF_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_3_0= vfwsub_wf_f32m2_tu(vec_value_0_0, vec_value_1_0, placeholder2, tail_vl);
...
uint64_t tmp[] = {1264895208u,1267237304u,1261078942u,1258485599u,1247388192u,1244223528u,1262779119u,};
