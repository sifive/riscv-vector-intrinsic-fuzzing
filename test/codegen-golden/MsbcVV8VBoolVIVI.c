// COMMAND: random_gen -r MsbcVV8VBoolVIVI -n 1 -l 7 --has-ta --has-ma -c MsbcVV8VBoolVIVI.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vbool8_t vec_value_2_0= vmsbc_vv_i8m1_b8(vec_value_0_0, vec_value_1_0, vl);
...
int golden_vmsbc_vv_operator_0() {
...
printf("operator_0 : %s\n", golden_vmsbc_vv_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
