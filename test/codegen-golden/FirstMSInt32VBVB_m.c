// COMMAND: random_gen -r FirstMSInt32VBVB_m -n 1 -l 7 --has-ta --has-ma -c FirstMSInt32VBVB_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
uint32_t placeholder5 = 0;
for (size_t vl = 0; placeholder4 == -1 && placeholder3 > 0; placeholder3 -= vl) {
placeholder5 += vl;
...
if (placeholder4 != -1) placeholder4 += placeholder5;
