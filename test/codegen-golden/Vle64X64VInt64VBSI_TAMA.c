// COMMAND: random_gen -r Vle64X64VInt64VBSI_TAMA -n 1 -l 7 --has-ta --has-ma -c Vle64X64VInt64VBSI_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint64m1_t vec_value_2_0= vle64_v_i64m1_tama(mask_value_0_0, placeholder1, tail_vl);
...
int64_t tmp[] = {-1ll,-1ll,-1529498ll,-1ll,1613727ll,-1ll,-1ll,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
