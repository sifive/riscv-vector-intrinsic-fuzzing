// COMMAND: random_gen -r FwnmsacVF16VFloat32VFSFVF_TA -n 1 -l 7 --has-ta --has-ma -c FwnmsacVF16VFloat32VFSFVF_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_3_0= vfwnmsac_vf_f32m2_ta(vec_value_0_0, placeholder1, vec_value_2_0, tail_vl);
...
uint64_t tmp[] = {3434559731u,4294967295u,3434259750u,4294967295u,3439504295u,4294967295u,3433926214u,};
