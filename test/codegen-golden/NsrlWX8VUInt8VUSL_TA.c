// COMMAND: random_gen -r NsrlWX8VUInt8VUSL_TA -n 1 -l 7 --has-ta --has-ma -c NsrlWX8VUInt8VUSL_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_2_0= vnsrl_wx_u8m1_ta(vec_value_0_0, placeholder1, tail_vl);
