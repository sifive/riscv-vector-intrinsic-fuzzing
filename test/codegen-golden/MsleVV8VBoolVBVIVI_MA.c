// COMMAND: random_gen -r MsleVV8VBoolVBVIVI_MA -n 1 -l 7 --has-ta --has-ma -c MsleVV8VBoolVBVIVI_MA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vbool8_t vec_value_3_0= vmsle_vv_i8m1_b8_ma(mask_value_0_0, vec_value_1_0, vec_value_2_0, vl);
