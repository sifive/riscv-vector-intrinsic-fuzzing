// COMMAND: random_gen -r WmuluVX8VUInt16VBVUVUSU_TAMU -n 1 -l 7 --has-ta --has-ma -c WmuluVX8VUInt16VBVUVUSU_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_4_0= vwmulu_vx_u16m2_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, tail_vl);
...
uint16_t tmp[] = {7500,65535,2301,65535,507,65535,6442,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
