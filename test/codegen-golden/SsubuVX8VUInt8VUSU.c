// COMMAND: random_gen -r SsubuVX8VUInt8VUSU -n 1 -l 7 --has-ta --has-ma -c SsubuVX8VUInt8VUSU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_2_0= vssubu_vx_u8m1(vec_value_0_0, placeholder1, vl);
