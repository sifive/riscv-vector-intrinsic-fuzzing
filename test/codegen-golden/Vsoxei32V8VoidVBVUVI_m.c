// COMMAND: random_gen -r Vsoxei32V8VoidVBVUVI_m -n 1 -l 7 --has-ta --has-ma -c Vsoxei32V8VoidVBVUVI_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vsoxei32_v_i8m1_m (mask_value_0_0, placeholder3, vec_value_2_0, vec_value_1_0, vl);
placeholder0 += vl;
placeholder1 += vl;
placeholder2 += vl;
}
