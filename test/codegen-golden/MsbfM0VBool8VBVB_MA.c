// COMMAND: random_gen -r MsbfM0VBool8VBVB_MA -n 1 -l 7 --has-ta --has-ma -c MsbfM0VBool8VBVB_MA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
void vmsbf_m_operator_0() {
int8_t *placeholder0 = value_0;
int8_t *placeholder1 = value_1;
int8_t *placeholder2 = value_2;
int placeholder3 = 7;

int32_t placeholder4 = -1;
for (size_t vl = 0; placeholder3 > 0 && placeholder4 == -1; placeholder3 -= vl) {
...
vbool8_t vec_value_2_0= vmsbf_m_b8_ma(mask_value_0_0, mask_value_1_0, vl);
{
...
placeholder1 += vl;
placeholder2 += vl;
placeholder4 = vfirst_m_b8_m(mask_value_0_0, mask_value_1_0, vl);
}
...
vbool8_t placeholder5 = vmnot_m_b8(mask_value_0_1, vl);
{
size_t vlmax = vsetvlmax_e8m1();
vint8m1_t zero = vmv_v_x_i8m1(0, vlmax);
vint8m1_t vec_store = vmerge_vxm_i8m1(placeholder5, zero, 1, vl);
vse8_v_i8m1(placeholder2, vec_store, vl);
}
placeholder0 += vl;
placeholder1 += vl;
...
printf("operator_0 : %s\n", golden_vmsbf_m_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
ret &= golden_vinit_rif_operator_1();
ret &= golden_vinit_rif_operator_2();
ret &= golden_vmsbf_m_operator_0();
if (!ret) return 1;
return 0; }
