// COMMAND: random_gen -r MsleuVV8VBool -n 1 -l 7 --has-ta --has-ma -c MsleuVV8VBool.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vbool8_t vec_value_2_0= vmsleu_vv_u8m1_b8(vec_value_0_0, vec_value_1_0, vl);
