// COMMAND: random_gen -r MnotMVBoolVB -n 1 -l 7 --has-ta --has-ma -c MnotMVBoolVB.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vbool8_t vec_value_1_0= vmnot_m_b8(mask_value_0_0, vl);
...
printf("operator_0 : %s\n", golden_vmnot_m_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
ret &= golden_vinit_rif_operator_1();
ret &= golden_vmnot_m_operator_0();
if (!ret) return 1;
return 0; }
