// COMMAND: random_gen -r RsubVX8VInt8 -n 1 -l 7 --has-ta --has-ma -c RsubVX8VInt8.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_2_0= vrsub_vx_i8m1(vec_value_0_0, placeholder1, vl);
