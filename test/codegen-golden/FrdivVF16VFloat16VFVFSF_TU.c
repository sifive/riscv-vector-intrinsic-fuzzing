// COMMAND: random_gen -r FrdivVF16VFloat16VFVFSF_TU -n 1 -l 7 --has-ta --has-ma -c FrdivVF16VFloat16VFVFSF_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_3_0= vfrdiv_vf_f16m1_tu(vec_value_0_0, vec_value_1_0, placeholder2, tail_vl);
...
uint64_t tmp[] = {14378,29790,14741,28721,16479,26987,14553,};
