// COMMAND: random_gen -r SaddVV8VInt8VIVI -n 1 -l 7 --has-ta --has-ma -c SaddVV8VInt8VIVI.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_2_0= vsadd_vv_i8m1(vec_value_0_0, vec_value_1_0, vl);
...
int8_t tmp[] = {-78,127,40,-2,42,-128,-83,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
