// COMMAND: random_gen -r Vle16X16VInt16VISI_TU -n 1 -l 7 --has-ta --has-ma -c Vle16X16VInt16VISI_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m1_t vec_value_2_0= vle16_v_i16m1_tu(vec_value_0_0, placeholder1, tail_vl);
...
int16_t tmp[] = {-2195,7893,-1530,-1417,1614,-7226,-2596,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
