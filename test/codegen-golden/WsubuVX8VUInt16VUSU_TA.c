// COMMAND: random_gen -r WsubuVX8VUInt16VUSU_TA -n 1 -l 7 --has-ta --has-ma -c WsubuVX8VUInt16VUSU_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_2_0= vwsubu_vx_u16m2_ta(vec_value_0_0, placeholder1, tail_vl);
...
uint16_t tmp[] = {65519,65535,39,65535,24,65535,65519,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
