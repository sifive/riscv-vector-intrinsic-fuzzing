// COMMAND: random_gen -r MulhuVX8VUInt8 -n 1 -l 7 --has-ta --has-ma -c MulhuVX8VUInt8.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_2_0= vmulhu_vx_u8m1(vec_value_0_0, placeholder1, vl);
