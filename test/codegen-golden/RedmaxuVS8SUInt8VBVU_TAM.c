// COMMAND: random_gen -r RedmaxuVS8SUInt8VBVU_TAM -n 1 -l 7 --has-ta --has-ma -c RedmaxuVS8SUInt8VBVU_TAM.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder5 = vredmaxu_vs_u8m1_u8m1_tam(mask_value_0_0, vec_value_1_0, placeholder5, vl);
placeholder0 += vl;
placeholder1 += vl;
placeholder2 += vl;
}
...
uint8_t tmp[] = {75,255,255,255,255,255,255,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
