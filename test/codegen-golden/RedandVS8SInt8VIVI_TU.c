// COMMAND: random_gen -r RedandVS8SInt8VIVI_TU -n 1 -l 7 --has-ta --has-ma -c RedandVS8SInt8VIVI_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder5 = vredand_vs_i8m1_i8m1_tu(vec_value_0_0, vec_value_1_0, placeholder5, vl);
placeholder0 += vl;
placeholder1 += vl;
placeholder2 += vl;
}
...
int8_t tmp[] = {0,79,55,-14,26,-73,-57,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
