// COMMAND: random_gen -r FwredusumVS16SFloat32VBVF_TAM -n 1 -l 7 --has-ta --has-ma -c FwredusumVS16SFloat32VBVF_TAM.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder5 = vfwredusum_vs_f16m1_f32m1_tam(mask_value_0_0, vec_value_1_0, placeholder5, vl);
placeholder0 += vl;
placeholder1 += vl;
placeholder2 += vl;
}
