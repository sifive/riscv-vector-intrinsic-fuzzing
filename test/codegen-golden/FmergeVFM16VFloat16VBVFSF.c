// COMMAND: random_gen -r FmergeVFM16VFloat16VBVFSF -n 1 -l 7 --has-ta --has-ma -c FmergeVFM16VFloat16VBVFSF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_3_0= vfmerge_vfm_f16m1(mask_value_0_0, vec_value_1_0, placeholder2, vl);
...
uint64_t tmp[] = {29523,28575,28575,29100,28575,28475,29258,};
