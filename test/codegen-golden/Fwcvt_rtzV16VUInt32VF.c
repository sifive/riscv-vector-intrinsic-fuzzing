// COMMAND: random_gen -r Fwcvt_rtzV16VUInt32VF -n 1 -l 7 --has-ta --has-ma -c Fwcvt_rtzV16VUInt32VF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint32m2_t vec_value_1_0= vfwcvt_rtz_xu_f_v_u32m2(vec_value_0_0, vl);
