// COMMAND: random_gen -r NegV8VInt8VBVI_TAMA -n 1 -l 7 --has-ta --has-ma -c NegV8VInt8VBVI_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_2_0= vneg_v_i8m1_tama(mask_value_0_0, vec_value_1_0, tail_vl);
