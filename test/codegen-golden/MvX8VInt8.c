// COMMAND: random_gen -r MvX8VInt8 -n 1 -l 7 --has-ta --has-ma -c MvX8VInt8.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_1_0= vmv_v_x_i8m1(placeholder0, vl);
...
int8_t tmp[] = {-56,-56,-56,-56,-56,-56,-56,};
for (int i=0; i<7;++i)
if(value_1[i] != tmp[i]) {
return 0;
}
