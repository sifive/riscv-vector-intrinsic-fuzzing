// COMMAND: random_gen -r FsubVV16VFloat16VFVFVF_TU -n 1 -l 7 --has-ta --has-ma -c FsubVV16VFloat16VFVFVF_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_3_0= vfsub_vv_f16m1_tu(vec_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
uint64_t tmp[] = {27893,29790,27344,28721,24928,26987,26436,};
