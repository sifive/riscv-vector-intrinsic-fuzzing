// COMMAND: random_gen -r FdivVV16VFloat16VFVFVF_TU -n 1 -l 7 --has-ta --has-ma -c FdivVV16VFloat16VFVFVF_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_3_0= vfdiv_vv_f16m1_tu(vec_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
uint64_t tmp[] = {16026,29790,15782,28721,15421,26987,15617,};
