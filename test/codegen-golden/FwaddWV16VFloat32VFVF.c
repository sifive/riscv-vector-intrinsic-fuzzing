// COMMAND: random_gen -r FwaddWV16VFloat32VFVF -n 1 -l 7 --has-ta --has-ma -c FwaddWV16VFloat32VFVF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_2_0= vfwadd_wv_f32m2(vec_value_0_0, vec_value_1_0, vl);
...
uint64_t tmp[] = {1250437964u,1267244804u,1265368938u,1258496783u,1262510316u,1244237816u,1250269428u,};
