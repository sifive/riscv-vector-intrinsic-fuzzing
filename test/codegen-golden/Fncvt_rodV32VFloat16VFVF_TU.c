// COMMAND: random_gen -r Fncvt_rodV32VFloat16VFVF_TU -n 1 -l 7 --has-ta --has-ma -c Fncvt_rodV32VFloat16VFVF_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16mf2_t vec_value_2_0= vfncvt_rod_f_f_w_f16mf2_tu(vec_value_0_0, vec_value_1_0, tail_vl);
...
uint64_t tmp[] = {31743,29790,31743,28721,31743,26987,31743,};
