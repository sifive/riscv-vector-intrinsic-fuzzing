// COMMAND: random_gen -r WadduWX8VUInt16VUSU_TA -n 1 -l 7 --has-ta --has-ma -c WadduWX8VUInt16VUSU_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_2_0= vwaddu_wx_u16m2_ta(vec_value_0_0, placeholder1, tail_vl);
...
uint16_t tmp[] = {2266,65535,7768,65535,6337,65535,2224,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
