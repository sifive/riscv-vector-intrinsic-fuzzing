// COMMAND: random_gen -r Vloxei32V32VInt32VBVISIVU_TUMU -n 1 -l 7 --has-ta --has-ma -c Vloxei32V32VInt32VBVISIVU_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint32m1_t vec_value_4_0= vloxei32_v_i32m1_tumu(mask_value_0_0, vec_value_1_0, placeholder2, vec_value_3_0, tail_vl);
