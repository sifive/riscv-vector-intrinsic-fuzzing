// COMMAND: random_gen -r Vloxei32V32VUInt32SUVU -n 1 -l 7 --has-ta --has-ma -c Vloxei32V32VUInt32SUVU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint32m1_t vec_value_2_0= vloxei32_v_u32m1(placeholder0, vec_value_1_0, vl);
