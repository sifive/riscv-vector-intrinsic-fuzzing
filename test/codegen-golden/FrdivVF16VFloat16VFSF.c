// COMMAND: random_gen -r FrdivVF16VFloat16VFSF -n 1 -l 7 --has-ta --has-ma -c FrdivVF16VFloat16VFSF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_2_0= vfrdiv_vf_f16m1(vec_value_0_0, placeholder1, vl);
...
uint64_t tmp[] = {16129,14075,14346,15174,14581,16800,16166,};
