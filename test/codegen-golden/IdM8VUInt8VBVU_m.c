// COMMAND: random_gen -r IdM8VUInt8VBVU_m -n 1 -l 7 --has-ta --has-ma -c IdM8VUInt8VBVU_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_2_0= vid_v_u8m1_m (mask_value_0_0, vec_value_1_0, vl);
vec_value_2_0 = vadd_vx_u8m1_m(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder4, vl);
