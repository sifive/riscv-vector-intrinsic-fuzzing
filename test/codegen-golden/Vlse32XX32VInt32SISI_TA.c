// COMMAND: random_gen -r Vlse32XX32VInt32SISI_TA -n 1 -l 7 --has-ta --has-ma -c Vlse32XX32VInt32SISI_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder1 *= 4;
vint32m1_t vec_value_2_0= vlse32_v_i32m1_ta(placeholder0, placeholder1, tail_vl);
