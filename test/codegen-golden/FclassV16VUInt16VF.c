// COMMAND: random_gen -r FclassV16VUInt16VF -n 1 -l 7 --has-ta --has-ma -c FclassV16VUInt16VF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m1_t vec_value_1_0= vfclass_v_u16m1(vec_value_0_0, vl);
...
uint16_t tmp[] = {64,64,64,64,64,64,64,};
for (int i=0; i<7;++i)
if(value_1[i] != tmp[i]) {
return 0;
}
