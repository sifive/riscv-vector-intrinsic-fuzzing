// COMMAND: random_gen -r WsubuWWX8VUInt16_m -n 1 -l 7 --has-ta --has-ma -c WsubuWWX8VUInt16_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_4_0= vwsubu_wx_u16m2_m (mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, vl);
...
uint16_t tmp[] = {7500,5940,5901,5807,1284,3702,6442,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
