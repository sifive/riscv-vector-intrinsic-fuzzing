// COMMAND: random_gen -r MsofM0VBool8VBVB_MA -n 1 -l 7 --has-ta --has-ma -c MsofM0VBool8VBVB_MA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vbool8_t vec_value_2_0= vmsof_m_b8_ma(mask_value_0_0, mask_value_1_0, vl);
{
