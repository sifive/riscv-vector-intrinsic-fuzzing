// COMMAND: random_gen -r FcvtV16VFloat16VBVFVU_m -n 1 -l 7 --has-ta --has-ma -c FcvtV16VFloat16VBVFVU_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_3_0= vfcvt_f_xu_v_f16m1_m (mask_value_0_0, vec_value_1_0, vec_value_2_0, vl);
...
uint64_t tmp[] = {29258,28499,27683,29133,28076,26923,28806,};
