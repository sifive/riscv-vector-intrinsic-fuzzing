// COMMAND: random_gen -r WaddWVX8VInt16 -n 1 -l 7 --has-ta --has-ma -c WaddWVX8VInt16.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_2_0= vwadd_vx_i16m2(vec_value_0_0, placeholder1, vl);
...
int16_t tmp[] = {-78,57,33,-36,4,-95,-79,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
