// COMMAND: random_gen -r MinuVV8VUInt8VBVUVUVU_TUMU -n 1 -l 7 --has-ta --has-ma -c MinuVV8VUInt8VBVUVUVU_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_4_0= vminu_vv_u8m1_tumu(mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, tail_vl);
...
uint8_t tmp[] = {65,92,42,59,31,13,46,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
