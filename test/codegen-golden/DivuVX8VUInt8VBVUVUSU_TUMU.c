// COMMAND: random_gen -r DivuVX8VUInt8VBVUVUSU_TUMU -n 1 -l 7 --has-ta --has-ma -c DivuVX8VUInt8VBVUVUSU_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_4_0= vdivu_vx_u8m1_tumu(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, tail_vl);
