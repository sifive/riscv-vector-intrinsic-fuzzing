// COMMAND: random_gen -r Vloxei8V8VInt8VBVISIVU_m -n 1 -l 7 --has-ta --has-ma -c Vloxei8V8VInt8VBVISIVU_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_4_0= vloxei8_v_i8m1_m (mask_value_0_0, vec_value_1_0, placeholder2, vec_value_3_0, vl);
