// COMMAND: random_gen -r Vle32X32VInt32VBSI_TAMA -n 1 -l 7 --has-ta --has-ma -c Vle32X32VInt32VBSI_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint32m1_t vec_value_2_0= vle32_v_i32m1_tama(mask_value_0_0, placeholder1, tail_vl);
...
int32_t tmp[] = {-1,-1,-1529498,-1,1613727,-1,-1,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
