// COMMAND: random_gen -r WredsumVS8SInt16VI_TA -n 1 -l 7 --has-ta --has-ma -c WredsumVS8SInt16VI_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder4 = vwredsum_vs_i8m1_i16m1_ta(vec_value_0_0, placeholder4, vl);
placeholder0 += vl;
placeholder1 += vl;
}
