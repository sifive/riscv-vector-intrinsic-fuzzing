// COMMAND: random_gen -r OrVX8VInt8VIVISI_TU -n 1 -l 7 --has-ta --has-ma -c OrVX8VInt8VIVISI_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_3_0= vor_vx_i8m1_tu(vec_value_0_0, vec_value_1_0, placeholder2, tail_vl);
