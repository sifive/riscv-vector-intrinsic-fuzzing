// COMMAND: random_gen -r RedminuVS8SUInt8VBVUVU_TUM -n 1 -l 7 --has-ta --has-ma -c RedminuVS8SUInt8VBVUVU_TUM.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder6 = vredminu_vs_u8m1_u8m1_tum(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder6, vl);
placeholder0 += vl;
placeholder1 += vl;
placeholder2 += vl;
placeholder3 += vl;
...
uint8_t tmp[] = {0,92,60,59,62,13,46,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
