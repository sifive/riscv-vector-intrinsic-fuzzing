// COMMAND: random_gen -r WmulsuVX8VInt16_m -n 1 -l 7 --has-ta --has-ma -c WmulsuVX8VInt16_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_4_0= vwmulsu_vx_i16m2_m (mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, vl);
...
int16_t tmp[] = {5001,780,741,1614,-2886,-2596,2884,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
