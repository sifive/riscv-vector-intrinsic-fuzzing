// COMMAND: random_gen -r FwnmaccVF16VFloat32VBVFSFVF_TUMU -n 1 -l 7 --has-ta --has-ma -c FwnmaccVF16VFloat32VBVFSFVF_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_4_0= vfwnmacc_vf_f32m2_tumu(mask_value_0_0, vec_value_1_0, placeholder2, vec_value_3_0, tail_vl);
...
uint64_t tmp[] = {1262786923u,1267490606u,3440676864u,1261781606u,3444034197u,1243709844u,1259168278u,};
