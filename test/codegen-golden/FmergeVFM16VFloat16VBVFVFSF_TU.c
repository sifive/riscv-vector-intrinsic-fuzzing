// COMMAND: random_gen -r FmergeVFM16VFloat16VBVFVFSF_TU -n 1 -l 7 --has-ta --has-ma -c FmergeVFM16VFloat16VBVFVFSF_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_4_0= vfmerge_vfm_f16m1_tu(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, tail_vl);
...
int golden_vfmerge_vfm_operator_0() {
uint64_t tmp[] = {29822,28707,28575,29100,28575,28475,29733,};
