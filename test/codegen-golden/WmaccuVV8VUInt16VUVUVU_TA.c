// COMMAND: random_gen -r WmaccuVV8VUInt16VUVUVU_TA -n 1 -l 7 --has-ta --has-ma -c WmaccuVV8VUInt16VUVUVU_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_3_0= vwmaccu_vv_u16m2_ta(vec_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
int golden_vwmaccu_vv_operator_0() {
uint16_t tmp[] = {4762,65535,10249,65535,9894,65535,3887,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
...
vwmaccu_vv_operator_0();
printf("operator_1 : %s\n", golden_vinit_rif_operator_1() ? "pass" : "fail");
printf("operator_3 : %s\n", golden_vinit_rif_operator_3() ? "pass" : "fail");
printf("operator_2 : %s\n", golden_vinit_rif_operator_2() ? "pass" : "fail");
printf("operator_0 : %s\n", golden_vwmaccu_vv_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
ret &= golden_vinit_rif_operator_1();
ret &= golden_vinit_rif_operator_3();
ret &= golden_vinit_rif_operator_2();
ret &= golden_vwmaccu_vv_operator_0();
if (!ret) return 1;
return 0; }
