// COMMAND: random_gen -r RedmaxuVS8SUInt8VBVUVU_TUM -n 1 -l 7 --has-ta --has-ma -c RedmaxuVS8SUInt8VBVUVU_TUM.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t placeholder5= vmv_v_x_u8m1(0, vsetvlmax_e8m1());
vuint8m1_t placeholder6= vmv_v_v_u8m1(placeholder5, vsetvlmax_e8m1());
...
placeholder6 = vredmaxu_vs_u8m1_u8m1_tum(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder6, vl);
placeholder0 += vl;
placeholder1 += vl;
placeholder2 += vl;
placeholder3 += vl;
}
uint8_t *placeholder7 = value_3;
*placeholder7= vmv_x_s_u8m1_u8(placeholder6);
}
...
int golden_vredmaxu_vs_operator_0() {
uint8_t tmp[] = {75,92,60,59,62,13,46,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
...
vredmaxu_vs_operator_0();
printf("operator_1 : %s\n", golden_vinit_rif_operator_1() ? "pass" : "fail");
printf("operator_3 : %s\n", golden_vinit_rif_operator_3() ? "pass" : "fail");
printf("operator_2 : %s\n", golden_vinit_rif_operator_2() ? "pass" : "fail");
printf("operator_0 : %s\n", golden_vredmaxu_vs_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
ret &= golden_vinit_rif_operator_1();
ret &= golden_vinit_rif_operator_3();
ret &= golden_vinit_rif_operator_2();
ret &= golden_vredmaxu_vs_operator_0();
if (!ret) return 1;
return 0; }
