// COMMAND: random_gen -r WadduWX8VUInt16VBVUSU_TAMA -n 1 -l 7 --has-ta --has-ma -c WadduWX8VUInt16VBVUSU_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_3_0= vwaddu_wx_u16m2_tama(mask_value_0_0, vec_value_1_0, placeholder2, tail_vl);
...
uint16_t tmp[] = {65535,65535,5631,65535,1825,65535,65535,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
