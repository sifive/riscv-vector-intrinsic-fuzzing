// COMMAND: random_gen -r NotV8VInt8VI -n 1 -l 7 --has-ta --has-ma -c NotV8VInt8VI.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_1_0= vnot_v_i8m1(vec_value_0_0, vl);
...
int8_t tmp[] = {55,-80,-56,13,-27,72,56,};
for (int i=0; i<7;++i)
if(value_1[i] != tmp[i]) {
return 0;
}
