// COMMAND: random_gen -r NsrlWX8VUInt8VBVUVUSL_TUMU -n 1 -l 7 --has-ta --has-ma -c NsrlWX8VUInt8VBVUVUSL_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_4_0= vnsrl_wx_u8m1_tumu(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, tail_vl);
...
uint8_t tmp[] = {75,42,1,58,0,37,65,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
