// COMMAND: random_gen -r FdivVF16VFloat16VBVFSF_TAMA -n 1 -l 7 --has-ta --has-ma -c FdivVF16VFloat16VBVFSF_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_3_0= vfdiv_vf_f16m1_tama(mask_value_0_0, vec_value_1_0, placeholder2, tail_vl);
...
uint64_t tmp[] = {65535,65535,15804,65535,14163,65535,65535,};
