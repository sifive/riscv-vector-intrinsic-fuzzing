// COMMAND: random_gen -r FwaddVV16VFloat32VFVF -n 1 -l 7 --has-ta --has-ma -c FwaddVV16VFloat32VFVF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_2_0= vfwadd_vv_f32m2(vec_value_0_0, vec_value_1_0, vl);
...
uint64_t tmp[] = {1178570752u,1191213056u,1186656256u,1184526336u,1186799616u,1170624512u,1178071040u,};
