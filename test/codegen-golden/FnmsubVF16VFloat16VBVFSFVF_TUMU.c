// COMMAND: random_gen -r FnmsubVF16VFloat16VBVFSFVF_TUMU -n 1 -l 7 --has-ta --has-ma -c FnmsubVF16VFloat16VBVFSFVF_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_4_0= vfnmsub_vf_f16m1_tumu(mask_value_0_0, vec_value_1_0, placeholder2, vec_value_3_0, tail_vl);
...
int golden_vfnmsub_vf_operator_0() {
