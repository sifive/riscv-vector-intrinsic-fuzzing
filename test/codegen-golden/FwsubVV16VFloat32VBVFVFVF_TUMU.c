// COMMAND: random_gen -r FwsubVV16VFloat32VBVFVFVF_TUMU -n 1 -l 7 --has-ta --has-ma -c FwsubVV16VFloat32VBVFVFVF_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_4_0= vfwsub_vv_f32m2_tumu(mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, tail_vl);
...
int golden_vfwsub_vv_operator_0() {
uint64_t tmp[] = {1262786923u,1267490606u,1168703488u,1261781606u,3316318208u,1243709844u,1259168278u,};
