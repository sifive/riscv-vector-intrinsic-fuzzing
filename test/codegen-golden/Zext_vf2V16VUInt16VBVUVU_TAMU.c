// COMMAND: random_gen -r Zext_vf2V16VUInt16VBVUVU_TAMU -n 1 -l 7 --has-ta --has-ma -c Zext_vf2V16VUInt16VBVUVU_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m1_t vec_value_3_0= vzext_vf2_u16m1_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
