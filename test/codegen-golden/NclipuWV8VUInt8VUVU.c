// COMMAND: random_gen -r NclipuWV8VUInt8VUVU -n 1 -l 7 --has-ta --has-ma -c NclipuWV8VUInt8VUVU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_2_0= vnclipu_wv_u8m1(vec_value_0_0, vec_value_1_0, vl);
...
uint8_t tmp[] = {17,4,8,17,6,255,68,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
