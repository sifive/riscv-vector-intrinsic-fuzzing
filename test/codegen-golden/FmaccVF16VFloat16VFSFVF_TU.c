// COMMAND: random_gen -r FmaccVF16VFloat16VFSFVF_TU -n 1 -l 7 --has-ta --has-ma -c FmaccVF16VFloat16VFSFVF_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_3_0= vfmacc_vf_f16m1_tu(vec_value_0_0, placeholder1, vec_value_2_0, tail_vl);
