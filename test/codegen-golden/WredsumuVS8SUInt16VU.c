// COMMAND: random_gen -r WredsumuVS8SUInt16VU -n 1 -l 7 --has-ta --has-ma -c WredsumuVS8SUInt16VU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder4 = vwredsumu_vs_u8m1_u16m1(placeholder4, vec_value_0_0, placeholder4, vl);
placeholder0 += vl;
}
