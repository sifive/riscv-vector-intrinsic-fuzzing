// COMMAND: random_gen -r FsubVF16VFloat16VFVFSF_TU -n 1 -l 7 --has-ta --has-ma -c FsubVF16VFloat16VFVFSF_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_3_0= vfsub_vf_f16m1_tu(vec_value_0_0, vec_value_1_0, placeholder2, tail_vl);
...
uint64_t tmp[] = {28423,29790,27290,28721,60450,26987,27893,};
