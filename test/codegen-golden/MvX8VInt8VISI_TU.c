// COMMAND: random_gen -r MvX8VInt8VISI_TU -n 1 -l 7 --has-ta --has-ma -c MvX8VInt8VISI_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_2_0= vmv_v_x_i8m1_tu(vec_value_0_0, placeholder1, tail_vl);
...
int8_t tmp[] = {-22,79,-22,-14,-22,-73,-22,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
