// COMMAND: random_gen -r Frsqrt7V16VFloat16VFVF_TU -n 1 -l 7 --has-ta --has-ma -c Frsqrt7V16VFloat16VFVF_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_2_0= vfrsqrt7_v_f16m1_tu(vec_value_0_0, vec_value_1_0, tail_vl);
...
uint64_t tmp[] = {8656,29790,8592,28721,8384,26987,8696,};
