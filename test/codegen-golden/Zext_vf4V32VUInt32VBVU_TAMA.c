// COMMAND: random_gen -r Zext_vf4V32VUInt32VBVU_TAMA -n 1 -l 7 --has-ta --has-ma -c Zext_vf4V32VUInt32VBVU_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8mf4_t vec_value_1_0= vle8_v_u8mf4(placeholder1, vl);

vuint32m1_t vec_value_2_0= vzext_vf4_u32m1_tama(mask_value_0_0, vec_value_1_0, tail_vl);
...
uint32_t tmp[] = {4294967295u,4294967295u,42u,4294967295u,58u,4294967295u,4294967295u,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
