// COMMAND: random_gen -r MaxVV8VInt8_m -n 1 -l 7 --has-ta --has-ma -c MaxVV8VInt8_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_4_0= vmax_vv_i8m1_m (mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, vl);
...
int8_t tmp[] = {29,50,39,19,16,-74,-7,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
