// COMMAND: random_gen -r Vle8X8VInt8VBVISI_m -n 1 -l 7 --has-ta --has-ma -c Vle8X8VInt8VBVISI_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_3_0= vle8_v_i8m1_m (mask_value_0_0, vec_value_1_0, placeholder2, vl);
