// COMMAND: random_gen -r FmvF16VFloat16VFSF_TU -n 1 -l 7 --has-ta --has-ma -c FmvF16VFloat16VFSF_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_2_0= vfmv_v_f_f16m1_tu(vec_value_0_0, placeholder1, tail_vl);
...
uint64_t tmp[] = {28575,29790,28575,28721,28575,26987,28575,};
