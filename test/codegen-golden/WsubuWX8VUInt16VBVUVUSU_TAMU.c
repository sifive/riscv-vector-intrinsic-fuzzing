// COMMAND: random_gen -r WsubuWX8VUInt16VBVUVUSU_TAMU -n 1 -l 7 --has-ta --has-ma -c WsubuWX8VUInt16VBVUVUSU_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_4_0= vwsubu_wx_u16m2_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, tail_vl);
...
uint16_t tmp[] = {7500,65535,5901,65535,1284,65535,6442,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
