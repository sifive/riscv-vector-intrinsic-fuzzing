// COMMAND: random_gen -r Fncvt_rtzV16VInt8VBVIVF_m -n 1 -l 7 --has-ta --has-ma -c Fncvt_rtzV16VInt8VBVIVF_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8mf2_t vec_value_3_0= vfncvt_rtz_x_f_w_i8mf2_m (mask_value_0_0, vec_value_1_0, vec_value_2_0, vl);
...
int8_t tmp[] = {29,127,127,19,127,-74,-7,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
