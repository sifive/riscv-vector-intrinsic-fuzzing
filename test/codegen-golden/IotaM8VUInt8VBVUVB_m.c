// COMMAND: random_gen -r IotaM8VUInt8VBVUVB_m -n 1 -l 7 --has-ta --has-ma -c IotaM8VUInt8VBVUVB_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_3_0= viota_m_u8m1_m (mask_value_0_0, vec_value_1_0, mask_value_2_0, vl);
vec_value_3_0 = vadd_vx_u8m1_m(mask_value_0_0, vec_value_1_0, vec_value_3_0, placeholder5, vl);
vse8_v_u8m1(placeholder3, vec_value_3_0, vl);
placeholder5 += vcpop_m_b8_m(mask_value_0_0, mask_value_2_0, vl);
placeholder0 += vl;
placeholder1 += vl;
placeholder2 += vl;
placeholder3 += vl;
