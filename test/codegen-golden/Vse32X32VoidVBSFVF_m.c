// COMMAND: random_gen -r Vse32X32VoidVBSFVF_m -n 1 -l 7 --has-ta --has-ma -c Vse32X32VoidVBSFVF_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vse32_v_f32m1_m (mask_value_0_0, placeholder2, vec_value_1_0, vl);
placeholder0 += vl;
placeholder1 += vl;
placeholder2 += vl;
}
...
uint64_t tmp[] = {0u,1264903012u,1258373094u,0u,1261516319u,0u,0u,};
