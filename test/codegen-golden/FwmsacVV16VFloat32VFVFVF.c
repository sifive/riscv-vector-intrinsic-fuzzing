// COMMAND: random_gen -r FwmsacVV16VFloat32VFVFVF -n 1 -l 7 --has-ta --has-ma -c FwmsacVV16VFloat32VFVFVF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_3_0= vfwmsac_vv_f32m2(vec_value_0_0, vec_value_1_0, vec_value_2_0, vl);
...
uint64_t tmp[] = {1287076083u,1299588761u,1285801822u,1290603780u,1291359310u,1254867932u,1282734892u,};
