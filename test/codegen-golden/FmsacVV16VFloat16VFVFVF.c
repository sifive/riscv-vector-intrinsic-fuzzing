// COMMAND: random_gen -r FmsacVV16VFloat16VFVFVF -n 1 -l 7 --has-ta --has-ma -c FmsacVV16VFloat16VFVFVF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_3_0= vfmsac_vv_f16m1(vec_value_0_0, vec_value_1_0, vec_value_2_0, vl);
...
uint64_t tmp[] = {31744,31744,31744,31744,31744,31744,31744,};
