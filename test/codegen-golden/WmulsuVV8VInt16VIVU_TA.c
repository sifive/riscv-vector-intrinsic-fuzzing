// COMMAND: random_gen -r WmulsuVV8VInt16VIVU_TA -n 1 -l 7 --has-ta --has-ma -c WmulsuVV8VInt16VIVU_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_2_0= vwmulsu_vv_i16m2_ta(vec_value_0_0, vec_value_1_0, tail_vl);
...
int16_t tmp[] = {-2184,-1,2310,-1,1508,-1,-2109,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
