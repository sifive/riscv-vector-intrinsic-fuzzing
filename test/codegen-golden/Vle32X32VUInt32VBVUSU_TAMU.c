// COMMAND: random_gen -r Vle32X32VUInt32VBVUSU_TAMU -n 1 -l 7 --has-ta --has-ma -c Vle32X32VUInt32VBVUSU_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint32m1_t vec_value_3_0= vle32_v_u32m1_tamu(mask_value_0_0, vec_value_1_0, placeholder2, tail_vl);
...
uint32_t tmp[] = {6442165u,4294967295u,4235251u,4294967295u,5806864u,4294967295u,4632843u,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
