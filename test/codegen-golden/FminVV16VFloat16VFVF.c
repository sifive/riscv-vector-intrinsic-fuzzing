// COMMAND: random_gen -r FminVV16VFloat16VFVF -n 1 -l 7 --has-ta --has-ma -c FminVV16VFloat16VFVF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_2_0= vfmin_vv_f16m1(vec_value_0_0, vec_value_1_0, vl);
...
uint64_t tmp[] = {27738,29523,28707,28721,29100,26987,27716,};
