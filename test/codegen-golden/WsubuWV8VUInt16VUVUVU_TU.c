// COMMAND: random_gen -r WsubuWV8VUInt16VUVUVU_TU -n 1 -l 7 --has-ta --has-ma -c WsubuWV8VUInt16VUVUVU_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_3_0= vwsubu_wv_u16m2_tu(vec_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
uint16_t tmp[] = {6403,8946,5937,4291,6094,1387,4596,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
