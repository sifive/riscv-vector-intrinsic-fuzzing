// COMMAND: random_gen -r WsubuVV8VUInt16VUVUVU_TU -n 1 -l 7 --has-ta --has-ma -c WsubuVV8VUInt16VUVUVU_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_3_0= vwsubu_vv_u16m2_tu(vec_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
uint16_t tmp[] = {26,8946,18,4291,4,1387,9,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
