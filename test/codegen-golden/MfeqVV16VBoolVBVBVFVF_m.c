// COMMAND: random_gen -r MfeqVV16VBoolVBVBVFVF_m -n 1 -l 7 --has-ta --has-ma -c MfeqVV16VBoolVBVBVFVF_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vbool16_t vec_value_4_0= vmfeq_vv_f16m1_b16_m (mask_value_0_0, mask_value_1_0, vec_value_2_0, vec_value_3_0, vl);
