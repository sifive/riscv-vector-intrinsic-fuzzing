// COMMAND: random_gen -r MinVX8VInt8 -n 1 -l 7 --has-ta --has-ma -c MinVX8VInt8.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_2_0= vmin_vx_i8m1(vec_value_0_0, placeholder1, vl);
...
int8_t tmp[] = {-56,-22,-22,-22,-22,-73,-57,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
