// COMMAND: random_gen -r Vlse32XX32VUInt32SUSI_TA -n 1 -l 7 --has-ta --has-ma -c Vlse32XX32VUInt32SUSI_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
size_t tail_vl = 1;
if (placeholder7 < 7) {
vuint32m1_t placeholder8= vmv_v_x_u32m1(0, vsetvlmax_e32m1());
vse32_v_u32m1(placeholder2, placeholder8, vl);
...
placeholder1 *= 4;
vuint32m1_t vec_value_2_0= vlse32_v_u32m1_ta(placeholder0, placeholder1, tail_vl);
vse32_v_u32m1(placeholder2, vec_value_2_0, vl);
vl = placeholder9; // recover vl
placeholder1 = placeholder10; // recover stride
}
else {
vuint32m1_t placeholder11= vmv_v_x_u32m1(0, vsetvlmax_e32m1());
vse32_v_u32m1(placeholder2, placeholder11, vl);
};
