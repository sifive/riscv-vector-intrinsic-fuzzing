// COMMAND: random_gen -r Vsoxei64V8VoidVBVUVI_m -n 1 -l 7 --has-ta --has-ma -c Vsoxei64V8VoidVBVUVI_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vsoxei64_v_i8m1_m (mask_value_0_0, placeholder3, vec_value_2_0, vec_value_1_0, vl);
placeholder0 += vl;
placeholder1 += vl;
placeholder2 += vl;
}
...
int golden_vsoxei64_v_operator_0() {
...
vsoxei64_v_operator_0();
printf("operator_1 : %s\n", golden_vinit_rif_operator_1() ? "pass" : "fail");
printf("operator_3 : %s\n", golden_vinit_rif_operator_3() ? "pass" : "fail");
printf("operator_2 : %s\n", golden_vinit_rif_operator_2() ? "pass" : "fail");
printf("operator_0 : %s\n", golden_vsoxei64_v_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
ret &= golden_vinit_rif_operator_1();
ret &= golden_vinit_rif_operator_3();
ret &= golden_vinit_rif_operator_2();
ret &= golden_vsoxei64_v_operator_0();
if (!ret) return 1;
return 0; }
