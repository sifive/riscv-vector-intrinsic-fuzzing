// COMMAND: random_gen -r MaxuVX8VUInt8VBVUVUSU_TAMU -n 1 -l 7 --has-ta --has-ma -c MaxuVX8VUInt8VBVUVUSU_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_4_0= vmaxu_vx_u8m1_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, tail_vl);
...
int golden_vmaxu_vx_operator_0() {
uint8_t tmp[] = {75,255,59,255,39,255,65,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
...
printf("operator_0 : %s\n", golden_vmaxu_vx_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
