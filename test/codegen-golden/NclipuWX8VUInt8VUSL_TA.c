// COMMAND: random_gen -r NclipuWX8VUInt8VUSL_TA -n 1 -l 7 --has-ta --has-ma -c NclipuWX8VUInt8VUSL_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_2_0= vnclipu_wx_u8m1_ta(vec_value_0_0, placeholder1, tail_vl);
...
uint8_t tmp[] = {1,255,2,255,2,255,1,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
