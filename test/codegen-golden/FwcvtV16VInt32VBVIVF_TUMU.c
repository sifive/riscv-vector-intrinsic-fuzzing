// COMMAND: random_gen -r FwcvtV16VInt32VBVIVF_TUMU -n 1 -l 7 --has-ta --has-ma -c FwcvtV16VInt32VBVIVF_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint32m2_t vec_value_3_0= vfwcvt_x_f_v_i32m2_tumu(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
int golden_vfwcvt_x_f_v_operator_0() {
...
vfwcvt_x_f_v_operator_0();
printf("operator_1 : %s\n", golden_vinit_rif_operator_1() ? "pass" : "fail");
printf("operator_3 : %s\n", golden_vinit_rif_operator_3() ? "pass" : "fail");
printf("operator_2 : %s\n", golden_vinit_rif_operator_2() ? "pass" : "fail");
printf("operator_0 : %s\n", golden_vfwcvt_x_f_v_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
