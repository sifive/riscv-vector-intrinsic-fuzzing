// COMMAND: random_gen -r Zext_vf4V32VUInt32VBVUVU_TAMU -n 1 -l 7 --has-ta --has-ma -c Zext_vf4V32VUInt32VBVUVU_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint32m1_t vec_value_3_0= vzext_vf4_u32m1_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
uint32_t tmp[] = {6442165u,4294967295u,42u,4294967295u,58u,4294967295u,4632843u,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
