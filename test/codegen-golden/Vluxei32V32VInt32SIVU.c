// COMMAND: random_gen -r Vluxei32V32VInt32SIVU -n 1 -l 7 --has-ta --has-ma -c Vluxei32V32VInt32SIVU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint32m1_t vec_value_2_0= vluxei32_v_i32m1(placeholder0, vec_value_1_0, vl);
