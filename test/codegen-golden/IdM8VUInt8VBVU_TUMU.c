// COMMAND: random_gen -r IdM8VUInt8VBVU_TUMU -n 1 -l 7 --has-ta --has-ma -c IdM8VUInt8VBVU_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_2_0= vid_v_u8m1_tumu(mask_value_0_0, vec_value_1_0, tail_vl);
vec_value_2_0 = vadd_vx_u8m1_tumu(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder4, tail_vl);
...
uint8_t tmp[] = {39,75,2,56,4,18,37,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
