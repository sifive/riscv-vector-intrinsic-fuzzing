// COMMAND: random_gen -r Fwcvt_rtzV16VUInt32VF_TA -n 1 -l 7 --has-ta --has-ma -c Fwcvt_rtzV16VUInt32VF_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint32m2_t vec_value_1_0= vfwcvt_rtz_xu_f_v_u32m2_ta(vec_value_0_0, tail_vl);
...
uint32_t tmp[] = {4456u,4294967295u,15456u,4294967295u,12592u,4294967295u,4368u,};
for (int i=0; i<7;++i)
if(value_1[i] != tmp[i]) {
return 0;
}
