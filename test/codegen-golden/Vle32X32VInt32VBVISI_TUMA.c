// COMMAND: random_gen -r Vle32X32VInt32VBVISI_TUMA -n 1 -l 7 --has-ta --has-ma -c Vle32X32VInt32VBVISI_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint32m1_t vec_value_3_0= vle32_v_i32m1_tuma(mask_value_0_0, vec_value_1_0, placeholder2, tail_vl);
...
int32_t tmp[] = {-1,8398813,-1529498,1879014,1613727,-7353883,-1,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
