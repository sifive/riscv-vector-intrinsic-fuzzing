// COMMAND: random_gen -r FwcvtV8VFloat16VFVI_TU -n 1 -l 7 --has-ta --has-ma -c FwcvtV8VFloat16VFVI_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m2_t vec_value_2_0= vfwcvt_f_x_v_f16m2_tu(vec_value_0_0, vec_value_1_0, tail_vl);
...
uint64_t tmp[] = {52608,29790,52096,28721,19456,26987,52864,};
