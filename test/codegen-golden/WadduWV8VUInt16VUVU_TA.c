// COMMAND: random_gen -r WadduWV8VUInt16VUVU_TA -n 1 -l 7 --has-ta --has-ma -c WadduWV8VUInt16VUVU_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_2_0= vwaddu_wv_u16m2_ta(vec_value_0_0, vec_value_1_0, tail_vl);
...
uint16_t tmp[] = {2266,65535,7771,65535,6356,65535,2222,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
