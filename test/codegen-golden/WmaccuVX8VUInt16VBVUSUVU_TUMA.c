// COMMAND: random_gen -r WmaccuVX8VUInt16VBVUSUVU_TUMA -n 1 -l 7 --has-ta --has-ma -c WmaccuVX8VUInt16VBVUSUVU_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_4_0= vwmaccu_vx_u16m2_tuma(mask_value_0_0, vec_value_1_0, placeholder2, vec_value_3_0, tail_vl);
...
uint16_t tmp[] = {65535,9200,9549,5940,11082,1323,65535,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
