// COMMAND: random_gen -r Zext_vf4V32VUInt32VBVUVU_TUMA -n 1 -l 7 --has-ta --has-ma -c Zext_vf4V32VUInt32VBVUVU_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint32m1_t vec_value_3_0= vzext_vf4_u32m1_tuma(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
uint32_t tmp[] = {4294967295u,9199407u,42u,5939507u,58u,1323058u,4294967295u,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
