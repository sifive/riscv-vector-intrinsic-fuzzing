// COMMAND: random_gen -r FwsubWV16VFloat32VBVFVFVF_m -n 1 -l 7 --has-ta --has-ma -c FwsubWV16VFloat32VBVFVFVF_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
uint32_t tmp[] = {1266779219u,1255845574u,1263781768u,1267886662u,1253798282u,1250916304u,1253542582u,};
for (int i=0; i<7;++i) {union { uint32_t u32; float32_t f; } converter;
converter.u32 = tmp[i];
value_2[i] = converter.f;
}
}
void vfwsub_wv_operator_0() {
...
vfloat32m2_t vec_value_2_0= vle32_v_f32m2(placeholder2, vl);
vfloat16m1_t vec_value_3_0= vle16_v_f16m1(placeholder3, vl);

vfloat32m2_t vec_value_4_0= vfwsub_wv_f32m2_m (mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, vl);
...
int golden_vfwsub_wv_operator_0() {
uint64_t tmp[] = {1262786923u,1255815574u,1263773296u,1261781606u,1253775050u,1243709844u,1259168278u,};
