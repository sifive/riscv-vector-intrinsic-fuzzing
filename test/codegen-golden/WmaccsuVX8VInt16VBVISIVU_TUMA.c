// COMMAND: random_gen -r WmaccsuVX8VInt16VBVISIVU_TUMA -n 1 -l 7 --has-ta --has-ma -c WmaccsuVX8VInt16VBVISIVU_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_4_0= vwmaccsu_vx_i16m2_tuma(mask_value_0_0, vec_value_1_0, placeholder2, vec_value_3_0, tail_vl);
...
int16_t tmp[] = {-1,8399,4898,1879,6363,-7354,-1,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
