// COMMAND: random_gen -r WmulVV8VInt16VIVI_TA -n 1 -l 7 --has-ta --has-ma -c WmulVV8VInt16VIVI_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_2_0= vwmul_vv_i16m2_ta(vec_value_0_0, vec_value_1_0, tail_vl);
...
int16_t tmp[] = {1232,-1,-825,-1,416,-1,1482,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
