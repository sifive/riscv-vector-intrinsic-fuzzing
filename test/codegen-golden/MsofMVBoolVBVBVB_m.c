// COMMAND: random_gen -r MsofMVBoolVBVBVB_m -n 1 -l 7 --has-ta --has-ma -c MsofMVBoolVBVBVB_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vbool8_t vec_value_3_0= vmsof_m_b8_m (mask_value_0_0, mask_value_1_0, mask_value_2_0, vl);
{
