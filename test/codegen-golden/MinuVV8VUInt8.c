// COMMAND: random_gen -r MinuVV8VUInt8 -n 1 -l 7 --has-ta --has-ma -c MinuVV8VUInt8.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_2_0= vminu_vv_u8m1(vec_value_0_0, vec_value_1_0, vl);
...
uint8_t tmp[] = {22,75,42,43,58,14,22,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
