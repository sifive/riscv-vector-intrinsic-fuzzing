// COMMAND: random_gen -r FncvtV32VFloat16VBVFVI_TAMU -n 1 -l 7 --has-ta --has-ma -c FncvtV32VFloat16VBVFVI_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint32m1_t vec_value_2_0= vle32_v_i32m1(placeholder2, vl);

vfloat16mf2_t vec_value_3_0= vfncvt_f_x_w_f16mf2_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
uint64_t tmp[] = {29258,65535,64512,65535,31744,65535,28806,};
