// COMMAND: random_gen -r FminVV16VFloat16VBVFVFVF_TAMU -n 1 -l 7 --has-ta --has-ma -c FminVV16VFloat16VBVFVFVF_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_4_0= vfmin_vv_f16m1_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, tail_vl);
...
uint64_t tmp[] = {29258,65535,28707,65535,28160,65535,28806,};
