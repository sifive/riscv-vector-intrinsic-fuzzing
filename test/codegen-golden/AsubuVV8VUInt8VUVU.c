// COMMAND: random_gen -r AsubuVV8VUInt8VUVU -n 1 -l 7 --has-ta --has-ma -c AsubuVV8VUInt8VUVU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_2_0= vasubu_vv_u8m1(vec_value_0_0, vec_value_1_0, vl);
...
uint8_t tmp[] = {248,8,18,250,3,254,249,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
