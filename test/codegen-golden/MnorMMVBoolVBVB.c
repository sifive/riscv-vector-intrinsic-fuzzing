// COMMAND: random_gen -r MnorMMVBoolVBVB -n 1 -l 7 --has-ta --has-ma -c MnorMMVBoolVBVB.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vbool8_t vec_value_2_0= vmnor_mm_b8(mask_value_0_0, mask_value_1_0, vl);
...
int golden_vmnor_mm_operator_0() {
...
printf("operator_0 : %s\n", golden_vmnor_mm_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
ret &= golden_vinit_rif_operator_1();
ret &= golden_vinit_rif_operator_2();
ret &= golden_vmnor_mm_operator_0();
if (!ret) return 1;
return 0; }
