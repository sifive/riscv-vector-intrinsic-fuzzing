// COMMAND: random_gen -r FwmaccVF16VFloat32VFSFVF_TU -n 1 -l 7 --has-ta --has-ma -c FwmaccVF16VFloat32VFSFVF_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_3_0= vfwmacc_vf_f32m2_tu(vec_value_0_0, placeholder1, vec_value_2_0, tail_vl);
...
uint64_t tmp[] = {1288189629u,1267237304u,1290640570u,1258485599u,1293595161u,1244223528u,1287535146u,};
