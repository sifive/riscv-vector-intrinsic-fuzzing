// COMMAND: random_gen -r WsubVX8VInt16VBVIVISI_TAMU -n 1 -l 7 --has-ta --has-ma -c WsubVX8VInt16VBVIVISI_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_4_0= vwsub_vx_i16m2_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, tail_vl);
...
int16_t tmp[] = {5001,-1,41,-1,-52,-1,2884,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
