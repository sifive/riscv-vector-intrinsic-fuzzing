// COMMAND: random_gen -r NmsacVV8VInt8VIVIVI_TA -n 1 -l 7 --has-ta --has-ma -c NmsacVV8VInt8VIVIVI_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_3_0= vnmsac_vv_i8m1_ta(vec_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
