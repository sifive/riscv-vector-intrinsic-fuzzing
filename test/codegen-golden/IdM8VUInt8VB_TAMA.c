// COMMAND: random_gen -r IdM8VUInt8VB_TAMA -n 1 -l 7 --has-ta --has-ma -c IdM8VUInt8VB_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_1_0= vid_v_u8m1_tama(mask_value_0_0, tail_vl);
vec_value_1_0 = vadd_vx_u8m1_tama(mask_value_0_0, vec_value_1_0, placeholder3, tail_vl);
...
uint8_t tmp[] = {255,255,2,255,4,255,255,};
for (int i=0; i<7;++i)
if(value_1[i] != tmp[i]) {
return 0;
}
