// COMMAND: random_gen -r FwcvtV8VFloat16VU -n 1 -l 7 --has-ta --has-ma -c FwcvtV8VFloat16VU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m2_t vec_value_1_0= vfwcvt_f_xu_v_f16m2(vec_value_0_0, vl);
...
uint64_t tmp[] = {19840,21920,21728,20832,21472,19200,19840,};
