// COMMAND: random_gen -r MergeVVM8VInt8VBVIVI -n 1 -l 7 --has-ta --has-ma -c MergeVVM8VInt8VBVIVI.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_3_0= vmerge_vvm_i8m1(mask_value_0_0, vec_value_1_0, vec_value_2_0, vl);
...
int8_t tmp[] = {29,50,-15,19,16,-74,-7,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
