// COMMAND: random_gen -r Fwcvt_rtzV16VUInt32VBVUVF_m -n 1 -l 7 --has-ta --has-ma -c Fwcvt_rtzV16VUInt32VBVUVF_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint32m2_t vec_value_3_0= vfwcvt_rtz_xu_f_v_u32m2_m (mask_value_0_0, vec_value_1_0, vec_value_2_0, vl);
...
uint32_t tmp[] = {6442165u,15000u,8472u,5939507u,11616u,1323058u,4632843u,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
