// COMMAND: random_gen -r WmuluVV8VUInt16VUVUVU_TU -n 1 -l 7 --has-ta --has-ma -c WmuluVV8VUInt16VUVUVU_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_3_0= vwmulu_vv_u16m2_tu(vec_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
uint16_t tmp[] = {2535,8946,2520,4291,3596,1387,1702,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
