// COMMAND: random_gen -r FwredosumVS16SFloat32VBVF_TAM -n 1 -l 7 --has-ta --has-ma -c FwredosumVS16SFloat32VBVF_TAM.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder5 = vfwredosum_vs_f16m1_f32m1_tam(mask_value_0_0, vec_value_1_0, placeholder5, vl);
placeholder0 += vl;
placeholder1 += vl;
placeholder2 += vl;
}
...
uint64_t tmp[] = {1191776256u,4294967295u,4294967295u,4294967295u,4294967295u,4294967295u,4294967295u,};
