// COMMAND: random_gen -r WsubVV8VInt16VBVIVIVI_TUMU -n 1 -l 7 --has-ta --has-ma -c WsubVV8VInt16VBVIVIVI_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_4_0= vwsub_vv_i16m2_tumu(mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, tail_vl);
...
int golden_vwsub_vv_operator_0() {
int16_t tmp[] = {2884,8399,54,1879,-55,-7354,-734,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
...
printf("operator_0 : %s\n", golden_vwsub_vv_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
ret &= golden_vinit_rif_operator_1();
ret &= golden_vinit_rif_operator_4();
ret &= golden_vinit_rif_operator_2();
ret &= golden_vinit_rif_operator_3();
ret &= golden_vwsub_vv_operator_0();
if (!ret) return 1;
return 0; }
