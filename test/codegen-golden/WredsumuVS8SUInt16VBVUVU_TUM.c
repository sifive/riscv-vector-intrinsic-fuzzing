// COMMAND: random_gen -r WredsumuVS8SUInt16VBVUVU_TUM -n 1 -l 7 --has-ta --has-ma -c WredsumuVS8SUInt16VBVUVU_TUM.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m1_t placeholder5= vmv_v_x_u16m1(0, vsetvlmax_e16m1());
vuint16m1_t placeholder6= vmv_v_v_u16m1(placeholder5, vsetvlmax_e16m1());
...
placeholder6 = vwredsumu_vs_u8m1_u16m1_tum(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder6, vl);
placeholder0 += vl;
placeholder1 += vl;
placeholder2 += vl;
placeholder3 += vl;
}
uint16_t *placeholder7 = value_3;
*placeholder7= vmv_x_s_u16m1_u16(placeholder6);
}
...
uint16_t tmp[] = {175,9200,5979,5940,6152,1323,4633,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
