// COMMAND: random_gen -r MsbcVVM8VBoolVIVIVB -n 1 -l 7 --has-ta --has-ma -c MsbcVVM8VBoolVIVIVB.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vbool8_t vec_value_3_0= vmsbc_vvm_i8m1_b8(vec_value_0_0, vec_value_1_0, mask_value_2_0, vl);
...
int golden_vmsbc_vvm_operator_0() {
int8_t tmp[] = {0,1,0,0,0,0,1,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
...
vmsbc_vvm_operator_0();
printf("operator_1 : %s\n", golden_vinit_rif_operator_1() ? "pass" : "fail");
printf("operator_3 : %s\n", golden_vinit_rif_operator_3() ? "pass" : "fail");
printf("operator_2 : %s\n", golden_vinit_rif_operator_2() ? "pass" : "fail");
printf("operator_0 : %s\n", golden_vmsbc_vvm_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
