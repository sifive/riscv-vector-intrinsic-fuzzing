// COMMAND: random_gen -r Vlse64XX64VInt64VBVISISI_m -n 1 -l 7 --has-ta --has-ma -c Vlse64XX64VInt64VBVISISI_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder3 *= 8;
vint64m1_t vec_value_4_0= vlse64_v_i64m1_m (mask_value_0_0, vec_value_1_0, placeholder2, placeholder3, vl);
...
int64_t tmp[] = {5000420ll,1958398ll,1879014ll,1613727ll,-7353883ll,-2595685ll,2884331ll,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
