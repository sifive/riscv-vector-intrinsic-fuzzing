// COMMAND: random_gen -r Vsoxei32V32VoidVUVF -n 1 -l 7 --has-ta --has-ma -c Vsoxei32V32VoidVUVF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vsoxei32_v_f32m1(placeholder2, vec_value_1_0, vec_value_0_0, vl);
placeholder0 += vl;
placeholder1 += vl;
}
}
