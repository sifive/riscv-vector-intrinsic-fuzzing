// COMMAND: random_gen -r MaccVX8VInt8VBVISIVI_TUMU -n 1 -l 7 --has-ta --has-ma -c MaccVX8VInt8VBVISIVI_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_4_0= vmacc_vx_i8m1_tumu(mask_value_0_0, vec_value_1_0, placeholder2, vec_value_3_0, tail_vl);
...
int8_t tmp[] = {29,84,-6,19,119,-74,-7,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
