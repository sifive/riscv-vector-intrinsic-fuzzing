// COMMAND: random_gen -r MsofMVBoolVB -n 1 -l 7 --has-ta --has-ma -c MsofMVBoolVB.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vbool8_t vec_value_1_0= vmsof_m_b8(mask_value_0_0, vl);
{
