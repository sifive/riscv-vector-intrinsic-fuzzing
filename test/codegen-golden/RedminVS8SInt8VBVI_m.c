// COMMAND: random_gen -r RedminVS8SInt8VBVI_m -n 1 -l 7 --has-ta --has-ma -c RedminVS8SInt8VBVI_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder5 = vredmin_vs_i8m1_i8m1_m (mask_value_0_0, placeholder5, vec_value_1_0, placeholder5, vl);
placeholder0 += vl;
placeholder1 += vl;
}
