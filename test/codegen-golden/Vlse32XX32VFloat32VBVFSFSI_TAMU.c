// COMMAND: random_gen -r Vlse32XX32VFloat32VBVFSFSI_TAMU -n 1 -l 7 --has-ta --has-ma -c Vlse32XX32VFloat32VBVFSFSI_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder3 *= 4;
vfloat32m1_t vec_value_4_0= vlse32_v_f32m1_tamu(mask_value_0_0, vec_value_1_0, placeholder2, placeholder3, tail_vl);
...
uint64_t tmp[] = {1264903012u,4294967295u,1261781606u,4294967295u,1243709844u,4294967295u,1262786923u,};
