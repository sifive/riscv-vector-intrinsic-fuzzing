// COMMAND: random_gen -r WaddWX8VInt16VISI_TA -n 1 -l 7 --has-ta --has-ma -c WaddWX8VInt16VISI_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_2_0= vwadd_wx_i16m2_ta(vec_value_0_0, placeholder1, tail_vl);
...
int16_t tmp[] = {-5568,-1,5436,-1,2574,-1,-5652,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
