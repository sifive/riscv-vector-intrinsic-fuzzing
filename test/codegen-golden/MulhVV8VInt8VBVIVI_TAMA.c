// COMMAND: random_gen -r MulhVV8VInt8VBVIVI_TAMA -n 1 -l 7 --has-ta --has-ma -c MulhVV8VInt8VBVIVI_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_3_0= vmulh_vv_i8m1_tama(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
