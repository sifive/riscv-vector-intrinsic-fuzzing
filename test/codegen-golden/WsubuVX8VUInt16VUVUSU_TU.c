// COMMAND: random_gen -r WsubuVX8VUInt16VUVUSU_TU -n 1 -l 7 --has-ta --has-ma -c WsubuVX8VUInt16VUVUSU_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_3_0= vwsubu_vx_u16m2_tu(vec_value_0_0, vec_value_1_0, placeholder2, tail_vl);
...
uint16_t tmp[] = {36,8946,17,4291,65515,1387,26,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
