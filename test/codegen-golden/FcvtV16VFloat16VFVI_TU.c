// COMMAND: random_gen -r FcvtV16VFloat16VFVI_TU -n 1 -l 7 --has-ta --has-ma -c FcvtV16VFloat16VFVI_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_2_0= vfcvt_f_x_v_f16m1_tu(vec_value_0_0, vec_value_1_0, tail_vl);
...
uint64_t tmp[] = {59466,29790,58874,28721,26190,26987,59666,};
