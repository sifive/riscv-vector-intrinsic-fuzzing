// COMMAND: random_gen -r Sext_vf2V16VInt16VBVIVI_TUMU -n 1 -l 7 --has-ta --has-ma -c Sext_vf2V16VInt16VBVIVI_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8mf2_t vec_value_2_0= vle8_v_i8mf2(placeholder2, vl);

vint16m1_t vec_value_3_0= vsext_vf2_i16m1_tumu(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
