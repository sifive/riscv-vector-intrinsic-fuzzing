// COMMAND: random_gen -r NclipuWX8VUInt8VBVUSL_TAMA -n 1 -l 7 --has-ta --has-ma -c NclipuWX8VUInt8VBVUSL_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_3_0= vnclipu_wx_u8m1_tama(mask_value_0_0, vec_value_1_0, placeholder2, tail_vl);
