// COMMAND: random_gen -r FwnmsacVV16VFloat32VBVFVFVF_TAMU -n 1 -l 7 --has-ta --has-ma -c FwnmsacVV16VFloat32VBVFVFVF_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_4_0= vfwnmsac_vv_f32m2_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, tail_vl);
...
int golden_vfwnmsac_vv_operator_0() {
uint64_t tmp[] = {1262786923u,4294967295u,3435756184u,4294967295u,3428929835u,4294967295u,1259168278u,};
...
vfwnmsac_vv_operator_0();
printf("operator_1 : %s\n", golden_vinit_rif_operator_1() ? "pass" : "fail");
printf("operator_4 : %s\n", golden_vinit_rif_operator_4() ? "pass" : "fail");
printf("operator_2 : %s\n", golden_vinit_rif_operator_2() ? "pass" : "fail");
printf("operator_3 : %s\n", golden_vinit_rif_operator_3() ? "pass" : "fail");
printf("operator_0 : %s\n", golden_vfwnmsac_vv_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
