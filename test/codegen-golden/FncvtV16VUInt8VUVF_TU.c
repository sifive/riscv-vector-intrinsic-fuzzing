// COMMAND: random_gen -r FncvtV16VUInt8VUVF_TU -n 1 -l 7 --has-ta --has-ma -c FncvtV16VUInt8VUVF_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8mf2_t vec_value_2_0= vfncvt_xu_f_w_u8mf2_tu(vec_value_0_0, vec_value_1_0, tail_vl);
