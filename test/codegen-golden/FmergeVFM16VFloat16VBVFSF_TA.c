// COMMAND: random_gen -r FmergeVFM16VFloat16VBVFSF_TA -n 1 -l 7 --has-ta --has-ma -c FmergeVFM16VFloat16VBVFSF_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_3_0= vfmerge_vfm_f16m1_ta(mask_value_0_0, vec_value_1_0, placeholder2, tail_vl);
...
uint64_t tmp[] = {29523,65535,28575,65535,28575,65535,29258,};
