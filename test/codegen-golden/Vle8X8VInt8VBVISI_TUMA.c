// COMMAND: random_gen -r Vle8X8VInt8VBVISI_TUMA -n 1 -l 7 --has-ta --has-ma -c Vle8X8VInt8VBVISI_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_3_0= vle8_v_i8m1_tuma(mask_value_0_0, vec_value_1_0, placeholder2, tail_vl);
