// COMMAND: random_gen -r FrsubVF16VFloat16VFSF -n 1 -l 7 --has-ta --has-ma -c FrsubVF16VFloat16VFSF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_2_0= vfrsub_vf_f16m1(vec_value_0_0, placeholder1, vl);
...
uint64_t tmp[] = {27274,61676,61305,57880,60589,27882,27318,};
