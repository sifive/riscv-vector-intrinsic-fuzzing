// COMMAND: random_gen -r FmulVV16VFloat16VFVF -n 1 -l 7 --has-ta --has-ma -c FmulVV16VFloat16VFVF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_2_0= vfmul_vv_f16m1(vec_value_0_0, vec_value_1_0, vl);
