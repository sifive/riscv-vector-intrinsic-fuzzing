// COMMAND: random_gen -r Vluxei32V32VFloat32SFVU_TA -n 1 -l 7 --has-ta --has-ma -c Vluxei32V32VFloat32SFVU_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m1_t vec_value_2_0= vluxei32_v_f32m1_ta(placeholder0, vec_value_1_0, tail_vl);
...
uint64_t tmp[] = {1244223528u,4294967295u,1250254620u,4294967295u,1250422356u,4294967295u,1262498700u,};
