// COMMAND: random_gen -r Vlse16XX16VInt16VISISI_TU -n 1 -l 7 --has-ta --has-ma -c Vlse16XX16VInt16VISISI_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder2 *= 2;
vint16m1_t vec_value_3_0= vlse16_v_i16m1_tu(vec_value_0_0, placeholder1, placeholder2, tail_vl);
...
int16_t tmp[] = {5001,7893,1184,-1417,-6427,-7226,2884,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
