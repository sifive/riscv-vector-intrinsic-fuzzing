// COMMAND: random_gen -r WmaccsuVV8VInt16VBVIVIVU_TUMU -n 1 -l 7 --has-ta --has-ma -c WmaccsuVV8VInt16VBVIVIVU_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_4_0= vwmaccsu_vv_i16m2_tumu(mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, tail_vl);
...
int golden_vwmaccsu_vv_operator_0() {
int16_t tmp[] = {2884,8399,3596,1879,41,-7354,-734,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
