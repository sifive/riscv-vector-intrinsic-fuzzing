// COMMAND: random_gen -r WcvtV8VInt16VBVIVI_TAMU -n 1 -l 7 --has-ta --has-ma -c WcvtV8VInt16VBVIVI_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_3_0= vwcvt_x_x_v_i16m2_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
int16_t tmp[] = {2884,-1,-15,-1,16,-1,-734,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
