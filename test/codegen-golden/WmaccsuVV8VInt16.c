// COMMAND: random_gen -r WmaccsuVV8VInt16 -n 1 -l 7 --has-ta --has-ma -c WmaccsuVV8VInt16.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_3_0= vwmaccsu_vv_i16m2(vec_value_0_0, vec_value_1_0, vec_value_2_0, vl);
...
int16_t tmp[] = {-4415,14193,6298,-353,3930,-8558,-5889,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
