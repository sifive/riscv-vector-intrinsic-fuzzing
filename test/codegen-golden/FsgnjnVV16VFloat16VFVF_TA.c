// COMMAND: random_gen -r FsgnjnVV16VFloat16VFVF_TA -n 1 -l 7 --has-ta --has-ma -c FsgnjnVV16VFloat16VFVF_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_2_0= vfsgnjn_vv_f16m1_ta(vec_value_0_0, vec_value_1_0, tail_vl);
