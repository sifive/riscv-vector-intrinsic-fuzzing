// COMMAND: random_gen -r MsneVX8VBool -n 1 -l 7 --has-ta --has-ma -c MsneVX8VBool.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vbool8_t vec_value_2_0= vmsne_vx_i8m1_b8(vec_value_0_0, placeholder1, vl);
