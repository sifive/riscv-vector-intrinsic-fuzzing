// COMMAND: random_gen -r NsraWX8VInt8VISL_TA -n 1 -l 7 --has-ta --has-ma -c NsraWX8VInt8VISL_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_2_0= vnsra_wx_i8m1_ta(vec_value_0_0, placeholder1, tail_vl);
