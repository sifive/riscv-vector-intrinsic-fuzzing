// COMMAND: random_gen -r FwaddWF16VFloat32VFSF_TA -n 1 -l 7 --has-ta --has-ma -c FwaddWF16VFloat32VFSF_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_2_0= vfwadd_wf_f32m2_ta(vec_value_0_0, placeholder1, tail_vl);
...
uint64_t tmp[] = {1250437964u,4294967295u,1265368270u,4294967295u,1262506504u,4294967295u,1250270228u,};
