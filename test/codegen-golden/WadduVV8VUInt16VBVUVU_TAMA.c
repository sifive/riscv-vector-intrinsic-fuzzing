// COMMAND: random_gen -r WadduVV8VUInt16VBVUVU_TAMA -n 1 -l 7 --has-ta --has-ma -c WadduVV8VUInt16VBVUVU_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_3_0= vwaddu_vv_u16m2_tama(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
uint16_t tmp[] = {65535,65535,102,65535,120,65535,65535,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
