// COMMAND: random_gen -r WmulVV8VInt16_m -n 1 -l 7 --has-ta --has-ma -c WmulVV8VInt16_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_4_0= vwmul_vv_i16m2_m (mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, vl);
...
int16_t tmp[] = {2884,-1400,-585,1879,-624,-7354,-734,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
