// COMMAND: random_gen -r MsleuVV8VBoolVBVBVUVU_MU -n 1 -l 7 --has-ta --has-ma -c MsleuVV8VBoolVBVBVUVU_MU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vbool8_t vec_value_4_0= vmsleu_vv_u8m1_b8_mu(mask_value_0_0, mask_value_1_0, vec_value_2_0, vec_value_3_0, vl);
...
int golden_vmsleu_vv_operator_0() {
