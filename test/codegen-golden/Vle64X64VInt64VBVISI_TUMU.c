// COMMAND: random_gen -r Vle64X64VInt64VBVISI_TUMU -n 1 -l 7 --has-ta --has-ma -c Vle64X64VInt64VBVISI_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint64m1_t vec_value_3_0= vle64_v_i64m1_tumu(mask_value_0_0, vec_value_1_0, placeholder2, tail_vl);
...
int64_t tmp[] = {2884331ll,8398813ll,-1529498ll,1879014ll,1613727ll,-7353883ll,-734314ll,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
