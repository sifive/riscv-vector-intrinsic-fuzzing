// COMMAND: random_gen -r Fcvt_rtzV16VInt16VBVIVF_TAMU -n 1 -l 7 --has-ta --has-ma -c Fcvt_rtzV16VInt16VBVIVF_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m1_t vec_value_3_0= vfcvt_rtz_x_f_v_i16m1_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
int16_t tmp[] = {2884,-1,8472,-1,11616,-1,-734,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
