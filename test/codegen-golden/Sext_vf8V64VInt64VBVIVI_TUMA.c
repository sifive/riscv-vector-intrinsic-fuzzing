// COMMAND: random_gen -r Sext_vf8V64VInt64VBVIVI_TUMA -n 1 -l 7 --has-ta --has-ma -c Sext_vf8V64VInt64VBVIVI_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint64m1_t vec_value_3_0= vsext_vf8_i64m1_tuma(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
int64_t tmp[] = {-1ll,8398813ll,-15ll,1879014ll,16ll,-7353883ll,-1ll,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
