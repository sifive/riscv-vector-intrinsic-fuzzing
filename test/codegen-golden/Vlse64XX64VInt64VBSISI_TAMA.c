// COMMAND: random_gen -r Vlse64XX64VInt64VBSISI_TAMA -n 1 -l 7 --has-ta --has-ma -c Vlse64XX64VInt64VBSISI_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder2 *= 8;
vint64m1_t vec_value_3_0= vlse64_v_i64m1_tama(mask_value_0_0, placeholder1, placeholder2, tail_vl);
...
int64_t tmp[] = {-1ll,-1ll,1184154ll,-1ll,-6426492ll,-1ll,-1ll,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
