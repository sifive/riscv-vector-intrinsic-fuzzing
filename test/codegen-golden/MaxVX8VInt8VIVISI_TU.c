// COMMAND: random_gen -r MaxVX8VInt8VIVISI_TU -n 1 -l 7 --has-ta --has-ma -c MaxVX8VInt8VIVISI_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_3_0= vmax_vx_i8m1_tu(vec_value_0_0, vec_value_1_0, placeholder2, tail_vl);
...
int8_t tmp[] = {50,79,12,-14,-22,-73,29,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
