// COMMAND: random_gen -r SsraVX8VInt8VBVIVISL_TAMU -n 1 -l 7 --has-ta --has-ma -c SsraVX8VInt8VBVIVISL_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_4_0= vssra_vx_i8m1_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, tail_vl);
