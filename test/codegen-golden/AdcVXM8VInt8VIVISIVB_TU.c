// COMMAND: random_gen -r AdcVXM8VInt8VIVISIVB_TU -n 1 -l 7 --has-ta --has-ma -c AdcVXM8VInt8VIVISIVB_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_4_0= vadc_vxm_i8m1_tu(vec_value_0_0, vec_value_1_0, placeholder2, mask_value_3_0, tail_vl);
...
int golden_vadc_vxm_operator_0() {
int8_t tmp[] = {99,79,90,-14,94,-73,63,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
...
printf("operator_0 : %s\n", golden_vadc_vxm_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
