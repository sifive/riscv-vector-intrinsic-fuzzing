// COMMAND: random_gen -r FmaddVF16VFloat16VFSFVF -n 1 -l 7 --has-ta --has-ma -c FmaddVF16VFloat16VFSFVF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_3_0= vfmadd_vf_f16m1(vec_value_0_0, placeholder1, vec_value_2_0, vl);
