// COMMAND: random_gen -r FncvtV32VFloat16VBVFVI_TUMA -n 1 -l 7 --has-ta --has-ma -c FncvtV32VFloat16VBVFVI_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16mf2_t vec_value_3_0= vfncvt_f_x_w_f16mf2_tuma(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
uint64_t tmp[] = {65535,29822,64512,29133,31744,26923,65535,};
