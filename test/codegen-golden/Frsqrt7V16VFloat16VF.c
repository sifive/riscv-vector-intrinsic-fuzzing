// COMMAND: random_gen -r Frsqrt7V16VFloat16VF -n 1 -l 7 --has-ta --has-ma -c Frsqrt7V16VFloat16VF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_1_0= vfrsqrt7_v_f16m1(vec_value_0_0, vl);
...
uint64_t tmp[] = {9136,8112,8224,8576,8336,9440,9144,};
