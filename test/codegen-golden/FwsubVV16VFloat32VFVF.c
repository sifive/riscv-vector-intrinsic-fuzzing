// COMMAND: random_gen -r FwsubVV16VFloat32VFVF -n 1 -l 7 --has-ta --has-ma -c FwsubVV16VFloat32VFVF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_2_0= vfwsub_vv_f32m2(vec_value_0_0, vec_value_1_0, vl);
...
uint64_t tmp[] = {3310436352u,1161068544u,1171931136u,3307372544u,1148452864u,3293020160u,3309158400u,};
