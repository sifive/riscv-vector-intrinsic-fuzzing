// COMMAND: random_gen -r Vloxei32V32VInt32SIVU_TA -n 1 -l 7 --has-ta --has-ma -c Vloxei32V32VInt32SIVU_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint32m1_t vec_value_2_0= vloxei32_v_i32m1_ta(placeholder0, vec_value_1_0, tail_vl);
