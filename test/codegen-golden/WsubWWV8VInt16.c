// COMMAND: random_gen -r WsubWWV8VInt16 -n 1 -l 7 --has-ta --has-ma -c WsubWWV8VInt16.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_2_0= vwsub_wv_i16m2(vec_value_0_0, vec_value_1_0, vl);
...
int16_t tmp[] = {-5524,7843,5473,-1429,2580,-7161,-5604,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
