// COMMAND: random_gen -r Fncvt_rodV32VFloat16VBVFVF_TUMA -n 1 -l 7 --has-ta --has-ma -c Fncvt_rodV32VFloat16VBVFVF_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16mf2_t vec_value_3_0= vfncvt_rod_f_f_w_f16mf2_tuma(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
uint64_t tmp[] = {65535,29822,31743,29133,31743,26923,65535,};
