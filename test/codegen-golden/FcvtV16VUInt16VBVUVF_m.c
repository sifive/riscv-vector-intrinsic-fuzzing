// COMMAND: random_gen -r FcvtV16VUInt16VBVUVF_m -n 1 -l 7 --has-ta --has-ma -c FcvtV16VUInt16VBVUVF_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m1_t vec_value_3_0= vfcvt_xu_f_v_u16m1_m (mask_value_0_0, vec_value_1_0, vec_value_2_0, vl);
