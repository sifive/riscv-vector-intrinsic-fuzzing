// COMMAND: random_gen -r MsltuVV8VBool -n 1 -l 7 --has-ta --has-ma -c MsltuVV8VBool.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vbool8_t vec_value_2_0= vmsltu_vv_u8m1_b8(vec_value_0_0, vec_value_1_0, vl);
