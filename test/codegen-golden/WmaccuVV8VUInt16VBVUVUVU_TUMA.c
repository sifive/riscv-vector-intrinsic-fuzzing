// COMMAND: random_gen -r WmaccuVV8VUInt16VBVUVUVU_TUMA -n 1 -l 7 --has-ta --has-ma -c WmaccuVV8VUInt16VBVUVUVU_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_4_0= vwmaccu_vv_u16m2_tuma(mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, tail_vl);
...
uint16_t tmp[] = {65535,9200,8919,5940,7950,1323,65535,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
