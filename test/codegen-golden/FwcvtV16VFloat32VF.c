// COMMAND: random_gen -r FwcvtV16VFloat32VF -n 1 -l 7 --has-ta --has-ma -c FwcvtV16VFloat32VF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_1_0= vfwcvt_f_f_v_f32m2(vec_value_0_0, vl);
...
uint64_t tmp[] = {1166753792u,1183563776u,1181843456u,1174806528u,1178910720u,1160601600u,1166573568u,};
