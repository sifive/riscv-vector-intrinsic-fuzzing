// COMMAND: random_gen -r IotaM8VUInt8VBVB_TAMA -n 1 -l 7 --has-ta --has-ma -c IotaM8VUInt8VBVB_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_2_0= viota_m_u8m1_tama(mask_value_0_0, mask_value_1_0, tail_vl);
vec_value_2_0 = vadd_vx_u8m1_tama(mask_value_0_0, vec_value_2_0, placeholder4, tail_vl);
vse8_v_u8m1(placeholder2, vec_value_2_0, vl);
placeholder4 += vcpop_m_b8_m(mask_value_0_0, mask_value_1_0, tail_vl);
placeholder0 += vl;
placeholder1 += vl;
placeholder2 += vl;
}
...
uint8_t tmp[] = {255,255,0,255,0,255,255,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
