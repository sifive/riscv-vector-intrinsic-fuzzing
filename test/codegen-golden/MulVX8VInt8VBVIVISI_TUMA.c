// COMMAND: random_gen -r MulVX8VInt8VBVIVISI_TUMA -n 1 -l 7 --has-ta --has-ma -c MulVX8VInt8VBVIVISI_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_4_0= vmul_vx_i8m1_tuma(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, tail_vl);
