// COMMAND: random_gen -r Vlse32XX32VInt32VBVISISI_TUMU -n 1 -l 7 --has-ta --has-ma -c Vlse32XX32VInt32VBVISISI_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder3 *= 4;
vint32m1_t vec_value_4_0= vlse32_v_i32m1_tumu(mask_value_0_0, vec_value_1_0, placeholder2, placeholder3, tail_vl);
...
int32_t tmp[] = {5000420,-1529498,1879014,1613727,-7353883,-2595685,2884331,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
