// COMMAND: random_gen -r WredsumVS8SInt16VIVI_TU -n 1 -l 7 --has-ta --has-ma -c WredsumVS8SInt16VIVI_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m1_t placeholder4= vmv_v_x_i16m1(0, vsetvlmax_e16m1());
vint16m1_t placeholder5= vmv_v_v_i16m1(placeholder4, vsetvlmax_e16m1());
...
placeholder5 = vwredsum_vs_i8m1_i16m1_tu(vec_value_0_0, vec_value_1_0, placeholder5, vl);
placeholder0 += vl;
placeholder1 += vl;
placeholder2 += vl;
}
int16_t *placeholder6 = value_2;
*placeholder6= vmv_x_s_i16m1_i16(placeholder5);
}
...
int16_t tmp[] = {-50,7893,5458,-1417,2596,-7226,-5630,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
