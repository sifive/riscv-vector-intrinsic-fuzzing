// COMMAND: random_gen -r FcvtV16VInt16VBVIVF_m -n 1 -l 7 --has-ta --has-ma -c FcvtV16VInt16VBVIVF_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m1_t vec_value_3_0= vfcvt_x_f_v_i16m1_m (mask_value_0_0, vec_value_1_0, vec_value_2_0, vl);
