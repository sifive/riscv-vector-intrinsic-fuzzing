// COMMAND: random_gen -r FsgnjnVV16VFloat16VBVFVFVF_TUMU -n 1 -l 7 --has-ta --has-ma -c FsgnjnVV16VFloat16VBVFVFVF_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_4_0= vfsgnjn_vv_f16m1_tumu(mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, tail_vl);
...
uint64_t tmp[] = {29258,29822,62151,29133,60928,26923,28806,};
