// COMMAND: random_gen -r Vluxei32V32VFloat32VBVFSFVU_TUMA -n 1 -l 7 --has-ta --has-ma -c Vluxei32V32VFloat32VBVFSFVU_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m1_t vec_value_4_0= vluxei32_v_f32m1_tuma(mask_value_0_0, vec_value_1_0, placeholder2, vec_value_3_0, tail_vl);
...
uint64_t tmp[] = {4294967295u,1267490606u,1253542582u,1261781606u,1266779219u,1243709844u,4294967295u,};
