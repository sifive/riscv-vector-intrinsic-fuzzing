// COMMAND: random_gen -r NsrlWX8VUInt8VUVUSL_TU -n 1 -l 7 --has-ta --has-ma -c NsrlWX8VUInt8VUVUSL_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_3_0= vnsrl_wx_u8m1_tu(vec_value_0_0, vec_value_1_0, placeholder2, tail_vl);
