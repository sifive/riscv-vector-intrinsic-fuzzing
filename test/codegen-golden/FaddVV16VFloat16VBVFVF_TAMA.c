// COMMAND: random_gen -r FaddVV16VFloat16VBVFVF_TAMA -n 1 -l 7 --has-ta --has-ma -c FaddVV16VFloat16VBVFVF_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_3_0= vfadd_vv_f16m1_tama(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
uint64_t tmp[] = {65535,65535,29949,65535,30167,65535,65535,};
