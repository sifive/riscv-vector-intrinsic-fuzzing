// COMMAND: random_gen -r WsubuVV8VUInt16VBVUVUVU_TAMU -n 1 -l 7 --has-ta --has-ma -c WsubuVV8VUInt16VBVUVUVU_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_4_0= vwsubu_vv_u16m2_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, tail_vl);
...
uint16_t tmp[] = {6442,65535,28,65535,65509,65535,4633,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
