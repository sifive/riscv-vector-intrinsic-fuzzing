// COMMAND: random_gen -r MsbcVX8VBoolVISI -n 1 -l 7 --has-ta --has-ma -c MsbcVX8VBoolVISI.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vbool8_t vec_value_2_0= vmsbc_vx_i8m1_b8(vec_value_0_0, placeholder1, vl);
...
int golden_vmsbc_vx_operator_0() {
...
printf("operator_0 : %s\n", golden_vmsbc_vx_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
