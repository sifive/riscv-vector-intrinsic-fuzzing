// COMMAND: random_gen -r Fcvt_rtzV16VInt16VIVF_TU -n 1 -l 7 --has-ta --has-ma -c Fcvt_rtzV16VInt16VIVF_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m1_t vec_value_2_0= vfcvt_rtz_x_f_v_i16m1_tu(vec_value_0_0, vec_value_1_0, tail_vl);
