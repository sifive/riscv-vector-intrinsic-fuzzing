// COMMAND: random_gen -r WadduWVX8VUInt16 -n 1 -l 7 --has-ta --has-ma -c WadduWVX8VUInt16.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_2_0= vwaddu_vx_u16m2(vec_value_0_0, placeholder1, vl);
...
uint16_t tmp[] = {61,129,117,82,102,53,61,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
