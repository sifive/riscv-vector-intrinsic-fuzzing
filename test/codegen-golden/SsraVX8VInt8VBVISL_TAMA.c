// COMMAND: random_gen -r SsraVX8VInt8VBVISL_TAMA -n 1 -l 7 --has-ta --has-ma -c SsraVX8VInt8VBVISL_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_3_0= vssra_vx_i8m1_tama(mask_value_0_0, vec_value_1_0, placeholder2, tail_vl);
