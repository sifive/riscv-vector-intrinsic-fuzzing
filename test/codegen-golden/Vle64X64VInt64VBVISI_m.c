// COMMAND: random_gen -r Vle64X64VInt64VBVISI_m -n 1 -l 7 --has-ta --has-ma -c Vle64X64VInt64VBVISI_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint64m1_t vec_value_3_0= vle64_v_i64m1_m (mask_value_0_0, vec_value_1_0, placeholder2, vl);
...
int64_t tmp[] = {2884331ll,5000420ll,-1529498ll,1879014ll,1613727ll,-7353883ll,-734314ll,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
