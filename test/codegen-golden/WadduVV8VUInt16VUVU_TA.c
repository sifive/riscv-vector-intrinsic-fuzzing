// COMMAND: random_gen -r WadduVV8VUInt16VUVU_TA -n 1 -l 7 --has-ta --has-ma -c WadduVV8VUInt16VUVU_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_2_0= vwaddu_vv_u16m2_ta(vec_value_0_0, vec_value_1_0, tail_vl);
...
uint16_t tmp[] = {61,65535,120,65535,121,65535,59,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
