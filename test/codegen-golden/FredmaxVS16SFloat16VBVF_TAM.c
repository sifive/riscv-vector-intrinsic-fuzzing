// COMMAND: random_gen -r FredmaxVS16SFloat16VBVF_TAM -n 1 -l 7 --has-ta --has-ma -c FredmaxVS16SFloat16VBVF_TAM.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder5 = vfredmax_vs_f16m1_f16m1_tam(mask_value_0_0, vec_value_1_0, placeholder5, vl);
placeholder0 += vl;
placeholder1 += vl;
placeholder2 += vl;
}
...
uint64_t tmp[] = {29523,65535,65535,65535,65535,65535,65535,};
