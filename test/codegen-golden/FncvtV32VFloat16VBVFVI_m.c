// COMMAND: random_gen -r FncvtV32VFloat16VBVFVI_m -n 1 -l 7 --has-ta --has-ma -c FncvtV32VFloat16VBVFVI_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16mf2_t vec_value_3_0= vfncvt_f_x_w_f16mf2_m (mask_value_0_0, vec_value_1_0, vec_value_2_0, vl);
...
uint64_t tmp[] = {29258,31744,64512,29133,31744,26923,28806,};
