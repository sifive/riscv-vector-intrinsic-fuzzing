// COMMAND: random_gen -r FmaxVF16VFloat16VBVFVFSF_m -n 1 -l 7 --has-ta --has-ma -c FmaxVF16VFloat16VBVFVFSF_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_4_0= vfmax_vf_f16m1_m (mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, vl);
...
uint64_t tmp[] = {29523,29143,29133,29100,28575,28475,29258,};
