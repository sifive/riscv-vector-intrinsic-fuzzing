// COMMAND: random_gen -r FsqrtV16VFloat16VBVFVF_m -n 1 -l 7 --has-ta --has-ma -c FsqrtV16VFloat16VBVFVF_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_3_0= vfsqrt_v_f16m1_m (mask_value_0_0, vec_value_1_0, vec_value_2_0, vl);
...
uint64_t tmp[] = {29258,22440,21953,29133,22204,26923,28806,};
