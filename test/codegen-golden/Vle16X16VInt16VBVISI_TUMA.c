// COMMAND: random_gen -r Vle16X16VInt16VBVISI_TUMA -n 1 -l 7 --has-ta --has-ma -c Vle16X16VInt16VBVISI_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m1_t vec_value_3_0= vle16_v_i16m1_tuma(mask_value_0_0, vec_value_1_0, placeholder2, tail_vl);
...
int16_t tmp[] = {-1,8399,-1530,1879,1614,-7354,-1,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
