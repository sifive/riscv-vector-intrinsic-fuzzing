// COMMAND: random_gen -r SbcVXM8VInt8VISIVB_TA -n 1 -l 7 --has-ta --has-ma -c SbcVXM8VInt8VISIVB_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_3_0= vsbc_vxm_i8m1_ta(vec_value_0_0, placeholder1, mask_value_2_0, tail_vl);
