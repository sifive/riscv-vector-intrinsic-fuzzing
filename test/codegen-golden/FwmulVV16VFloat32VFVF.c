// COMMAND: random_gen -r FwmulVV16VFloat32VFVF -n 1 -l 7 --has-ta --has-ma -c FwmulVV16VFloat32VFVF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_2_0= vfwmul_vv_f32m2(vec_value_0_0, vec_value_1_0, vl);
...
uint64_t tmp[] = {1275373464u,1300227024u,1291436320u,1287068848u,1292598816u,1259811320u,1274461536u,};
