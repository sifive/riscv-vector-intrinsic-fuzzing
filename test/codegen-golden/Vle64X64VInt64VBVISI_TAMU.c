// COMMAND: random_gen -r Vle64X64VInt64VBVISI_TAMU -n 1 -l 7 --has-ta --has-ma -c Vle64X64VInt64VBVISI_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint64m1_t vec_value_3_0= vle64_v_i64m1_tamu(mask_value_0_0, vec_value_1_0, placeholder2, tail_vl);
...
int64_t tmp[] = {2884331ll,-1ll,-1529498ll,-1ll,1613727ll,-1ll,-734314ll,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
