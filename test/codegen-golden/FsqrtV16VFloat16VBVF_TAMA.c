// COMMAND: random_gen -r FsqrtV16VFloat16VBVF_TAMA -n 1 -l 7 --has-ta --has-ma -c FsqrtV16VFloat16VBVF_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_2_0= vfsqrt_v_f16m1_tama(mask_value_0_0, vec_value_1_0, tail_vl);
...
uint64_t tmp[] = {65535,65535,21953,65535,22204,65535,65535,};
