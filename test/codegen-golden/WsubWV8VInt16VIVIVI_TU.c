// COMMAND: random_gen -r WsubWV8VInt16VIVIVI_TU -n 1 -l 7 --has-ta --has-ma -c WsubWV8VInt16VIVIVI_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_3_0= vwsub_wv_i16m2_tu(vec_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
int16_t tmp[] = {2906,7893,1973,-1417,2287,-7226,-708,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
