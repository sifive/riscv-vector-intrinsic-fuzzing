// COMMAND: random_gen -r SmulVV8VInt8VIVI -n 1 -l 7 --has-ta --has-ma -c SmulVV8VInt8VIVI.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_2_0= vsmul_vv_i8m1(vec_value_0_0, vec_value_1_0, vl);
