// COMMAND: random_gen -r WadduWX8VUInt16VUVUSU_TU -n 1 -l 7 --has-ta --has-ma -c WadduWX8VUInt16VUVUSU_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_3_0= vwaddu_wx_u16m2_tu(vec_value_0_0, vec_value_1_0, placeholder2, tail_vl);
...
uint16_t tmp[] = {7539,8946,5631,4291,1825,1387,6481,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
