// COMMAND: random_gen -r WmaccVV8VInt16VBVIVIVI_TAMA -n 1 -l 7 --has-ta --has-ma -c WmaccVV8VInt16VBVIVIVI_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_4_0= vwmacc_vv_i16m2_tama(mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, tail_vl);
...
int16_t tmp[] = {-1,-1,1373,-1,1679,-1,-1,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
