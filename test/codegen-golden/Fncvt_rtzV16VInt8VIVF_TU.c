// COMMAND: random_gen -r Fncvt_rtzV16VInt8VIVF_TU -n 1 -l 7 --has-ta --has-ma -c Fncvt_rtzV16VInt8VIVF_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8mf2_t vec_value_2_0= vfncvt_rtz_x_f_w_i8mf2_tu(vec_value_0_0, vec_value_1_0, tail_vl);
...
int8_t tmp[] = {127,79,127,-14,127,-73,127,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
