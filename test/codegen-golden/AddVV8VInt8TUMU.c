// COMMAND: random_gen -r AddVV8VInt8TUMU -n 1 -l 7 --has-ta --has-ma -c AddVV8VInt8TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_4_0= vadd_vv_i8m1_tumu(mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, tail_vl);
...
printf("operator_0 : %s\n", golden_vadd_vv_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
ret &= golden_vinit_rif_operator_1();
ret &= golden_vinit_rif_operator_4();
ret &= golden_vinit_rif_operator_2();
ret &= golden_vinit_rif_operator_3();
ret &= golden_vadd_vv_operator_0();
if (!ret) return 1;
return 0; }
