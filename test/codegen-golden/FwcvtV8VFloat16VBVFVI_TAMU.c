// COMMAND: random_gen -r FwcvtV8VFloat16VBVFVI_TAMU -n 1 -l 7 --has-ta --has-ma -c FwcvtV8VFloat16VBVFVI_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m2_t vec_value_3_0= vfwcvt_f_x_v_f16m2_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
uint64_t tmp[] = {29258,65535,52096,65535,19456,65535,28806,};
