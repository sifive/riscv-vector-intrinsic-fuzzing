// COMMAND: random_gen -r RemuVX8VUInt8VBVUSU_TAMA -n 1 -l 7 --has-ta --has-ma -c RemuVX8VUInt8VBVUSU_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_3_0= vremu_vx_u8m1_tama(mask_value_0_0, vec_value_1_0, placeholder2, tail_vl);
...
uint8_t tmp[] = {255,255,17,255,18,255,255,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
