// COMMAND: random_gen -r NsrlWV8VUInt8VUVUVU_TU -n 1 -l 7 --has-ta --has-ma -c NsrlWV8VUInt8VUVUVU_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_3_0= vnsrl_wv_u8m1_tu(vec_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
uint8_t tmp[] = {50,90,5,43,6,14,144,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
