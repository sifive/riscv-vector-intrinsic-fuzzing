// COMMAND: random_gen -r Vloxei32V32VUInt32VBVUSUVU_TUMU -n 1 -l 7 --has-ta --has-ma -c Vloxei32V32VUInt32VBVUSUVU_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint32m1_t vec_value_4_0= vloxei32_v_u32m1_tumu(mask_value_0_0, vec_value_1_0, placeholder2, vec_value_3_0, tail_vl);
...
uint32_t tmp[] = {6442165u,9199407u,3007149u,5939507u,8488019u,1323058u,4632843u,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
