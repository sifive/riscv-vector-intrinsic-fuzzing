// COMMAND: random_gen -r MulhsuVV8VInt8VBVIVIVU_TUMU -n 1 -l 7 --has-ta --has-ma -c MulhsuVV8VInt8VBVIVIVU_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_4_0= vmulhsu_vv_i8m1_tumu(mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, tail_vl);
...
int golden_vmulhsu_vv_operator_0() {
int8_t tmp[] = {29,84,6,19,-9,-74,-7,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
