// COMMAND: random_gen -r FwsubVF16VFloat32VFVFSF_TU -n 1 -l 7 --has-ta --has-ma -c FwsubVF16VFloat32VFVFSF_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_3_0= vfwsub_vf_f32m2_tu(vec_value_0_0, vec_value_1_0, placeholder2, tail_vl);
...
uint64_t tmp[] = {1172365312u,1267237304u,1163083776u,1258485599u,3313778688u,1244223528u,1168023552u,};
