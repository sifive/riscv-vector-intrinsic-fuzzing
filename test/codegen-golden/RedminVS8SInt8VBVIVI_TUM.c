// COMMAND: random_gen -r RedminVS8SInt8VBVIVI_TUM -n 1 -l 7 --has-ta --has-ma -c RedminVS8SInt8VBVIVI_TUM.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder6 = vredmin_vs_i8m1_i8m1_tum(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder6, vl);
placeholder0 += vl;
placeholder1 += vl;
placeholder2 += vl;
placeholder3 += vl;
...
int8_t tmp[] = {-15,84,20,19,23,-74,-7,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
