// COMMAND: random_gen -r NclipWV8VInt8VIVIVU_TU -n 1 -l 7 --has-ta --has-ma -c NclipWV8VInt8VIVIVU_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_3_0= vnclip_wv_i8m1_tu(vec_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
