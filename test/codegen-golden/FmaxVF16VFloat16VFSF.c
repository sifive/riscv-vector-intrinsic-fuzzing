// COMMAND: random_gen -r FmaxVF16VFloat16VFSF -n 1 -l 7 --has-ta --has-ma -c FmaxVF16VFloat16VFSF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_2_0= vfmax_vf_f16m1(vec_value_0_0, placeholder1, vl);
...
uint64_t tmp[] = {28575,29790,29580,28721,29222,28575,28575,};
