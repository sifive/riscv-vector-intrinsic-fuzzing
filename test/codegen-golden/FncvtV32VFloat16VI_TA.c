// COMMAND: random_gen -r FncvtV32VFloat16VI_TA -n 1 -l 7 --has-ta --has-ma -c FncvtV32VFloat16VI_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16mf2_t vec_value_1_0= vfncvt_f_x_w_f16mf2_ta(vec_value_0_0, tail_vl);
...
uint64_t tmp[] = {64512,65535,31744,65535,31744,65535,64512,};
