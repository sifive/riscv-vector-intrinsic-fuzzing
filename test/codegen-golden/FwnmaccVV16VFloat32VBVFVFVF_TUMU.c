// COMMAND: random_gen -r FwnmaccVV16VFloat32VBVFVFVF_TUMU -n 1 -l 7 --has-ta --has-ma -c FwnmaccVV16VFloat32VBVFVFVF_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_4_0= vfwnmacc_vv_f32m2_tumu(mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, tail_vl);
...
int golden_vfwnmacc_vv_operator_0() {
uint64_t tmp[] = {1262786923u,1267490606u,3438745784u,1261781606u,3433011050u,1243709844u,1259168278u,};
