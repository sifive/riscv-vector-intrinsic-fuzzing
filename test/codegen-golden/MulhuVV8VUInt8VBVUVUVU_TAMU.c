// COMMAND: random_gen -r MulhuVV8VUInt8VBVUVUVU_TAMU -n 1 -l 7 --has-ta --has-ma -c MulhuVV8VUInt8VBVUVUVU_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_4_0= vmulhu_vv_u8m1_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, tail_vl);
...
int golden_vmulhu_vv_operator_0() {
uint8_t tmp[] = {65,255,11,255,7,255,46,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
