// COMMAND: random_gen -r SadduVX8VUInt8VBVUVUSU_TAMU -n 1 -l 7 --has-ta --has-ma -c SadduVX8VUInt8VBVUVUSU_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_4_0= vsaddu_vx_u8m1_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, tail_vl);
...
int golden_vsaddu_vx_operator_0() {
uint8_t tmp[] = {75,255,98,255,52,255,65,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
