// COMMAND: random_gen -r RedminuVS8SUInt8VU_TA -n 1 -l 7 --has-ta --has-ma -c RedminuVS8SUInt8VU_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder4 = vredminu_vs_u8m1_u8m1_ta(vec_value_0_0, placeholder4, vl);
placeholder0 += vl;
placeholder1 += vl;
}
