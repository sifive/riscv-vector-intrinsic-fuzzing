// COMMAND: random_gen -r RsubVX8VInt8VISI_TA -n 1 -l 7 --has-ta --has-ma -c RsubVX8VInt8VISI_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_2_0= vrsub_vx_i8m1_ta(vec_value_0_0, placeholder1, tail_vl);
