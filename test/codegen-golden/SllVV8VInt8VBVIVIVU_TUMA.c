// COMMAND: random_gen -r SllVV8VInt8VBVIVIVU_TUMA -n 1 -l 7 --has-ta --has-ma -c SllVV8VInt8VBVIVIVU_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_4_0= vsll_vv_i8m1_tuma(mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, tail_vl);
...
int8_t tmp[] = {-1,84,-100,19,100,-74,-1,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
