// COMMAND: random_gen -r Vsse32XX32VoidSIVF -n 1 -l 7 --has-ta --has-ma -c Vsse32XX32VoidSIVF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder1 *= 4;
vsse32_v_f32m1(placeholder2, placeholder1, vec_value_0_0, vl);
