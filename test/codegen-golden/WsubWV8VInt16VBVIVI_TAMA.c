// COMMAND: random_gen -r WsubWV8VInt16VBVIVI_TAMA -n 1 -l 7 --has-ta --has-ma -c WsubWV8VInt16VBVIVI_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_3_0= vwsub_wv_i16m2_tama(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
int16_t tmp[] = {-1,-1,1973,-1,2287,-1,-1,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
