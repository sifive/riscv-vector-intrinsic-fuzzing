// COMMAND: random_gen -r FcvtV16VFloat16VBVFVI_TUMU -n 1 -l 7 --has-ta --has-ma -c FcvtV16VFloat16VBVFVI_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_3_0= vfcvt_f_x_v_f16m1_tumu(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
uint64_t tmp[] = {29258,29822,58874,29133,26190,26923,28806,};
