// COMMAND: random_gen -r FwnmaccVF16VFloat32VFSFVF -n 1 -l 7 --has-ta --has-ma -c FwnmaccVF16VFloat32VFSFVF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_3_0= vfwnmacc_vf_f32m2(vec_value_0_0, placeholder1, vec_value_2_0, vl);
...
uint64_t tmp[] = {3435673277u,3444133935u,3438124218u,3440480230u,3441078809u,3426358930u,3435018794u,};
