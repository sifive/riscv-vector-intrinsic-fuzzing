// COMMAND: random_gen -r WmulsuVX8VInt16VBVIVISU_TUMA -n 1 -l 7 --has-ta --has-ma -c WmulsuVX8VInt16VBVIVISU_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_4_0= vwmulsu_vx_i16m2_tuma(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, tail_vl);
...
int16_t tmp[] = {-1,-1530,741,1614,-2886,-2596,-1,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
