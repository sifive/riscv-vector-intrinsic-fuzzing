// COMMAND: random_gen -r RedxorVS8SInt8VI_TA -n 1 -l 7 --has-ta --has-ma -c RedxorVS8SInt8VI_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder4 = vredxor_vs_i8m1_i8m1_ta(vec_value_0_0, placeholder4, vl);
placeholder0 += vl;
placeholder1 += vl;
}
