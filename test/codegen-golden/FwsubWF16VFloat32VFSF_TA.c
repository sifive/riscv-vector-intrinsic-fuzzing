// COMMAND: random_gen -r FwsubWF16VFloat32VFSF_TA -n 1 -l 7 --has-ta --has-ma -c FwsubWF16VFloat32VFSF_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_2_0= vfwsub_wf_f32m2_ta(vec_value_0_0, placeholder1, tail_vl);
...
uint64_t tmp[] = {1250406748u,4294967295u,1265352662u,4294967295u,1262490896u,4294967295u,1250239012u,};
