// COMMAND: random_gen -r AadduVV8VUInt8VUVUVU_TU -n 1 -l 7 --has-ta --has-ma -c AadduVV8VUInt8VUVUVU_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_3_0= vaaddu_vv_u8m1_tu(vec_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
uint8_t tmp[] = {52,90,51,43,60,14,42,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
