// COMMAND: random_gen -r NclipuWX8VUInt8VBVUVUSL_TAMU -n 1 -l 7 --has-ta --has-ma -c NclipuWX8VUInt8VBVUVUSL_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_4_0= vnclipu_wx_u8m1_tamu(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, tail_vl);
