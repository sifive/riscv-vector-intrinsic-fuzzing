// COMMAND: random_gen -r Vse32X32VoidSIVI -n 1 -l 7 --has-ta --has-ma -c Vse32X32VoidSIVI.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
int32_t *placeholder2 = value_1;
int placeholder3 = 7;

for (size_t vl; placeholder3 > 0; placeholder3 -= vl) {
vl = vsetvl_e32m1(placeholder3);
vint32m1_t placeholder4= vmv_v_x_i32m1(0, vsetvlmax_e32m1());
vse32_v_i32m1(placeholder2, placeholder4, vl);
placeholder2 += vl;
}
int placeholder5 = 7;
...
vse32_v_i32m1(placeholder1, vec_value_0_0, vl);
placeholder0 += vl;
placeholder1 += vl;
}
}
