// COMMAND: random_gen -r FncvtV32VFloat16VFVI_TU -n 1 -l 7 --has-ta --has-ma -c FncvtV32VFloat16VFVI_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vl = 2;
size_t tail_vl = 1;
vfloat16mf2_t vec_value_0_0= vle16_v_f16mf2(placeholder0, vl);
vint32m1_t vec_value_1_0= vle32_v_i32m1(placeholder1, vl);

vfloat16mf2_t vec_value_2_0= vfncvt_f_x_w_f16mf2_tu(vec_value_0_0, vec_value_1_0, tail_vl);

vse16_v_f16mf2(placeholder2, vec_value_2_0, vl);
...
int golden_vfncvt_f_x_w_operator_0() {
uint64_t tmp[] = {64512,29790,64512,28721,31744,26987,64512,};
...
vfncvt_f_x_w_operator_0();
printf("operator_1 : %s\n", golden_vinit_rif_operator_1() ? "pass" : "fail");
printf("operator_2 : %s\n", golden_vinit_rif_operator_2() ? "pass" : "fail");
printf("operator_0 : %s\n", golden_vfncvt_f_x_w_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
ret &= golden_vinit_rif_operator_1();
ret &= golden_vinit_rif_operator_2();
ret &= golden_vfncvt_f_x_w_operator_0();
if (!ret) return 1;
return 0; }
