// COMMAND: random_gen -r Vsuxei32V32VoidVUVF -n 1 -l 7 --has-ta --has-ma -c Vsuxei32V32VoidVUVF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vsuxei32_v_f32m1(placeholder2, vec_value_1_0, vec_value_0_0, vl);
placeholder0 += vl;
placeholder1 += vl;
}
}
...
uint64_t tmp[] = {1262498700u,1258485599u,0u,0u,1250254620u,1250422356u,1265360466u,};
