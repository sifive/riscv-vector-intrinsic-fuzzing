// COMMAND: random_gen -r NotV8VInt8VIVI_TU -n 1 -l 7 --has-ta --has-ma -c NotV8VInt8VIVI_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_2_0= vnot_v_i8m1_tu(vec_value_0_0, vec_value_1_0, tail_vl);
...
int8_t tmp[] = {21,79,14,-14,-17,-73,25,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
