// COMMAND: random_gen -r FwcvtV16VFloat32VFVF_TU -n 1 -l 7 --has-ta --has-ma -c FwcvtV16VFloat32VFVF_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_2_0= vfwcvt_f_f_v_f32m2_tu(vec_value_0_0, vec_value_1_0, tail_vl);
...
uint64_t tmp[] = {1173610496u,1267237304u,1174691840u,1258485599u,1177911296u,1244223528u,1172791296u,};
