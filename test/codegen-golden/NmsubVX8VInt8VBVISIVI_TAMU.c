// COMMAND: random_gen -r NmsubVX8VInt8VBVISIVI_TAMU -n 1 -l 7 --has-ta --has-ma -c NmsubVX8VInt8VBVISIVI_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_4_0= vnmsub_vx_i8m1_tamu(mask_value_0_0, vec_value_1_0, placeholder2, vec_value_3_0, tail_vl);
