// COMMAND: random_gen -r Vzext_vf2V16VUInt16VU -n 1 -l 7 --has-ta --has-ma -c Vzext_vf2V16VUInt16VU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m1_t vec_value_1_0= vzext_vf2_u16m1(vec_value_0_0, vl);
...
uint16_t tmp[] = {22,90,78,43,63,14,22,};
for (int i=0; i<7;++i)
if(value_1[i] != tmp[i]) {
return 0;
}
