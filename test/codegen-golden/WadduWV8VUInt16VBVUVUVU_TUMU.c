// COMMAND: random_gen -r WadduWV8VUInt16VBVUVUVU_TUMU -n 1 -l 7 --has-ta --has-ma -c WadduWV8VUInt16VBVUVUVU_TUMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_4_0= vwaddu_wv_u16m2_tumu(mask_value_0_0, vec_value_1_0, vec_value_2_0, vec_value_3_0, tail_vl);
...
uint16_t tmp[] = {6442,9200,6982,5940,3129,1323,4633,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
