// COMMAND: random_gen -r Vle32X32VFloat32SF -n 1 -l 7 --has-ta --has-ma -c Vle32X32VFloat32SF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m1_t vec_value_1_0= vle32_v_f32m1(placeholder0, vl);
