// COMMAND: random_gen -r WsubuWX8VUInt16VUSU_TA -n 1 -l 7 --has-ta --has-ma -c WsubuWX8VUInt16VUSU_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_2_0= vwsubu_wx_u16m2_ta(vec_value_0_0, placeholder1, tail_vl);
...
uint16_t tmp[] = {2188,65535,7690,65535,6259,65535,2146,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
