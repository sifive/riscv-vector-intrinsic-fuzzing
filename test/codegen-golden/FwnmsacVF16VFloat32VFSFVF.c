// COMMAND: random_gen -r FwnmsacVF16VFloat32VFSFVF -n 1 -l 7 --has-ta --has-ma -c FwnmsacVF16VFloat32VFSFVF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_3_0= vfwnmsac_vf_f32m2(vec_value_0_0, placeholder1, vec_value_2_0, vl);
...
uint64_t tmp[] = {3434559731u,3441897409u,3434259750u,3439407354u,3439504295u,3424971662u,3433926214u,};
