// COMMAND: random_gen -r NsrlWV8VUInt8 -n 1 -l 7 --has-ta --has-ma -c NsrlWV8VUInt8.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_2_0= vnsrl_wv_u8m1(vec_value_0_0, vec_value_1_0, vl);
