// COMMAND: random_gen -r Sext_vf4V32VInt32VIVI_TU -n 1 -l 7 --has-ta --has-ma -c Sext_vf4V32VInt32VIVI_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8mf4_t vec_value_1_0= vle8_v_i8mf4(placeholder1, vl);

vint32m1_t vec_value_2_0= vsext_vf4_i32m1_tu(vec_value_0_0, vec_value_1_0, tail_vl);
...
int32_t tmp[] = {-22,7892207,-15,-1416993,16,-7225462,-26,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
