// COMMAND: random_gen -r Vse8X8VoidVBSIVI_m -n 1 -l 7 --has-ta --has-ma -c Vse8X8VoidVBSIVI_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vse8_v_i8m1_m (mask_value_0_0, placeholder2, vec_value_1_0, vl);
placeholder0 += vl;
placeholder1 += vl;
placeholder2 += vl;
}
...
int golden_vse8_v_operator_0() {
int8_t tmp[] = {0,50,-15,0,16,0,0,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
...
printf("operator_0 : %s\n", golden_vse8_v_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
ret &= golden_vinit_rif_operator_1();
ret &= golden_vinit_rif_operator_2();
ret &= golden_vse8_v_operator_0();
if (!ret) return 1;
return 0; }
