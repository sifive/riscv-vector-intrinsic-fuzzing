// COMMAND: random_gen -r FcvtV16VFloat16VBVFVU_TUMA -n 1 -l 7 --has-ta --has-ma -c FcvtV16VFloat16VBVFVU_TUMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m1_t vec_value_2_0= vle16_v_u16m1(placeholder2, vl);

vfloat16m1_t vec_value_3_0= vfcvt_f_xu_v_f16m1_tuma(mask_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
int golden_vfcvt_f_xu_v_operator_0() {
uint64_t tmp[] = {65535,29822,27683,29133,28076,26923,65535,};
...
vfcvt_f_xu_v_operator_0();
printf("operator_1 : %s\n", golden_vinit_rif_operator_1() ? "pass" : "fail");
printf("operator_3 : %s\n", golden_vinit_rif_operator_3() ? "pass" : "fail");
printf("operator_2 : %s\n", golden_vinit_rif_operator_2() ? "pass" : "fail");
printf("operator_0 : %s\n", golden_vfcvt_f_xu_v_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
ret &= golden_vinit_rif_operator_1();
ret &= golden_vinit_rif_operator_3();
ret &= golden_vinit_rif_operator_2();
ret &= golden_vfcvt_f_xu_v_operator_0();
if (!ret) return 1;
return 0; }
