// COMMAND: random_gen -r FcvtV16VFloat16VI_TA -n 1 -l 7 --has-ta --has-ma -c FcvtV16VFloat16VI_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_1_0= vfcvt_f_x_v_f16m1_ta(vec_value_0_0, tail_vl);
...
uint64_t tmp[] = {60778,65535,27988,65535,26898,65535,60800,};
