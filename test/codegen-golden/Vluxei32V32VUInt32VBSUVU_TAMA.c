// COMMAND: random_gen -r Vluxei32V32VUInt32VBSUVU_TAMA -n 1 -l 7 --has-ta --has-ma -c Vluxei32V32VUInt32VBSUVU_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint32m1_t vec_value_3_0= vluxei32_v_u32m1_tama(mask_value_0_0, placeholder1, vec_value_2_0, tail_vl);
...
uint32_t tmp[] = {4294967295u,4294967295u,4632843u,4294967295u,6442165u,4294967295u,4294967295u,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
