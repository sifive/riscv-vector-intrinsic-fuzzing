// COMMAND: random_gen -r FsgnjnVF16VFloat16VFVFSF_TU -n 1 -l 7 --has-ta --has-ma -c FsgnjnVF16VFloat16VFVFSF_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_3_0= vfsgnjn_vf_f16m1_tu(vec_value_0_0, vec_value_1_0, placeholder2, tail_vl);
...
uint64_t tmp[] = {62291,29790,61814,28721,60154,26987,62026,};
