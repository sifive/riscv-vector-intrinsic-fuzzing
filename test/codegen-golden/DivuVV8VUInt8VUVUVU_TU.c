// COMMAND: random_gen -r DivuVV8VUInt8VUVUVU_TU -n 1 -l 7 --has-ta --has-ma -c DivuVV8VUInt8VUVUVU_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint8m1_t vec_value_3_0= vdivu_vv_u8m1_tu(vec_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
