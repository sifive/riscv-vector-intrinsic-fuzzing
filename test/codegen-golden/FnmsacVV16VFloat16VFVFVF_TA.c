// COMMAND: random_gen -r FnmsacVV16VFloat16VFVFVF_TA -n 1 -l 7 --has-ta --has-ma -c FnmsacVV16VFloat16VFVFVF_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_3_0= vfnmsac_vv_f16m1_ta(vec_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
uint64_t tmp[] = {64512,65535,64512,65535,64512,65535,64512,};
