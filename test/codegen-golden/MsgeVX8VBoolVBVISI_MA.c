// COMMAND: random_gen -r MsgeVX8VBoolVBVISI_MA -n 1 -l 7 --has-ta --has-ma -c MsgeVX8VBoolVBVISI_MA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vbool8_t vec_value_3_0= vmsge_vx_i8m1_b8_ma(mask_value_0_0, vec_value_1_0, placeholder2, vl);
...
int golden_vmsge_vx_operator_0() {
...
printf("operator_0 : %s\n", golden_vmsge_vx_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
ret &= golden_vinit_rif_operator_1();
ret &= golden_vinit_rif_operator_3();
ret &= golden_vinit_rif_operator_2();
ret &= golden_vmsge_vx_operator_0();
if (!ret) return 1;
return 0; }
