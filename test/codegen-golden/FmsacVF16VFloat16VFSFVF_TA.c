// COMMAND: random_gen -r FmsacVF16VFloat16VFSFVF_TA -n 1 -l 7 --has-ta --has-ma -c FmsacVF16VFloat16VFSFVF_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_3_0= vfmsac_vf_f16m1_ta(vec_value_0_0, placeholder1, vec_value_2_0, tail_vl);
