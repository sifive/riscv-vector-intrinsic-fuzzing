// COMMAND: random_gen -r Vlse8XX8VInt8VBVISISI_TAMU -n 1 -l 7 --has-ta --has-ma -c Vlse8XX8VInt8VBVISISI_TAMU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder3 *= 1;
vint8m1_t vec_value_4_0= vlse8_v_i8m1_tamu(mask_value_0_0, vec_value_1_0, placeholder2, placeholder3, tail_vl);
