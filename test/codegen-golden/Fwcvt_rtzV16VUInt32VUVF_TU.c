// COMMAND: random_gen -r Fwcvt_rtzV16VUInt32VUVF_TU -n 1 -l 7 --has-ta --has-ma -c Fwcvt_rtzV16VUInt32VUVF_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vl = 2;
size_t tail_vl = 1;
vuint32m2_t vec_value_0_0= vle32_v_u32m2(placeholder0, vl);
vfloat16m1_t vec_value_1_0= vle16_v_f16m1(placeholder1, vl);

vuint32m2_t vec_value_2_0= vfwcvt_rtz_xu_f_v_u32m2_tu(vec_value_0_0, vec_value_1_0, tail_vl);

vse32_v_u32m2(placeholder2, vec_value_2_0, vl);
...
uint32_t tmp[] = {7804u,8946104u,8472u,4291503u,11616u,1387269u,7404u,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
