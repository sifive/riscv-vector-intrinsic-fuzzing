// COMMAND: random_gen -r FwsubVF16VFloat32VFSF -n 1 -l 7 --has-ta --has-ma -c FwsubVF16VFloat32VFSF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_2_0= vfwsub_vf_f32m2(vec_value_0_0, placeholder1, vl);
...
uint64_t tmp[] = {3310436352u,1176342528u,1173299200u,1145241600u,1167433728u,3315412992u,3310796800u,};
