// COMMAND: random_gen -r MsgtuVX8VBoolVBVUSU_MA -n 1 -l 7 --has-ta --has-ma -c MsgtuVX8VBoolVBVUSU_MA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vbool8_t vec_value_3_0= vmsgtu_vx_u8m1_b8_ma(mask_value_0_0, vec_value_1_0, placeholder2, vl);
...
int golden_vmsgtu_vx_operator_0() {
...
vmsgtu_vx_operator_0();
printf("operator_1 : %s\n", golden_vinit_rif_operator_1() ? "pass" : "fail");
printf("operator_3 : %s\n", golden_vinit_rif_operator_3() ? "pass" : "fail");
printf("operator_2 : %s\n", golden_vinit_rif_operator_2() ? "pass" : "fail");
printf("operator_0 : %s\n", golden_vmsgtu_vx_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
