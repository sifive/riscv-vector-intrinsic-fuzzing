// COMMAND: random_gen -r WadduVX8VUInt16VUVUSU_TU -n 1 -l 7 --has-ta --has-ma -c WadduVX8VUInt16VUVUSU_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vuint16m2_t vec_value_3_0= vwaddu_vx_u16m2_tu(vec_value_0_0, vec_value_1_0, placeholder2, tail_vl);
...
uint16_t tmp[] = {114,8946,95,4291,57,1387,104,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
