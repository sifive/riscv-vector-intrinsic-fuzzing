// COMMAND: random_gen -r WsubVX8VInt16VBVISI_TAMA -n 1 -l 7 --has-ta --has-ma -c WsubVX8VInt16VBVISI_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_3_0= vwsub_vx_i16m2_tama(mask_value_0_0, vec_value_1_0, placeholder2, tail_vl);
