// COMMAND: random_gen -r FncvtV32VFloat16VFVF_TU -n 1 -l 7 --has-ta --has-ma -c FncvtV32VFloat16VFVF_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16mf2_t vec_value_2_0= vfncvt_f_f_w_f16mf2_tu(vec_value_0_0, vec_value_1_0, tail_vl);
...
int golden_vfncvt_f_f_w_operator_0() {
uint64_t tmp[] = {31744,29790,31744,28721,31744,26987,31744,};
...
vfncvt_f_f_w_operator_0();
printf("operator_1 : %s\n", golden_vinit_rif_operator_1() ? "pass" : "fail");
printf("operator_2 : %s\n", golden_vinit_rif_operator_2() ? "pass" : "fail");
printf("operator_0 : %s\n", golden_vfncvt_f_f_w_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
ret &= golden_vinit_rif_operator_1();
ret &= golden_vinit_rif_operator_2();
ret &= golden_vfncvt_f_f_w_operator_0();
if (!ret) return 1;
return 0; }
