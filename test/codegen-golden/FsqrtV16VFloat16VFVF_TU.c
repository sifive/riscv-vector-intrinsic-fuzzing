// COMMAND: random_gen -r FsqrtV16VFloat16VFVF_TU -n 1 -l 7 --has-ta --has-ma -c FsqrtV16VFloat16VFVF_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_2_0= vfsqrt_v_f16m1_tu(vec_value_0_0, vec_value_1_0, tail_vl);
...
uint64_t tmp[] = {21893,29790,21953,28721,22204,26987,21857,};
