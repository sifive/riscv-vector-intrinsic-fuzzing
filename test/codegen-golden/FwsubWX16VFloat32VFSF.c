// COMMAND: random_gen -r FwsubWX16VFloat32VFSF -n 1 -l 7 --has-ta --has-ma -c FwsubWX16VFloat32VFSF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat32m2_t vec_value_2_0= vfwsub_wf_f32m2(vec_value_0_0, placeholder1, vl);
...
uint64_t tmp[] = {1250406748u,1267233402u,1265352662u,1258477795u,1262490896u,1244192312u,1250239012u,};
