// COMMAND: random_gen -r WsubVV8VInt16VIVIVI_TU -n 1 -l 7 --has-ta --has-ma -c WsubVV8VInt16VIVIVI_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_3_0= vwsub_vv_i16m2_tu(vec_value_0_0, vec_value_1_0, vec_value_2_0, tail_vl);
...
int16_t tmp[] = {51,7893,35,-1417,7,-7226,19,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
