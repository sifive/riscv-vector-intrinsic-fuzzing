// COMMAND: random_gen -r MergeVXM8VInt8VBVIVISI_TU -n 1 -l 7 --has-ta --has-ma -c MergeVXM8VInt8VBVIVISI_TU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_4_0= vmerge_vxm_i8m1_tu(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, tail_vl);
...
int golden_vmerge_vxm_operator_0() {
int8_t tmp[] = {84,-15,-22,16,-22,-26,70,};
for (int i=0; i<7;++i)
if(value_4[i] != tmp[i]) {
return 0;
}
