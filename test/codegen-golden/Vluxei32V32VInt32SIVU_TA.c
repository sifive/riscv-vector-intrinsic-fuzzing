// COMMAND: random_gen -r Vluxei32V32VInt32SIVU_TA -n 1 -l 7 --has-ta --has-ma -c Vluxei32V32VInt32SIVU_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint32m1_t vec_value_2_0= vluxei32_v_i32m1_ta(placeholder0, vec_value_1_0, tail_vl);
...
int32_t tmp[] = {-7225462,-1,-5629682,-1,-5545814,-1,2596108,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
