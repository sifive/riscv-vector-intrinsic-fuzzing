// COMMAND: random_gen -r Vsext_vf8V64VInt64VBVIVI_m -n 1 -l 7 --has-ta --has-ma -c Vsext_vf8V64VInt64VBVIVI_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint64m1_t vec_value_3_0= vsext_vf8_i64m1_m (mask_value_0_0, vec_value_1_0, vec_value_2_0, vl);
...
int64_t tmp[] = {2884331ll,50ll,-15ll,1879014ll,16ll,-7353883ll,-734314ll,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
