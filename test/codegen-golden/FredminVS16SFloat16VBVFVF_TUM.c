// COMMAND: random_gen -r FredminVS16SFloat16VBVFVF_TUM -n 1 -l 7 --has-ta --has-ma -c FredminVS16SFloat16VBVFVF_TUM.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder6 = vfredmin_vs_f16m1_f16m1_tum(mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder6, vl);
placeholder0 += vl;
placeholder1 += vl;
placeholder2 += vl;
placeholder3 += vl;
...
uint64_t tmp[] = {0,29822,29143,29133,29186,26923,28806,};
