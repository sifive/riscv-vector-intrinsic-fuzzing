// COMMAND: random_gen -r MsgeVV8VBoolVBVBVIVI_MU -n 1 -l 7 --has-ta --has-ma -c MsgeVV8VBoolVBVBVIVI_MU.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vbool8_t vec_value_4_0= vmsge_vv_i8m1_b8_mu(mask_value_0_0, mask_value_1_0, vec_value_2_0, vec_value_3_0, vl);
...
int golden_vmsge_vv_operator_0() {
...
printf("operator_0 : %s\n", golden_vmsge_vv_operator_0() ? "pass" : "fail");
int ret = 1; // 1 = success
