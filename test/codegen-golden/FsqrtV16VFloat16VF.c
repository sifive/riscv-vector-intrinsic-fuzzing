// COMMAND: random_gen -r FsqrtV16VFloat16VF -n 1 -l 7 --has-ta --has-ma -c FsqrtV16VFloat16VF.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_1_0= vfsqrt_v_f16m1(vec_value_0_0, vl);
...
uint64_t tmp[] = {21548,22574,22469,21962,22275,21141,21537,};
