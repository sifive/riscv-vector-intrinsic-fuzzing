// COMMAND: random_gen -r MaddVX8VInt8VISIVI_TA -n 1 -l 7 --has-ta --has-ma -c MaddVX8VInt8VISIVI_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_3_0= vmadd_vx_i8m1_ta(vec_value_0_0, placeholder1, vec_value_2_0, tail_vl);
