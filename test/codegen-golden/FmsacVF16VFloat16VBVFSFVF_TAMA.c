// COMMAND: random_gen -r FmsacVF16VFloat16VBVFSFVF_TAMA -n 1 -l 7 --has-ta --has-ma -c FmsacVF16VFloat16VBVFSFVF_TAMA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_4_0= vfmsac_vf_f16m1_tama(mask_value_0_0, vec_value_1_0, placeholder2, vec_value_3_0, tail_vl);
