// COMMAND: random_gen -r WsubWV8VInt16VIVI_TA -n 1 -l 7 --has-ta --has-ma -c WsubWV8VInt16VIVI_TA.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint16m2_t vec_value_2_0= vwsub_wv_i16m2_ta(vec_value_0_0, vec_value_1_0, tail_vl);
...
int16_t tmp[] = {-5524,-1,5473,-1,2580,-1,-5604,};
for (int i=0; i<7;++i)
if(value_2[i] != tmp[i]) {
return 0;
}
