// COMMAND: random_gen -r FsgnjxVF16VFloat16VBVFVFSF_m -n 1 -l 7 --has-ta --has-ma -c FsgnjxVF16VFloat16VBVFVFSF_m.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vfloat16m1_t vec_value_4_0= vfsgnjx_vf_f16m1_m (mask_value_0_0, vec_value_1_0, vec_value_2_0, placeholder3, vl);
