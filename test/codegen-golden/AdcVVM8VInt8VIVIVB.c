// COMMAND: random_gen -r AdcVVM8VInt8VIVIVB -n 1 -l 7 --has-ta --has-ma -c AdcVVM8VInt8VIVIVB.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
vint8m1_t vec_value_3_0= vadc_vvm_i8m1(vec_value_0_0, vec_value_1_0, mask_value_2_0, vl);
...
int8_t tmp[] = {-27,-92,75,6,50,109,-64,};
for (int i=0; i<7;++i)
if(value_3[i] != tmp[i]) {
return 0;
}
