// COMMAND: random_gen -r RedmaxVS8SInt8VBVI_TAM -n 1 -l 7 --has-ta --has-ma -c RedmaxVS8SInt8VBVI_TAM.c --has-policy
#include <stdbool.h>
#include <stdint.h>
#include <stdlib.h>
#include <stdio.h>
...
placeholder5 = vredmax_vs_i8m1_i8m1_tam(mask_value_0_0, vec_value_1_0, placeholder5, vl);
placeholder0 += vl;
placeholder1 += vl;
placeholder2 += vl;
}
